...
public class AnomalyDetectorClientImpl extends AzureServiceClient implements AnomalyDetectorClient {
    ...
    interface AnomalyDetectorClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.cognitiveservices.anomalydetector.AnomalyDetectorClient shivangiTestDetectEntireSeries" })
        @POST("timeseries/entire/detect")
        Observable<Response<ResponseBody>> shivangiTestDetectEntireSeries(@Body DetectRequest body, @Header("accept-language") String acceptLanguage, @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
     ...
     * Testing This operation generates a model using an entire series, each point is detected with the same model. With this method, points before and after a certain point are used to determine whether it is an anomaly. The entire detection can give user an overall status of the time series.
     *
     ...
     */
    public EntireDetectResponse shivangiTestDetectEntireSeries(DetectRequest body) {
        return shivangiTestDetectEntireSeriesWithServiceResponseAsync(body).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<EntireDetectResponse> shivangiTestDetectEntireSeriesAsync(DetectRequest body, final ServiceCallback<EntireDetectResponse> serviceCallback) {
        return ServiceFuture.fromResponse(shivangiTestDetectEntireSeriesWithServiceResponseAsync(body), serviceCallback);
    }
     ...
     */
    public Observable<EntireDetectResponse> shivangiTestDetectEntireSeriesAsync(DetectRequest body) {
        return shivangiTestDetectEntireSeriesWithServiceResponseAsync(body).map(new Func1<ServiceResponse<EntireDetectResponse>, EntireDetectResponse>() {
            @Override
     ...
     * @return the observable to the EntireDetectResponse object
     */
    public Observable<ServiceResponse<EntireDetectResponse>> shivangiTestDetectEntireSeriesWithServiceResponseAsync(DetectRequest body) {
        ...
        return service.shivangiTestDetectEntireSeries(body, this.acceptLanguage(), parameterizedHost, this.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EntireDetectResponse>>>() {
                ...
                public Observable<ServiceResponse<EntireDetectResponse>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<EntireDetectResponse> clientResponse = shivangiTestDetectEntireSeriesDelegate(response);
    ...
    private ServiceResponse<EntireDetectResponse> shivangiTestDetectEntireSeriesDelegate(Response<ResponseBody> response) throws AnomalyDetectorErrorException, IOException, IllegalArgumentException {
