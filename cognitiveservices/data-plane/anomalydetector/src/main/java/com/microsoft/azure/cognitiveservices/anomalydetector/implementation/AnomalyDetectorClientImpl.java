...
public class AnomalyDetectorClientImpl extends AzureServiceClient implements AnomalyDetectorClient {
    ...
    interface AnomalyDetectorClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.cognitiveservices.anomalydetector.AnomalyDetectorClient breakingChangeDetectEntireSeries" })
        @POST("timeseries/entire/detect")
        Observable<Response<ResponseBody>> breakingChangeDetectEntireSeries(@Body DetectRequest body, @Header("accept-language") String acceptLanguage, @Header("x-ms-parameterized-host") String parameterizedHost, @Header("User-Agent") String userAgent);
     ...
     * Shivangi Testing This operation generates a model using an entire series, each point is detected with the same model. With this method, points before and after a certain point are used to determine whether it is an anomaly. The entire detection can give user an overall status of the time series.
     *
     ...
     */
    public EntireDetectResponse breakingChangeDetectEntireSeries(DetectRequest body) {
        return breakingChangeDetectEntireSeriesWithServiceResponseAsync(body).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<EntireDetectResponse> breakingChangeDetectEntireSeriesAsync(DetectRequest body, final ServiceCallback<EntireDetectResponse> serviceCallback) {
        return ServiceFuture.fromResponse(breakingChangeDetectEntireSeriesWithServiceResponseAsync(body), serviceCallback);
    }
     ...
     */
    public Observable<EntireDetectResponse> breakingChangeDetectEntireSeriesAsync(DetectRequest body) {
        return breakingChangeDetectEntireSeriesWithServiceResponseAsync(body).map(new Func1<ServiceResponse<EntireDetectResponse>, EntireDetectResponse>() {
            @Override
     ...
     * @return the observable to the EntireDetectResponse object
     */
    public Observable<ServiceResponse<EntireDetectResponse>> breakingChangeDetectEntireSeriesWithServiceResponseAsync(DetectRequest body) {
        ...
        return service.breakingChangeDetectEntireSeries(body, this.acceptLanguage(), parameterizedHost, this.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EntireDetectResponse>>>() {
                ...
                public Observable<ServiceResponse<EntireDetectResponse>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<EntireDetectResponse> clientResponse = breakingChangeDetectEntireSeriesDelegate(response);
    ...
    private ServiceResponse<EntireDetectResponse> breakingChangeDetectEntireSeriesDelegate(Response<ResponseBody> response) throws AnomalyDetectorErrorException, IOException, IllegalArgumentException {
