...
public interface AnomalyDetectorClient {
    ...
    */
     ...
     */
    EntireDetectResponse breakingChangeDetectEntireSeries(DetectRequest body);
     ...
     */
    ServiceFuture<EntireDetectResponse> breakingChangeDetectEntireSeriesAsync(DetectRequest body, final ServiceCallback<EntireDetectResponse> serviceCallback);
     ...
     */
    Observable<EntireDetectResponse> breakingChangeDetectEntireSeriesAsync(DetectRequest body);
     ...
     * @return the observable to the EntireDetectResponse object
     */
    Observable<ServiceResponse<EntireDetectResponse>> breakingChangeDetectEntireSeriesWithServiceResponseAsync(DetectRequest body);
