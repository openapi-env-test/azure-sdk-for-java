...
public interface AnomalyDetectorClient {
    ...
    */
     ...
     */
    EntireDetectResponse shivangiTestDetectEntireSeries(DetectRequest body);
     ...
     */
    ServiceFuture<EntireDetectResponse> shivangiTestDetectEntireSeriesAsync(DetectRequest body, final ServiceCallback<EntireDetectResponse> serviceCallback);
     ...
     */
    Observable<EntireDetectResponse> shivangiTestDetectEntireSeriesAsync(DetectRequest body);
     ...
     * @return the observable to the EntireDetectResponse object
     */
    Observable<ServiceResponse<EntireDetectResponse>> shivangiTestDetectEntireSeriesWithServiceResponseAsync(DetectRequest body);
