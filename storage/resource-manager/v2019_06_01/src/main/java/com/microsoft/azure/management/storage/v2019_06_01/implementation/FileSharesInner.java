...
import com.microsoft.azure.management.storage.v2019_06_01.FileShareCreateParameters;
...
import com.microsoft.azure.management.storage.v2019_06_01.FileShareUpdateParameters;
...
public class FileSharesInner {
    ...
    public Observable<ServiceResponse<FileShareInner>> createWithServiceResponseAsync(String resourceGroupName, String accountName, String shareName) {
        ...
        final FileSharePropertiesCreateParameters properties = null;
        FileShareCreateParameters fileShare = new FileShareCreateParameters();
        fileShare.withProperties(null);
     ...
     * @return the FileShareInner object if successful.
     */
    public FileShareInner create(String resourceGroupName, String accountName, String shareName, FileSharePropertiesCreateParameters properties) {
        return createWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FileShareInner> createAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesCreateParameters properties, final ServiceCallback<FileShareInner> serviceCallback) {
        return ServiceFuture.fromResponse(createWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties), serviceCallback);
    }
     ...
     * @return the observable to the FileShareInner object
     */
    public Observable<FileShareInner> createAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesCreateParameters properties) {
        return createWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties).map(new Func1<ServiceResponse<FileShareInner>, FileShareInner>() {
            @Override
            public FileShareInner call(ServiceResponse<FileShareInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the FileShareInner object
     */
    public Observable<ServiceResponse<FileShareInner>> createWithServiceResponseAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesCreateParameters properties) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
        ...
        FileShareCreateParameters fileShare = new FileShareCreateParameters();
        fileShare.withProperties(properties);
        return service.create(resourceGroupName, accountName, shareName, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), fileShare, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<FileShareInner>>>() {
                @Override
                public Observable<ServiceResponse<FileShareInner>> call(Response<ResponseBody> response) {
    ...
    public Observable<ServiceResponse<FileShareInner>> updateWithServiceResponseAsync(String resourceGroupName, String accountName, String shareName) {
        ...
        final FileSharePropertiesUpdateParameters properties = null;
     ...
     * @return the FileShareInner object if successful.
     */
    public FileShareInner update(String resourceGroupName, String accountName, String shareName, FileSharePropertiesUpdateParameters properties) {
        return updateWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FileShareInner> updateAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesUpdateParameters properties, final ServiceCallback<FileShareInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties), serviceCallback);
    }
     ...
     * @return the observable to the FileShareInner object
     */
    public Observable<FileShareInner> updateAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesUpdateParameters properties) {
        return updateWithServiceResponseAsync(resourceGroupName, accountName, shareName, properties).map(new Func1<ServiceResponse<FileShareInner>, FileShareInner>() {
            @Override
            public FileShareInner call(ServiceResponse<FileShareInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the FileShareInner object
     */
    public Observable<ServiceResponse<FileShareInner>> updateWithServiceResponseAsync(String resourceGroupName, String accountName, String shareName, FileSharePropertiesUpdateParameters properties) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
