...
public final class RecommendationMetadatasClientImpl implements RecommendationMetadatasClient {
     ...
     * @return the entity along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the entity on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the entity along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
