...
import com.azure.resourcemanager.advisor.models.RecommendationsOperationsGenerateResponse;
import com.azure.resourcemanager.advisor.models.ResourceRecommendationBaseListResult;
import java.util.UUID;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in RecommendationsOperationsClient. */
public final class RecommendationsOperationsClientImpl implements RecommendationsOperationsClient {
    /** The proxy service used to perform REST calls. */
    private final RecommendationsOperationsService service;

    /** The service client containing this operation class. */
    private final AdvisorManagementClientImpl client;

    /**
     * Initializes an instance of RecommendationsOperationsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    RecommendationsOperationsClientImpl(AdvisorManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    RecommendationsOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AdvisorManagementClientRecommendationsOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AdvisorManagementCli")
    private interface RecommendationsOperationsService {
        @Headers({"Content-Type: application/json"})
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/generateRecommendations")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<RecommendationsOperationsGenerateResponse> generate(
    ...
    private Mono<RecommendationsOperationsGenerateResponse> generateWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecommendationsOperationsGenerateResponse> generateWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Void> generateAsync() {
        return generateWithResponseAsync().flatMap((RecommendationsOperationsGenerateResponse res) -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RecommendationsOperationsGenerateResponse generateWithResponse(Context context) {
