...
public final class RecommendationsOperationsImpl implements RecommendationsOperations {
    private static final ClientLogger LOGGER = new ClientLogger(RecommendationsOperationsImpl.class);

    private final RecommendationsOperationsClient innerClient;

    private final com.azure.resourcemanager.advisor.AdvisorManager serviceManager;

    public RecommendationsOperationsImpl(
        RecommendationsOperationsClient innerClient, com.azure.resourcemanager.advisor.AdvisorManager serviceManager) {
    ...
    private RecommendationsOperationsClient serviceClient() {
