...
public interface ProfilesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SsoUriInner generateSsoUriX(String resourceGroupName, String profileName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SsoUriInner> generateSsoUriXWithResponse(String resourceGroupName, String profileName, Context context);
