...
public final class CdnManagementClientImpl implements CdnManagementClient {
    ...
    /** The ProfilesTestsClient object to access its operations. */
    private final ProfilesTestsClient profilesTests;

    /**
     * Gets the ProfilesTestsClient object to access its operations.
     *
     * @return the ProfilesTestsClient object.
     */
    public ProfilesTestsClient getProfilesTests() {
        return this.profilesTests;
    }
    ...
    CdnManagementClientImpl(
        ...
        this.profilesTests = new ProfilesTestsClientImpl(this);
