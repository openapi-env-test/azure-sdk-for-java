...
public final class ProfilesClientImpl implements ProfilesClient {
    ...
    private interface ProfilesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SsoUriInner>> generateSsoUriX(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("profileName") String profileName,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SsoUriInner>> generateSsoUriXWithResponseAsync(String resourceGroupName, String profileName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SsoUriInner>> generateSsoUriXWithResponseAsync(
        String resourceGroupName, String profileName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SsoUriInner> generateSsoUriXAsync(String resourceGroupName, String profileName) {
        return generateSsoUriXWithResponseAsync(resourceGroupName, profileName)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SsoUriInner generateSsoUriX(String resourceGroupName, String profileName) {
        return generateSsoUriXAsync(resourceGroupName, profileName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SsoUriInner> generateSsoUriXWithResponse(
        String resourceGroupName, String profileName, Context context) {
        return generateSsoUriXWithResponseAsync(resourceGroupName, profileName, context).block();
    }
