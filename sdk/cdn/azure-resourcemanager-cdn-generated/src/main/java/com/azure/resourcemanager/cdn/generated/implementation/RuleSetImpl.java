...
public final class RuleSetImpl implements RuleSet, RuleSet.Definition {
    ...
    public PagedIterable<Usage> listResourceUsage() {
        return serviceManager.ruleSets().listResourceUsage(resourceGroupName, profileName, ruleSetName);
    }

    public PagedIterable<Usage> listResourceUsage(Context context) {
        return serviceManager.ruleSets().listResourceUsage(resourceGroupName, profileName, ruleSetName, context);
    }
}
