...
public final class ProfilesImpl implements Profiles {
    ...
    public SsoUri generateSsoUriX(String resourceGroupName, String profileName) {
        SsoUriInner inner = this.serviceClient().generateSsoUriX(resourceGroupName, profileName);
        if (inner != null) {
    ...
    public Response<SsoUri> generateSsoUriXWithResponse(String resourceGroupName, String profileName, Context context) {
        Response<SsoUriInner> inner =
            this.serviceClient().generateSsoUriXWithResponse(resourceGroupName, profileName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
