...
/** An instance of this class provides access to all the operations defined in ProfilesTestsClient. */
public final class ProfilesTestsClientImpl implements ProfilesTestsClient {
    private final ClientLogger logger = new ClientLogger(ProfilesTestsClientImpl.class);

    /** The proxy service used to perform REST calls. */
    private final ProfilesTestsService service;

    /** The service client containing this operation class. */
    private final CdnManagementClientImpl client;

    /**
     * Initializes an instance of ProfilesTestsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ProfilesTestsClientImpl(CdnManagementClientImpl client) {
        this.service =
            RestProxy.create(ProfilesTestsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for CdnManagementClientProfilesTests to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CdnManagementClientP")
    private interface ProfilesTestsService {
