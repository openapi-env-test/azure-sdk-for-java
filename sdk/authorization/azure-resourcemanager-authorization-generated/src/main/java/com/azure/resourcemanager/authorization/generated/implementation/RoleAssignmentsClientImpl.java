...
public final class RoleAssignmentsClientImpl implements RoleAssignmentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleAssignmentInner>> deleteByIdWithResponseAsync(String roleId, String tenantId) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .deleteById(
                            this.client.getEndpoint(), roleId, this.client.getApiVersion(), tenantId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RoleAssignmentInner>> deleteByIdWithResponseAsync(
        String roleId, String tenantId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        context = this.client.mergeContext(context);
        return service
            .deleteById(this.client.getEndpoint(), roleId, this.client.getApiVersion(), tenantId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentInner> deleteByIdAsync(String roleId, String tenantId) {
        return deleteByIdWithResponseAsync(roleId, tenantId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public RoleAssignmentInner deleteById(String roleId) {
        final String tenantId = null;
        return deleteByIdAsync(roleId, tenantId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleAssignmentInner> deleteByIdWithResponse(String roleId, String tenantId, Context context) {
        return deleteByIdWithResponseAsync(roleId, tenantId, context).block();
    }
    ...
    private Mono<Response<RoleAssignmentInner>> createByIdWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .createById(this.client.getEndpoint(), roleId, this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleAssignmentInner>> getByIdWithResponseAsync(String roleId, String tenantId) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<RoleAssignmentInner>> getByIdWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getById(this.client.getEndpoint(), roleId, this.client.getApiVersion(), tenantId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentInner> getByIdAsync(String roleId, String tenantId) {
        return getByIdWithResponseAsync(roleId, tenantId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public RoleAssignmentInner getById(String roleId) {
        final String tenantId = null;
        return getByIdAsync(roleId, tenantId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleAssignmentInner> getByIdWithResponse(String roleId, String tenantId, Context context) {
        return getByIdWithResponseAsync(roleId, tenantId, context).block();
    }
    ...
    private PagedFlux<RoleAssignmentInner> listAsync(String filter, String tenantId) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(filter, tenantId), nextLink -> listNextSinglePageAsync(nextLink));
    }
    ...
    private Mono<PagedResponse<RoleAssignmentInner>> listForScopeSinglePageAsync(
        ...
        return service
            .listForScope(
                this.client.getEndpoint(), scope, filter, this.client.getApiVersion(), tenantId, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
