...
public final class AccessReviewInstancesImpl implements AccessReviewInstances {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AccessReviewInstancesImpl.class);

    private final AccessReviewInstancesClient innerClient;

    private final AuthorizationManager serviceManager;

    public AccessReviewInstancesImpl(AccessReviewInstancesClient innerClient, AuthorizationManager serviceManager) {
