...
public final class AccessReviewScheduleDefinitionImpl
    ...
    public AccessReviewScopePrincipalType principalTypePropertiesScopePrincipalType() {
        return this.innerModel().principalTypePropertiesScopePrincipalType();
    }
    ...
    public AccessReviewRecurrenceRangeType typePropertiesSettingsRecurrenceRangeType() {
        return this.innerModel().typePropertiesSettingsRecurrenceRangeType();
    }
    ...
    public AccessReviewRecurrencePatternType typePropertiesSettingsRecurrencePatternType() {
        return this.innerModel().typePropertiesSettingsRecurrencePatternType();
    }
    ...
    public AccessReviewActorIdentityType principalTypePropertiesCreatedByPrincipalType() {
        return this.innerModel().principalTypePropertiesCreatedByPrincipalType();
    }
    ...
    AccessReviewScheduleDefinitionImpl(String name, AuthorizationManager serviceManager) {
    ...
    AccessReviewScheduleDefinitionImpl(
        AccessReviewScheduleDefinitionInner innerObject, AuthorizationManager serviceManager) {
    ...
    public AccessReviewScheduleDefinitionImpl withTypeSettingsRecurrenceRangeType(
        AccessReviewRecurrenceRangeType typeSettingsRecurrenceRangeType) {
        if (isInCreateMode()) {
            this.createProperties.withTypeSettingsRecurrenceRangeType(typeSettingsRecurrenceRangeType);
            return this;
        } else {
            this.updateProperties.withTypeSettingsRecurrenceRangeType(typeSettingsRecurrenceRangeType);
            return this;
        }
    }
    ...
    public AccessReviewScheduleDefinitionImpl withTypeSettingsRecurrencePatternType(
        AccessReviewRecurrencePatternType typeSettingsRecurrencePatternType) {
        if (isInCreateMode()) {
            this.createProperties.withTypeSettingsRecurrencePatternType(typeSettingsRecurrencePatternType);
            return this;
        } else {
            this.updateProperties.withTypeSettingsRecurrencePatternType(typeSettingsRecurrencePatternType);
            return this;
        }
    }
