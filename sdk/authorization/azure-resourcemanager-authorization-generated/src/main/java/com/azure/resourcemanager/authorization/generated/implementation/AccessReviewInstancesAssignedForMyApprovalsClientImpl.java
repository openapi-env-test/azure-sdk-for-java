...
public final class AccessReviewInstancesAssignedForMyApprovalsClientImpl
    ...
    private final ClientLogger logger = new ClientLogger(AccessReviewInstancesAssignedForMyApprovalsClientImpl.class);
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), scheduleDefinitionId, this.client.getApiVersion(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of Access Review Instances.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
