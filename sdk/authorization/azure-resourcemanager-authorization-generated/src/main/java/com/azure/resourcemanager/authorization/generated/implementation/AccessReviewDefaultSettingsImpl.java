...
public final class AccessReviewDefaultSettingsImpl implements AccessReviewDefaultSettings {
    ...
    AccessReviewDefaultSettingsImpl(AccessReviewDefaultSettingsInner innerObject, AuthorizationManager serviceManager) {
    ...
    public AccessReviewRecurrenceRangeType typePropertiesRecurrenceRangeType() {
        return this.innerModel().typePropertiesRecurrenceRangeType();
    }
    ...
    public AccessReviewRecurrencePatternType typePropertiesRecurrencePatternType() {
        return this.innerModel().typePropertiesRecurrencePatternType();
    }
