...
public final class GroupsList {
     ...
     * @return the GroupsList object itself.
     */
    public GroupsList setValue(List<Group> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the GroupsList object itself.
     */
    public GroupsList setNextLink(String nextLink) {
