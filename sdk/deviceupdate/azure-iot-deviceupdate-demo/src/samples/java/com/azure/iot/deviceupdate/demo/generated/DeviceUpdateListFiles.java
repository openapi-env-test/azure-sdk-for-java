    ...
    public static void main(String[] args) {
        DeviceUpdateClient deviceUpdateClient =
                new DeviceUpdateClientBuilder()
                        ...
                        .instanceId("blue")
                        .buildClient();
        // BEGIN:com.azure.iot.deviceupdate.demo.generated.deviceupdatelistfiles.deviceupdatelistfiles
        RequestOptions requestOptions = new RequestOptions();
        PagedIterable<BinaryData> response =
                deviceUpdateClient.listFiles("microsoft", "adu", "1.0.0.0", requestOptions);
        // END:com.azure.iot.deviceupdate.demo.generated.deviceupdatelistfiles.deviceupdatelistfiles
    }
}
