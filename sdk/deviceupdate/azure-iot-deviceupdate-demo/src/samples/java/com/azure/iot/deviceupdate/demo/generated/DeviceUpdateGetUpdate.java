    ...
    public static void main(String[] args) {
        DeviceUpdateClient deviceUpdateClient =
                new DeviceUpdateClientBuilder()
                        ...
                        .instanceId("blue")
                        .buildClient();
        // BEGIN:com.azure.iot.deviceupdate.demo.generated.deviceupdategetupdate.deviceupdategetupdate
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response =
                deviceUpdateClient.getUpdateWithResponse("microsoft", "adu", "1.0.0.0", requestOptions);
        // END:com.azure.iot.deviceupdate.demo.generated.deviceupdategetupdate.deviceupdategetupdate
    }
}
