...
package com.azure.iot.deviceupdate.demo.implementation;
...
public final class DeviceManagementsImpl {
    ...
    public Response<BinaryData> stopDeploymentAaaWithResponse(
            String groupId, String deviceClassId, String deploymentId, RequestOptions requestOptions) {
        return stopDeploymentAaaWithResponseAsync(groupId, deviceClassId, deploymentId, requestOptions).block();
    }
