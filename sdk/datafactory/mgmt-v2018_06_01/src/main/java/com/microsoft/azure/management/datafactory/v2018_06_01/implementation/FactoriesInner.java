...
public class FactoriesInner implements InnerSupportsGet<FactoryInner>, InnerSupportsDelete<Void>, InnerSupportsListing<FactoryInner> {
    ...
    interface FactoriesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datafactory.v2018_06_01.Factories configureFactoryRepoForDemo" })
        @POST("subscriptions/{subscriptionId}/providers/Microsoft.DataFactory/locations/{locationId}/configureFactoryRepoForDemo")
        Observable<Response<ResponseBody>> configureFactoryRepoForDemo(@Path("subscriptionId") String subscriptionId, @Path("locationId") String locationId, @Query("api-version") String apiVersion, @Body FactoryRepoUpdate factoryRepoUpdate, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public FactoryInner configureFactoryRepoForDemo(String locationId, FactoryRepoUpdate factoryRepoUpdate) {
        return configureFactoryRepoForDemoWithServiceResponseAsync(locationId, factoryRepoUpdate).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FactoryInner> configureFactoryRepoForDemoAsync(String locationId, FactoryRepoUpdate factoryRepoUpdate, final ServiceCallback<FactoryInner> serviceCallback) {
        return ServiceFuture.fromResponse(configureFactoryRepoForDemoWithServiceResponseAsync(locationId, factoryRepoUpdate), serviceCallback);
    }
     ...
     */
    public Observable<FactoryInner> configureFactoryRepoForDemoAsync(String locationId, FactoryRepoUpdate factoryRepoUpdate) {
        return configureFactoryRepoForDemoWithServiceResponseAsync(locationId, factoryRepoUpdate).map(new Func1<ServiceResponse<FactoryInner>, FactoryInner>() {
            @Override
     ...
     * @return the observable to the FactoryInner object
     */
    public Observable<ServiceResponse<FactoryInner>> configureFactoryRepoForDemoWithServiceResponseAsync(String locationId, FactoryRepoUpdate factoryRepoUpdate) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (locationId == null) {
        ...
        return service.configureFactoryRepoForDemo(this.client.subscriptionId(), locationId, this.client.apiVersion(), factoryRepoUpdate, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<FactoryInner>>>() {
                ...
                public Observable<ServiceResponse<FactoryInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<FactoryInner> clientResponse = configureFactoryRepoForDemoDelegate(response);
    ...
    private ServiceResponse<FactoryInner> configureFactoryRepoForDemoDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
