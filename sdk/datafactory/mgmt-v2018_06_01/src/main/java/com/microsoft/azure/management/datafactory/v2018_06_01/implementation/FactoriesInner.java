...
public class FactoriesInner implements InnerSupportsGet<FactoryInner>, InnerSupportsDelete<Void>, InnerSupportsListing<FactoryInner> {
    ...
    interface FactoriesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datafactory.v2018_06_01.Factories getGitHubAccessTokenDemo" })
        @POST("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/getGitHubAccessTokenDemo")
        Observable<Response<ResponseBody>> getGitHubAccessTokenDemo(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("factoryName") String factoryName, @Query("api-version") String apiVersion, @Body GitHubAccessTokenRequest gitHubAccessTokenRequest, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @return the GitHubAccessTokenResponseInner object if successful.
     */
    public GitHubAccessTokenResponseInner getGitHubAccessTokenDemo(String resourceGroupName, String factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest) {
        return getGitHubAccessTokenDemoWithServiceResponseAsync(resourceGroupName, factoryName, gitHubAccessTokenRequest).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<GitHubAccessTokenResponseInner> getGitHubAccessTokenDemoAsync(String resourceGroupName, String factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest, final ServiceCallback<GitHubAccessTokenResponseInner> serviceCallback) {
        return ServiceFuture.fromResponse(getGitHubAccessTokenDemoWithServiceResponseAsync(resourceGroupName, factoryName, gitHubAccessTokenRequest), serviceCallback);
    }
     ...
     * @return the observable to the GitHubAccessTokenResponseInner object
     */
    public Observable<GitHubAccessTokenResponseInner> getGitHubAccessTokenDemoAsync(String resourceGroupName, String factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest) {
        return getGitHubAccessTokenDemoWithServiceResponseAsync(resourceGroupName, factoryName, gitHubAccessTokenRequest).map(new Func1<ServiceResponse<GitHubAccessTokenResponseInner>, GitHubAccessTokenResponseInner>() {
            @Override
            public GitHubAccessTokenResponseInner call(ServiceResponse<GitHubAccessTokenResponseInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the GitHubAccessTokenResponseInner object
     */
    public Observable<ServiceResponse<GitHubAccessTokenResponseInner>> getGitHubAccessTokenDemoWithServiceResponseAsync(String resourceGroupName, String factoryName, GitHubAccessTokenRequest gitHubAccessTokenRequest) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        Validator.validate(gitHubAccessTokenRequest);
        return service.getGitHubAccessTokenDemo(this.client.subscriptionId(), resourceGroupName, factoryName, this.client.apiVersion(), gitHubAccessTokenRequest, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<GitHubAccessTokenResponseInner>>>() {
                @Override
                public Observable<ServiceResponse<GitHubAccessTokenResponseInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<GitHubAccessTokenResponseInner> clientResponse = getGitHubAccessTokenDemoDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<GitHubAccessTokenResponseInner> getGitHubAccessTokenDemoDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<GitHubAccessTokenResponseInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<GitHubAccessTokenResponseInner>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
