...
public final class SchedulesImpl implements Schedules {
    ...
    public PagedIterable<Schedule> list(String resourceGroupName, String workspaceName, String skip, Context context) {
        PagedIterable<ScheduleInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, skip, context);
        return Utils.mapPage(inner, inner1 -> new ScheduleImpl(inner1, this.manager()));
    }
