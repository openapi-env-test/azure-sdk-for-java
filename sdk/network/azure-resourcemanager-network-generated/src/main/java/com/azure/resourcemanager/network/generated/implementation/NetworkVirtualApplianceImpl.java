...
public final class NetworkVirtualApplianceImpl
    ...
    public List<String> bootStrapConfigurationBlob() {
        List<String> inner = this.innerModel().bootStrapConfigurationBlob();
        if (inner != null) {
    ...
    public List<String> cloudInitConfigurationBlob() {
        List<String> inner = this.innerModel().cloudInitConfigurationBlob();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public NetworkVirtualApplianceImpl withBootStrapConfigurationBlob(List<String> bootStrapConfigurationBlob) {
        this.innerModel().withBootStrapConfigurationBlob(bootStrapConfigurationBlob);
        return this;
    }
    ...
    public NetworkVirtualApplianceImpl withCloudInitConfigurationBlob(List<String> cloudInitConfigurationBlob) {
        this.innerModel().withCloudInitConfigurationBlob(cloudInitConfigurationBlob);
        return this;
    }
