...
import com.azure.resourcemanager.network.generated.implementation.FirewallPolicyRuleGroupsImpl;
...
import com.azure.resourcemanager.network.generated.implementation.P2SVpnServerConfigurationsImpl;
...
public final class NetworkManager {
    ...
    /** @return Resource collection API of FirewallPolicyRuleGroups. */
    public FirewallPolicyRuleGroups firewallPolicyRuleGroups() {
        if (this.firewallPolicyRuleGroups == null) {
            this.firewallPolicyRuleGroups =
                new FirewallPolicyRuleGroupsImpl(clientObject.getFirewallPolicyRuleGroups(), this);
        }
        return firewallPolicyRuleGroups;
    }
    ...
    /** @return Resource collection API of P2SVpnServerConfigurations. */
    public P2SVpnServerConfigurations p2SVpnServerConfigurations() {
        if (this.p2SVpnServerConfigurations == null) {
            this.p2SVpnServerConfigurations =
                new P2SVpnServerConfigurationsImpl(clientObject.getP2SVpnServerConfigurations(), this);
        }
