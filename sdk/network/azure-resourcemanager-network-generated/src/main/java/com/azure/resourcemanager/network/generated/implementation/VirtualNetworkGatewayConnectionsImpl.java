...
public final class VirtualNetworkGatewayConnectionsImpl implements VirtualNetworkGatewayConnections {
    ...
    public VirtualNetworkGatewayConnectionListEntity updateTags(
        String resourceGroupName, String virtualNetworkGatewayConnectionName, TagsObject parameters) {
        VirtualNetworkGatewayConnectionListEntityInner inner =
            this.serviceClient().updateTags(resourceGroupName, virtualNetworkGatewayConnectionName, parameters);
        if (inner != null) {
            return new VirtualNetworkGatewayConnectionListEntityImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public VirtualNetworkGatewayConnectionListEntity updateTags(
        ...
        VirtualNetworkGatewayConnectionListEntityInner inner =
            this
                .serviceClient()
                .updateTags(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, context);
        if (inner != null) {
            return new VirtualNetworkGatewayConnectionListEntityImpl(inner, this.manager());
        } else {
            return null;
