...
public class SecurityRuleInner extends SubResource {
    ...
    /*
     * The destination address prefix. CIDR or source IP range. Asterisk '*'
    ...
    /**
     * Get the destinationAddressPrefix property: The destination address prefix. CIDR or source IP range. Asterisk '*'
    ...
    /**
     * Set the destinationAddressPrefix property: The destination address prefix. CIDR or source IP range. Asterisk '*'
     * can also be used to match all source IPs. Default tags such as 'VirtualNetwork', 'AzureLoadBalancer' and
     * 'Internet' can also be used.
     *
