...
public final class VirtualNetworksClientImpl implements VirtualNetworksClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BastionHostListResultInner>> getBastionHostsWithResponseAsync(
        String resourceGroupName, String virtualNetworkName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BastionHostListResultInner> getBastionHostsAsync(String resourceGroupName, String virtualNetworkName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BastionHostListResultInner> getBastionHostsWithResponse(
        String resourceGroupName, String virtualNetworkName, Context context) {
        return getBastionHostsWithResponseAsync(resourceGroupName, virtualNetworkName, context).block();
    }
