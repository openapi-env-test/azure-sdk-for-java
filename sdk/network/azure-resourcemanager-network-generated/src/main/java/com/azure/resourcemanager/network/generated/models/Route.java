...
public interface Route {
    ...
    /**
     * Gets the addressPrefix property: Gets or sets the destination CIDR to which the route applies.
     *
    ...
    /**
     * Gets the nextHopType property: Gets or sets the type of Azure hop the packet should be sent to.
     *
    ...
    /**
     * Gets the nextHopIpAddress property: Gets or sets the IP address packets should be forwarded to. Next hop values
