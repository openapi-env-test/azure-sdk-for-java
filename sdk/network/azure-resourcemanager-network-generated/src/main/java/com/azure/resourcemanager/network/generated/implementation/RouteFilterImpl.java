...
import com.azure.resourcemanager.network.generated.models.PatchRouteFilter;
...
public final class RouteFilterImpl implements RouteFilter, RouteFilter.Definition, RouteFilter.Update {
    ...
    private PatchRouteFilter updateRouteFilterParameters;
    ...
    public RouteFilterImpl update() {
        this.updateRouteFilterParameters = new PatchRouteFilter();
        return this;
    }
    ...
    public RouteFilter apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getRouteFilters()
                .update(resourceGroupName, routeFilterName, updateRouteFilterParameters, Context.NONE);
        return this;
    }
    ...
    public RouteFilter apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getRouteFilters()
                .update(resourceGroupName, routeFilterName, updateRouteFilterParameters, context);
        return this;
    }
    ...
    public RouteFilterImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
            ...
            this.updateRouteFilterParameters.withTags(tags);
            return this;
        }
    }
    ...
    public RouteFilterImpl withRules(List<RouteFilterRuleInner> rules) {
        if (isInCreateMode()) {
            ...
            this.updateRouteFilterParameters.withRules(rules);
            return this;
        }
    }
    ...
    public RouteFilterImpl withPeerings(List<ExpressRouteCircuitPeeringInner> peerings) {
        if (isInCreateMode()) {
            ...
            this.updateRouteFilterParameters.withPeerings(peerings);
            return this;
        }
    }
    ...
    public RouteFilterImpl withIpv6Peerings(List<ExpressRouteCircuitPeeringInner> ipv6Peerings) {
        if (isInCreateMode()) {
            this.innerModel().withIpv6Peerings(ipv6Peerings);
            return this;
        } else {
            this.updateRouteFilterParameters.withIpv6Peerings(ipv6Peerings);
            return this;
        }
    }
