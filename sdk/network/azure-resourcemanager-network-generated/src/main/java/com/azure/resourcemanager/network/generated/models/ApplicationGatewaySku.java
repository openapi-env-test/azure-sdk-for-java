...
public final class ApplicationGatewaySku {
    ...
    /**
     * Get the name property: Gets or sets name of application gateway SKU.
     *
    ...
    /**
     * Set the name property: Gets or sets name of application gateway SKU.
     *
    ...
    /**
     * Get the tier property: Gets or sets tier of application gateway.
     *
    ...
    /**
     * Set the tier property: Gets or sets tier of application gateway.
     *
    ...
    /**
     * Get the capacity property: Gets or sets capacity (instance count) of application gateway.
     *
    ...
    /**
     * Set the capacity property: Gets or sets capacity (instance count) of application gateway.
     *
