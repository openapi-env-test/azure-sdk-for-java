...
public final class PublicIpPrefixImpl implements PublicIpPrefix, PublicIpPrefix.Definition, PublicIpPrefix.Update {
    ...
    public PublicIpPrefix apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getPublicIpPrefixes()
                .updateTags(resourceGroupName, publicIpPrefixName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public PublicIpPrefix apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getPublicIpPrefixes()
                .updateTags(resourceGroupName, publicIpPrefixName, updateParameters, context);
        return this;
    }
    ...
    public PublicIpPrefixImpl withIpPrefix(String ipPrefix) {
        this.innerModel().withIpPrefix(ipPrefix);
        return this;
    }
