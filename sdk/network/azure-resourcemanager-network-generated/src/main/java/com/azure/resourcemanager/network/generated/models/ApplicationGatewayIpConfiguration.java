...
public class ApplicationGatewayIpConfiguration extends SubResource {
    ...
    /**
     * Get the subnet property: Gets or sets the reference of the subnet resource.A subnet from where application
    ...
    /**
     * Set the subnet property: Gets or sets the reference of the subnet resource.A subnet from where application
     * gateway gets its private address.
     *
    ...
    /**
     * Get the provisioningState property: Gets or sets Provisioning state of the application gateway subnet resource
    ...
    /**
     * Set the provisioningState property: Gets or sets Provisioning state of the application gateway subnet resource
     * Updating/Deleting/Failed.
     *
