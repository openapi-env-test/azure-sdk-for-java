...
public class FlowLogInformationInner {
    ...
    /**
     * Get the targetResourceId property: The ID of the resource to configure for flow logging.
     *
    ...
    /**
     * Set the targetResourceId property: The ID of the resource to configure for flow logging.
     *
