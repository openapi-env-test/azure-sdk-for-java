...
public final class LoadBalancersImpl implements LoadBalancers {
    ...
    public Response<LoadBalancer> getByResourceGroupWithResponse(
        ...
        Response<LoadBalancerInner> inner =
            this.serviceClient().getByResourceGroupWithResponse(resourceGroupName, loadBalancerName, context);
        if (inner != null) {
    ...
    public LoadBalancer getById(String id) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, loadBalancerName, Context.NONE).getValue();
    }
    ...
    public Response<LoadBalancer> getByIdWithResponse(String id, Context context) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, loadBalancerName, context);
    }
