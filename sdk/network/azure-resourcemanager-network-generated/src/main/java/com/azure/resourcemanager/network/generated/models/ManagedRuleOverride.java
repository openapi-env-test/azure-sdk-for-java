...
public final class ManagedRuleOverride {
    ...
    /**
     * Get the state property: Describes the state of the managed rule. Defaults to Disabled if not specified.
     *
    ...
    /**
     * Set the state property: Describes the state of the managed rule. Defaults to Disabled if not specified.
     *
