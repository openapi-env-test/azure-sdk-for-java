...
public class InboundNatRuleInner extends SubResource {
     ...
     * VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backed IP.
     *
    ...
    /**
     * Get the protocol property: The transport protocol for the endpoint. Possible values are: 'Udp' or 'Tcp'.
     *
    ...
    /**
     * Set the protocol property: The transport protocol for the endpoint. Possible values are: 'Udp' or 'Tcp'.
     *
