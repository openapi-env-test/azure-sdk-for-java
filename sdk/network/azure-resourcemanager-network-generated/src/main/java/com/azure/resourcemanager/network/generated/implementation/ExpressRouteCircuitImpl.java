...
public final class ExpressRouteCircuitImpl
    ...
    public Boolean allowGlobalReach() {
        return this.innerModel().allowGlobalReach();
    }
    ...
    public ExpressRouteCircuit apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRouteCircuits()
                .updateTags(resourceGroupName, circuitName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public ExpressRouteCircuit apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRouteCircuits()
                .updateTags(resourceGroupName, circuitName, updateParameters, context);
        return this;
    }
    ...
    public ExpressRouteCircuitImpl withAllowGlobalReach(Boolean allowGlobalReach) {
        this.innerModel().withAllowGlobalReach(allowGlobalReach);
        return this;
    }
