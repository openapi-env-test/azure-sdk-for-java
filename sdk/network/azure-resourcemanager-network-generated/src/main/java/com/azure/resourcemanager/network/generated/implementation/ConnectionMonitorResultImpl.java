...
public final class ConnectionMonitorResultImpl
    ...
    private ConnectionMonitor updateParameters;
    ...
    public ConnectionMonitorResultImpl update() {
        this.updateParameters = new ConnectionMonitor();
        return this;
    }
    ...
    public ConnectionMonitorResultImpl withDestination(ConnectionMonitorDestination destination) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withDestination(destination);
            return this;
        }
    }
    ...
    public ConnectionMonitorResultImpl withAutoStart(Boolean autoStart) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withAutoStart(autoStart);
            return this;
        }
    }
    ...
    public ConnectionMonitorResultImpl withMonitoringIntervalInSeconds(Integer monitoringIntervalInSeconds) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withMonitoringIntervalInSeconds(monitoringIntervalInSeconds);
            return this;
        }
    }
