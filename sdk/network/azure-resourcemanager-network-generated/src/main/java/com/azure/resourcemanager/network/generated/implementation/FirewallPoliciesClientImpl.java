...
public final class FirewallPoliciesClientImpl implements FirewallPoliciesClient {
    ...
    private Mono<Response<FirewallPolicyInner>> updateTagsWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, TagsObject firewallPolicyParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (firewallPolicyParameters == null) {
            return Mono
                .error(
                    new IllegalArgumentException("Parameter firewallPolicyParameters is required and cannot be null."));
        } else {
            firewallPolicyParameters.validate();
        }
        final String apiVersion = "2019-06-01";
        final String accept = "application/json";
        return FluxUtil
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirewallPolicyInner>> updateTagsWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, TagsObject firewallPolicyParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    public Response<FirewallPolicyInner> updateTagsWithResponse(
        String resourceGroupName, String firewallPolicyName, TagsObject firewallPolicyParameters, Context context) {
        return updateTagsWithResponseAsync(resourceGroupName, firewallPolicyName, firewallPolicyParameters, context)
            .block();
    }
