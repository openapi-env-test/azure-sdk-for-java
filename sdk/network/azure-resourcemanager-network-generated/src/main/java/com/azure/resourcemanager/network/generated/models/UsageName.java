...
public final class UsageName {
    ...
    /**
     * Get the value property: Gets or sets a string describing the resource name.
     *
    ...
    /**
     * Set the value property: Gets or sets a string describing the resource name.
     *
    ...
    /**
     * Get the localizedValue property: Gets or sets a localized string describing the resource name.
     *
    ...
    /**
     * Set the localizedValue property: Gets or sets a localized string describing the resource name.
     *
