...
public final class BastionHostImpl implements BastionHost, BastionHost.Definition, BastionHost.Update {
    ...
    private TagsObject updateBastionHostParameters;
    ...
    public BastionHostImpl update() {
        this.updateBastionHostParameters = new TagsObject();
        return this;
    }
    ...
    public BastionHost apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getBastionHosts()
                .updateTags(resourceGroupName, bastionHostname, updateBastionHostParameters, Context.NONE);
        return this;
    }
    ...
    public BastionHost apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getBastionHosts()
                .updateTags(resourceGroupName, bastionHostname, updateBastionHostParameters, context);
        return this;
    }
    ...
    public BastionHostImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
            ...
            this.updateBastionHostParameters.withTags(tags);
            return this;
        }
    }
