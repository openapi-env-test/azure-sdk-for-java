...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public DnsNameAvailabilityResult checkDnsNameAvailability(String location) {
        DnsNameAvailabilityResultInner inner = this.serviceClient().checkDnsNameAvailability(location);
        if (inner != null) {
