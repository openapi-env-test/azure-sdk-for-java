...
public final class PublicIpAddressImpl implements PublicIpAddress, PublicIpAddress.Definition, PublicIpAddress.Update {
    ...
    public SubResource ipConfiguration() {
        return this.innerModel().ipConfiguration();
    }
    ...
    public PublicIpAddress refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getPublicIpAddresses()
                .getByResourceGroupWithResponse(resourceGroupName, publicIpAddressName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public PublicIpAddress refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getPublicIpAddresses()
                .getByResourceGroupWithResponse(resourceGroupName, publicIpAddressName, context)
                .getValue();
        return this;
    }
    ...
    public PublicIpAddressImpl withIpConfiguration(SubResource ipConfiguration) {
        this.innerModel().withIpConfiguration(ipConfiguration);
        return this;
    }
