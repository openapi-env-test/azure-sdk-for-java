...
public final class NetworkRuleCondition extends FirewallPolicyRuleCondition {
     ...
     * @return the NetworkRuleCondition object itself.
     */
    public NetworkRuleCondition withSourceIpGroups(List<String> sourceIpGroups) {
     ...
     * @return the NetworkRuleCondition object itself.
     */
    public NetworkRuleCondition withDestinationIpGroups(List<String> destinationIpGroups) {
    ...
    /** {@inheritDoc} */
    @Override
    public NetworkRuleCondition withName(String name) {
        super.withName(name);
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public NetworkRuleCondition withDescription(String description) {
