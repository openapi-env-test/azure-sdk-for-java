...
public class RouteInner extends SubResource {
    ...
    /**
     * Get the addressPrefix property: Gets or sets the destination CIDR to which the route applies.
     *
    ...
    /**
     * Set the addressPrefix property: Gets or sets the destination CIDR to which the route applies.
     *
    ...
    /**
     * Get the nextHopType property: Gets or sets the type of Azure hop the packet should be sent to.
     *
    ...
    /**
     * Set the nextHopType property: Gets or sets the type of Azure hop the packet should be sent to.
     *
    ...
    /**
     * Get the nextHopIpAddress property: Gets or sets the IP address packets should be forwarded to. Next hop values
    ...
    /**
     * Set the nextHopIpAddress property: Gets or sets the IP address packets should be forwarded to. Next hop values
     * are only allowed in routes where the next hop type is VirtualAppliance.
     *
