...
public final class VirtualWanImpl implements VirtualWan, VirtualWan.Definition, VirtualWan.Update {
    ...
    public List<P2SVpnServerConfiguration> p2SVpnServerConfigurations() {
        List<P2SVpnServerConfigurationInner> inner = this.innerModel().p2SVpnServerConfigurations();
        if (inner != null) {
            return Collections
                .unmodifiableList(
                    inner
                        .stream()
                        .map(inner1 -> new P2SVpnServerConfigurationImpl(inner1, this.manager()))
    ...
    public VirtualWan apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getVirtualWans()
                .updateTags(resourceGroupName, virtualWanName, updateWanParameters, Context.NONE);
        return this;
    }
    ...
    public VirtualWan apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getVirtualWans()
                .updateTags(resourceGroupName, virtualWanName, updateWanParameters, context);
        return this;
    }
    ...
    public VirtualWanImpl withP2SVpnServerConfigurations(
        List<P2SVpnServerConfigurationInner> p2SVpnServerConfigurations) {
        this.innerModel().withP2SVpnServerConfigurations(p2SVpnServerConfigurations);
        return this;
    }
