    ...
    public DdosCustomPolicy apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDdosCustomPolicies()
                .updateTags(resourceGroupName, ddosCustomPolicyName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public DdosCustomPolicy apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDdosCustomPolicies()
                .updateTags(resourceGroupName, ddosCustomPolicyName, updateParameters, context);
        return this;
    }
