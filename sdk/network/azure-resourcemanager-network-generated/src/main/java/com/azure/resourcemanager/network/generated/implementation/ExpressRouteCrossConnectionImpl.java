...
public final class ExpressRouteCrossConnectionImpl
    ...
    public ExpressRouteCrossConnection apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRouteCrossConnections()
                .updateTags(resourceGroupName, crossConnectionName, updateCrossConnectionParameters, Context.NONE);
        return this;
    }
    ...
    public ExpressRouteCrossConnection apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRouteCrossConnections()
                .updateTags(resourceGroupName, crossConnectionName, updateCrossConnectionParameters, context);
        return this;
    }
    ...
    public ExpressRouteCrossConnectionImpl withBandwidthInMbps(Integer bandwidthInMbps) {
        this.innerModel().withBandwidthInMbps(bandwidthInMbps);
        return this;
    }
