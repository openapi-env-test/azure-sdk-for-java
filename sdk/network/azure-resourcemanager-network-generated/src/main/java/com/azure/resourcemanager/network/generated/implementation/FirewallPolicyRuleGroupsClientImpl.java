...
import com.azure.resourcemanager.network.generated.models.FirewallPolicyRuleGroupListResult;
...
public final class FirewallPolicyRuleGroupsClientImpl implements FirewallPolicyRuleGroupsClient {
    private final ClientLogger logger = new ClientLogger(FirewallPolicyRuleGroupsClientImpl.class);
    ...
    /**
     * Initializes an instance of FirewallPolicyRuleGroupsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    FirewallPolicyRuleGroupsClientImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String firewallPolicyName, String ruleGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirewallPolicyRuleGroupInner>> getWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyRuleGroupInner> getAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FirewallPolicyRuleGroupInner> getWithResponse(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName, Context context) {
        return getWithResponseAsync(resourceGroupName, firewallPolicyName, ruleGroupName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<FirewallPolicyRuleGroupInner>, FirewallPolicyRuleGroupInner> beginCreateOrUpdateAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleGroupName,
        FirewallPolicyRuleGroupInner parameters) {
        ...
        return this
            .client
            .<FirewallPolicyRuleGroupInner, FirewallPolicyRuleGroupInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyRuleGroupInner> createOrUpdateAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleGroupName,
        FirewallPolicyRuleGroupInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FirewallPolicyRuleGroupInner>> listSinglePageAsync(
    ...
    private PagedFlux<FirewallPolicyRuleGroupInner> listAsync(String resourceGroupName, String firewallPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<FirewallPolicyRuleGroupInner> listAsync(
        String resourceGroupName, String firewallPolicyName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FirewallPolicyRuleGroupInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FirewallPolicyRuleGroupInner>> listNextSinglePageAsync(
