...
public final class ExpressRouteCircuitPeeringConfig {
    ...
    /**
     * Get the advertisedPublicPrefixes property: Gets or sets the reference of AdvertisedPublicPrefixes.
     *
    ...
    /**
     * Set the advertisedPublicPrefixes property: Gets or sets the reference of AdvertisedPublicPrefixes.
     *
    ...
    /**
     * Get the advertisedPublicPrefixesState property: Gets or sets AdvertisedPublicPrefixState of the Peering resource.
     *
    ...
    /**
     * Set the advertisedPublicPrefixesState property: Gets or sets AdvertisedPublicPrefixState of the Peering resource.
     *
    ...
    /**
     * Get the customerAsn property: Gets or Sets CustomerAsn of the peering.
     *
    ...
    /**
     * Set the customerAsn property: Gets or Sets CustomerAsn of the peering.
     *
    ...
    /**
     * Get the routingRegistryName property: Gets or Sets RoutingRegistryName of the config.
     *
    ...
    /**
     * Set the routingRegistryName property: Gets or Sets RoutingRegistryName of the config.
     *
