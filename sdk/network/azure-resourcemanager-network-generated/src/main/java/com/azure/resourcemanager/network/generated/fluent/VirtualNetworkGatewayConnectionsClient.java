...
public interface VirtualNetworkGatewayConnectionsClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<
            PollResult<VirtualNetworkGatewayConnectionListEntityInner>, VirtualNetworkGatewayConnectionListEntityInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VirtualNetworkGatewayConnectionListEntityInner updateTags(
