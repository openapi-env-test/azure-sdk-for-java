...
import com.azure.resourcemanager.network.generated.models.PatchRouteFilterRule;
...
public final class RouteFilterRulesImpl implements RouteFilterRules {
    ...
    public RouteFilterRule update(
        String resourceGroupName,
        String routeFilterName,
        String ruleName,
        PatchRouteFilterRule routeFilterRuleParameters) {
        RouteFilterRuleInner inner =
            this.serviceClient().update(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters);
        if (inner != null) {
            return new RouteFilterRuleImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RouteFilterRule update(
        ...
        RouteFilterRuleInner inner =
            this
                .serviceClient()
                .update(resourceGroupName, routeFilterName, ruleName, routeFilterRuleParameters, context);
        if (inner != null) {
            return new RouteFilterRuleImpl(inner, this.manager());
        } else {
            return null;
