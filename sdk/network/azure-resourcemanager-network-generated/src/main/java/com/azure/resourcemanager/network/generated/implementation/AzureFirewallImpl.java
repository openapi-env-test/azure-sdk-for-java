    ...
    public AzureFirewall apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAzureFirewalls()
                .updateTagsWithResponse(resourceGroupName, azureFirewallName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public AzureFirewall apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAzureFirewalls()
                .updateTagsWithResponse(resourceGroupName, azureFirewallName, this.innerModel(), context)
                .getValue();
        return this;
    }
