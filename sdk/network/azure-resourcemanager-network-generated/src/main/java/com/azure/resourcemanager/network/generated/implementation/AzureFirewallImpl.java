    ...
    public AzureFirewall apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAzureFirewalls()
                .updateTagsWithResponse(resourceGroupName, azureFirewallName, updateParameters, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public AzureFirewall apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAzureFirewalls()
                .updateTagsWithResponse(resourceGroupName, azureFirewallName, updateParameters, context)
                .getValue();
        return this;
    }
