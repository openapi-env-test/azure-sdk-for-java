...
public final class BastionHostsClientImpl implements BastionHostsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateTagsWithResponseAsync(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (bastionHostParameters == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter bastionHostParameters is required and cannot be null."));
        } else {
            bastionHostParameters.validate();
        }
        final String apiVersion = "2019-06-01";
        final String accept = "application/json";
        return FluxUtil
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateTagsWithResponseAsync(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<BastionHostInner>, BastionHostInner> beginUpdateTagsAsync(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateTagsWithResponseAsync(resourceGroupName, bastionHostname, bastionHostParameters);
        return this
            .client
            .<BastionHostInner, BastionHostInner>getLroResult(
                mono, this.client.getHttpPipeline(), BastionHostInner.class, BastionHostInner.class, Context.NONE);
    ...
    private PollerFlux<PollResult<BastionHostInner>, BastionHostInner> beginUpdateTagsAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateTagsWithResponseAsync(resourceGroupName, bastionHostname, bastionHostParameters, context);
        return this
            .client
            .<BastionHostInner, BastionHostInner>getLroResult(
                mono, this.client.getHttpPipeline(), BastionHostInner.class, BastionHostInner.class, context);
    ...
    public SyncPoller<PollResult<BastionHostInner>, BastionHostInner> beginUpdateTags(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters) {
        return beginUpdateTagsAsync(resourceGroupName, bastionHostname, bastionHostParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<BastionHostInner>, BastionHostInner> beginUpdateTags(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters, Context context) {
        return beginUpdateTagsAsync(resourceGroupName, bastionHostname, bastionHostParameters, context).getSyncPoller();
    }
    ...
    private Mono<BastionHostInner> updateTagsAsync(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters) {
        return beginUpdateTagsAsync(resourceGroupName, bastionHostname, bastionHostParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<BastionHostInner> updateTagsAsync(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters, Context context) {
        return beginUpdateTagsAsync(resourceGroupName, bastionHostname, bastionHostParameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public BastionHostInner updateTags(
        String resourceGroupName, String bastionHostname, TagsObject bastionHostParameters, Context context) {
        return updateTagsAsync(resourceGroupName, bastionHostname, bastionHostParameters, context).block();
    }
