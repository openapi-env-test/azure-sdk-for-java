...
public final class RouteTablesImpl implements RouteTables {
    ...
    public Response<RouteTable> getByResourceGroupWithResponse(
        ...
        Response<RouteTableInner> inner =
            this.serviceClient().getByResourceGroupWithResponse(resourceGroupName, routeTableName, context);
        if (inner != null) {
    ...
    public RouteTable getById(String id) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, routeTableName, Context.NONE).getValue();
    }

    public Response<RouteTable> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, routeTableName, context);
    }
