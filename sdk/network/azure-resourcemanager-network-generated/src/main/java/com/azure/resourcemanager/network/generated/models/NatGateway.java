...
public interface NatGateway {
    ...
    /**
     * Gets the provisioningState property: The provisioning state of the NatGateway resource. Possible values are:
    ...
    interface DefinitionStages {
        ...
        interface WithResourceGuid {
            /**
             * Specifies the resourceGuid property: The resource GUID property of the nat gateway resource..
             *
        ...
        interface WithProvisioningState {
            /**
             * Specifies the provisioningState property: The provisioning state of the NatGateway resource. Possible
             * values are: 'Updating', 'Deleting', and 'Failed'..
             *
             * @param provisioningState The provisioning state of the NatGateway resource. Possible values are:
             *     'Updating', 'Deleting', and 'Failed'.
             * @return the next definition stage.
             */
