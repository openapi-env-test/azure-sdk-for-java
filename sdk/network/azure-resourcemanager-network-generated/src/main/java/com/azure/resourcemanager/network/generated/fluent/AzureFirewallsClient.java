...
public interface AzureFirewallsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureFirewallInner updateTags(String resourceGroupName, String azureFirewallName, AzureFirewallInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureFirewallInner> updateTagsWithResponse(
        String resourceGroupName, String azureFirewallName, AzureFirewallInner parameters, Context context);
