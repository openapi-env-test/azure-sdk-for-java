    ...
    public ExpressRoutePort apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRoutePorts()
                .updateTags(resourceGroupName, expressRoutePortName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public ExpressRoutePort apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getExpressRoutePorts()
                .updateTags(resourceGroupName, expressRoutePortName, updateParameters, context);
        return this;
    }
