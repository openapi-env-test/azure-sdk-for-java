    ...
    public DdosProtectionPlan apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDdosProtectionPlans()
                .updateTags(resourceGroupName, ddosProtectionPlanName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public DdosProtectionPlan apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDdosProtectionPlans()
                .updateTags(resourceGroupName, ddosProtectionPlanName, updateParameters, context);
        return this;
    }
