...
public class ProbeInner extends SubResource {
    ...
    /**
     * Get the protocol property: The protocol of the end point. Possible values are: 'Http', 'Tcp' or 'Https'. If 'Tcp'
     * is specified, a received ACK is required for the probe to be successful. If 'Http' or 'Https' is specified, a 200
     * OK response from the specifies URI is required for the probe to be successful.
     *
    ...
    /**
     * Set the protocol property: The protocol of the end point. Possible values are: 'Http', 'Tcp' or 'Https'. If 'Tcp'
     * is specified, a received ACK is required for the probe to be successful. If 'Http' or 'Https' is specified, a 200
     * OK response from the specifies URI is required for the probe to be successful.
     *
