...
public final class VirtualNetworksImpl implements VirtualNetworks {
    ...
    public BastionHostListResult getBastionHosts(String resourceGroupName, String virtualNetworkName) {
        BastionHostListResultInner inner = this.serviceClient().getBastionHosts(resourceGroupName, virtualNetworkName);
        if (inner != null) {
            return new BastionHostListResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<BastionHostListResult> getBastionHostsWithResponse(
        String resourceGroupName, String virtualNetworkName, Context context) {
        Response<BastionHostListResultInner> inner =
            this.serviceClient().getBastionHostsWithResponse(resourceGroupName, virtualNetworkName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new BastionHostListResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
