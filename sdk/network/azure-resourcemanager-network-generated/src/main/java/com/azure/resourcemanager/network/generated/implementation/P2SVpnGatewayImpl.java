    ...
    public P2SVpnGateway apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getP2SVpnGateways()
                .updateTagsWithResponse(resourceGroupName, gatewayName, updateP2SVpnGatewayParameters, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public P2SVpnGateway apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getP2SVpnGateways()
                .updateTagsWithResponse(resourceGroupName, gatewayName, updateP2SVpnGatewayParameters, context)
                .getValue();
        return this;
    }
