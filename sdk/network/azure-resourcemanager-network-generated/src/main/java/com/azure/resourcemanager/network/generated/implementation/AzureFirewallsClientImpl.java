...
public final class AzureFirewallsClientImpl implements AzureFirewallsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureFirewallInner>> updateTagsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureFirewallInner> updateTagsWithResponse(
        String resourceGroupName, String azureFirewallName, TagsObject parameters, Context context) {
        return updateTagsWithResponseAsync(resourceGroupName, azureFirewallName, parameters, context).block();
    }
