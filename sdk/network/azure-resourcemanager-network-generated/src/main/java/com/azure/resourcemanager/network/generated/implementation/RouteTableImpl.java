...
public final class RouteTableImpl implements RouteTable, RouteTable.Definition, RouteTable.Update {
    ...
    public RouteTable refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getRouteTables()
                .getByResourceGroupWithResponse(resourceGroupName, routeTableName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public RouteTable refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getRouteTables()
                .getByResourceGroupWithResponse(resourceGroupName, routeTableName, context)
                .getValue();
        return this;
    }
    ...
    public RouteTableImpl withSubnets(List<SubResource> subnets) {
