...
public final class NetworkSecurityGroupsClientImpl implements NetworkSecurityGroupsClient {
    ...
    public NetworkSecurityGroupInner getByResourceGroup(String resourceGroupName, String networkSecurityGroupName) {
        return getByResourceGroupAsync(resourceGroupName, networkSecurityGroupName).block();
    }
    ...
    public Response<NetworkSecurityGroupInner> getByResourceGroupWithResponse(
        String resourceGroupName, String networkSecurityGroupName, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, networkSecurityGroupName, context).block();
    }
