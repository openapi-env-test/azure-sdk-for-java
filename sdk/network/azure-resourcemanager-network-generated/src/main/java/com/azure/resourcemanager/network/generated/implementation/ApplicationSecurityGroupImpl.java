    ...
    public ApplicationSecurityGroup apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getApplicationSecurityGroups()
                .updateTags(resourceGroupName, applicationSecurityGroupName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public ApplicationSecurityGroup apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getApplicationSecurityGroups()
                .updateTags(resourceGroupName, applicationSecurityGroupName, updateParameters, context);
        return this;
    }
