    ...
    public ServiceEndpointPolicy apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getServiceEndpointPolicies()
                .update(resourceGroupName, serviceEndpointPolicyName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public ServiceEndpointPolicy apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getServiceEndpointPolicies()
                .update(resourceGroupName, serviceEndpointPolicyName, updateParameters, context);
        return this;
    }
