...
public interface InboundNatRule {
    ...
    /**
     * Gets the name property: Gets name of the resource that is unique within the set of inbound NAT rules used by the
    ...
    interface DefinitionStages {
        ...
        interface WithName {
            /**
             * Specifies the name property: Gets name of the resource that is unique within the set of inbound NAT rules
             * used by the load balancer. This name can be used to access the resource..
             *
             * @param name Gets name of the resource that is unique within the set of inbound NAT rules used by the load
