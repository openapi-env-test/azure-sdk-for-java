...
public class InboundNatRule extends SubResource {
    ...
    /**
     * Get the backendIpConfiguration property: Gets or sets a reference to a private ip address defined on a
     * NetworkInterface of a VM. Traffic sent to frontendPort of each of the frontendIPConfigurations is forwarded to
     * the backed IP.
     *
     * @return the backendIpConfiguration value.
     */
    public SubResource backendIpConfiguration() {
        return this.backendIpConfiguration;
    }

    /**
     * Set the backendIpConfiguration property: Gets or sets a reference to a private ip address defined on a
     * NetworkInterface of a VM. Traffic sent to frontendPort of each of the frontendIPConfigurations is forwarded to
     * the backed IP.
     *
     ...
     * @return the InboundNatRule object itself.
     */
    public InboundNatRule withBackendIpConfiguration(SubResource backendIpConfiguration) {
     ...
     * @return the InboundNatRule object itself.
     */
    public InboundNatRule withProtocol(TransportProtocol protocol) {
    ...
    /** {@inheritDoc} */
    @Override
    public InboundNatRule withId(String id) {
        super.withId(id);
        return this;
    }
