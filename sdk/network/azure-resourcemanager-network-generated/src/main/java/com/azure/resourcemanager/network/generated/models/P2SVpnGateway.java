...
public interface P2SVpnGateway {
    ...
    /**
     * Gets the customRoutes property: The reference of the address space resource which represents the custom routes
    ...
    interface DefinitionStages {
        ...
        interface WithCustomRoutes {
            /**
             * Specifies the customRoutes property: The reference of the address space resource which represents the
             * custom routes specified by the customer for P2SVpnGateway and P2S VpnClient..
             *
             * @param customRoutes The reference of the address space resource which represents the custom routes
             *     specified by the customer for P2SVpnGateway and P2S VpnClient.
             * @return the next definition stage.
             */
