...
*/
        ...
        interface WithPublicNetworkAccessForIngestion {
             ...
             * @param publicNetworkAccessForIngestion Possible values include: 'Enabled', 'Disabled'
             * @return the next definition stage
             */
        ...
        interface WithPublicNetworkAccessForQuery {
             ...
             * @param publicNetworkAccessForQuery Possible values include: 'Enabled', 'Disabled'
             * @return the next definition stage
             */
         ...
         */
        interface WithCreate extends Creatable<ApplicationInsightsComponent>, Resource.DefinitionWithTags<WithCreate>, DefinitionStages.WithDisableIpMasking, DefinitionStages.WithFlowType, DefinitionStages.WithHockeyAppId, DefinitionStages.WithImmediatePurgeDataOn30Days, DefinitionStages.WithPublicNetworkAccessForIngestion, DefinitionStages.WithPublicNetworkAccessForQuery, DefinitionStages.WithRequestSource, DefinitionStages.WithRetentionInDays, DefinitionStages.WithSamplingPercentage {
        }
    }
    /**
     * The template for a ApplicationInsightsComponent update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<ApplicationInsightsComponent>, Resource.UpdateWithTags<Update>, UpdateStages.WithDisableIpMasking, UpdateStages.WithFlowType, UpdateStages.WithHockeyAppId, UpdateStages.WithImmediatePurgeDataOn30Days, UpdateStages.WithPublicNetworkAccessForIngestion, UpdateStages.WithPublicNetworkAccessForQuery, UpdateStages.WithRequestSource, UpdateStages.WithRetentionInDays, UpdateStages.WithSamplingPercentage {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the applicationinsightscomponent update allowing to specify PublicNetworkAccessForIngestion.
         */
        interface WithPublicNetworkAccessForIngestion {
            /**
             * Specifies publicNetworkAccessForIngestion.
        ...
        /**
         * The stage of the applicationinsightscomponent update allowing to specify PublicNetworkAccessForQuery.
         */
        interface WithPublicNetworkAccessForQuery {
            /**
             * Specifies publicNetworkAccessForQuery.
