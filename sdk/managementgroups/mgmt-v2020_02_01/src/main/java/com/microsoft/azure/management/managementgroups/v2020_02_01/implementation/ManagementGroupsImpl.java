...
import com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroups;
import rx.functions.Func1;
import rx.Observable;
import com.microsoft.azure.Page;
import com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroup;
import com.microsoft.azure.management.managementgroups.v2020_02_01.OperationResults;
import com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroupInfo;
import com.microsoft.azure.management.managementgroups.v2020_02_01.CreateManagementGroupRequest;
import com.microsoft.azure.management.managementgroups.v2020_02_01.DescendantInfo;
...
class ManagementGroupsImpl extends WrapperImpl<ManagementGroupsInner> implements ManagementGroups {
    ...
    private DescendantInfoImpl wrapDescendantInfoModel(DescendantInfoInner inner) {
    ...
    public Observable<DescendantInfo> getDescendantsAsync(final String groupId) {
        ...
        .map(new Func1<DescendantInfoInner, DescendantInfo>() {
            ...
            public DescendantInfo call(DescendantInfoInner inner) {
                return wrapDescendantInfoModel(inner);
            }
        });
    }
