...
import com.microsoft.azure.management.managementgroups.v2020_02_01.CheckNameAvailabilityRequest;
...
public class ManagementGroupsAPIImpl extends AzureServiceClient {
    ...
    interface ManagementGroupsAPIService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroupsAPI checkNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroupsAPI startTenantBackfill" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2020_02_01.ManagementGroupsAPI tenantBackfillStatus" })
