...
public class ManagementGroupChildInfo {
     ...
     * (e.g. Microsoft.Management/managementGroups). Possible values include:
    ...
    /**
     * Get the fully qualified resource type which includes provider namespace (e.g. Microsoft.Management/managementGroups). Possible values include: 'Microsoft.Management/managementGroups', '/subscriptions'.
     *
    ...
    /**
     * Set the fully qualified resource type which includes provider namespace (e.g. Microsoft.Management/managementGroups). Possible values include: 'Microsoft.Management/managementGroups', '/subscriptions'.
     *
