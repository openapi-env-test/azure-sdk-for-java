...
import com.microsoft.azure.management.managementgroups.v2019_11_01.CheckNameAvailabilityRequest;
...
public class ManagementGroupsAPIImpl extends AzureServiceClient {
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "ManagementGroupsAPI", "2019-11-01");
    }
    ...
    interface ManagementGroupsAPIService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2019_11_01.ManagementGroupsAPI checkNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2019_11_01.ManagementGroupsAPI startTenantBackfill" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2019_11_01.ManagementGroupsAPI tenantBackfillStatus" })
