...
public interface ConnectorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DryrunResourceInner> listDryrun(
    ...
    Response<DryrunResourceInner> getDryrunWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DryrunResourceInner updateDryrun(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, DryrunPatch parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteDryrunWithResponse(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LinkerResourceInner> list(
        String subscriptionId, String resourceGroupName, String location, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LinkerResourceInner> getWithResponse(
    ...
    SyncPoller<PollResult<LinkerResourceInner>, LinkerResourceInner> beginUpdate(
        String subscriptionId, String resourceGroupName, String location, String connectorName, LinkerPatch parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ValidateOperationResultInner validate(
        String subscriptionId, String resourceGroupName, String location, String connectorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConfigurationResultInner generateConfigurations(
        String subscriptionId, String resourceGroupName, String location, String connectorName);
}
