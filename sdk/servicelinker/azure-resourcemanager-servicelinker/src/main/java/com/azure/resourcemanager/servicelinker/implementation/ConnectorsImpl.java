...
public final class ConnectorsImpl implements Connectors {
    ...
    public PagedIterable<DryrunResource> listDryrun(
    ...
    public Response<DryrunResource> getDryrunWithResponse(
    ...
    public PagedIterable<LinkerResource> list(
        String subscriptionId, String resourceGroupName, String location, Context context) {
        PagedIterable<LinkerResourceInner> inner =
    ...
    public Response<LinkerResource> getWithResponse(
