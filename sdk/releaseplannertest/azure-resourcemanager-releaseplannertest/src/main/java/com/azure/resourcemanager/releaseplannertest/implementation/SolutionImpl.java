...
import com.azure.resourcemanager.releaseplannertest.fluent.models.SolutionInner;
import com.azure.resourcemanager.releaseplannertest.models.Solution;
import com.azure.resourcemanager.releaseplannertest.models.SolutionInstallationRequest;
...
public final class SolutionImpl implements Solution, Solution.Definition, Solution.Update {
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, farmBeatsResourceName, solutionId, createBody, Context.NONE)
                .getValue();
        return this;
    }
    ...
    SolutionImpl(String name, com.azure.resourcemanager.releaseplannertest.AgriFoodManager serviceManager) {
    ...
    public Solution apply() {
        this.innerObject =
            serviceManager
                ...
                .getSolutions()
                .createOrUpdateWithResponse(
                    resourceGroupName, farmBeatsResourceName, solutionId, updateBody, Context.NONE)
                .getValue();
        return this;
    }
    ...
    SolutionImpl(
        SolutionInner innerObject, com.azure.resourcemanager.releaseplannertest.AgriFoodManager serviceManager) {
