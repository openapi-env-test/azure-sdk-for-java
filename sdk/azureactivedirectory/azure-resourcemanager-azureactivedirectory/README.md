...
This package contains Microsoft Azure SDK for Azureactivedirectory Management SDK. Metrics and Alerts for Azure Active Directory. Package tag package-preview-2020-07. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
