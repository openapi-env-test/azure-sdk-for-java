...
public final class PrivateLinkForAzureAdsImpl implements PrivateLinkForAzureAds {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PrivateLinkForAzureAdsImpl.class);
    ...
    public PrivateLinkForAzureAdsImpl(
        PrivateLinkForAzureAdsClient innerClient, AzureactivedirectoryManager serviceManager) {
    ...
    public PagedIterable<PrivateLinkPolicy> list() {
        ...
        return inner.mapPage(inner1 -> new PrivateLinkPolicyImpl(inner1, this.manager()));
    }
