...
public final class PrivateLinkPolicyImpl
    ...
    PrivateLinkPolicyImpl(String name, AzureactivedirectoryManager serviceManager) {
    ...
    PrivateLinkPolicyImpl(PrivateLinkPolicyInner innerObject, AzureactivedirectoryManager serviceManager) {
