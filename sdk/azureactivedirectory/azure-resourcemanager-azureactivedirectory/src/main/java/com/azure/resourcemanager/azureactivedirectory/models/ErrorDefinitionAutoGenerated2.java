...
/** Error definition. */
@Immutable
public final class ErrorDefinitionAutoGenerated2 {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ErrorDefinitionAutoGenerated2.class);
    ...
    private List<ErrorDefinitionAutoGenerated2> details;
     ...
     */
    public List<ErrorDefinitionAutoGenerated2> details() {
        return this.details;
    }
