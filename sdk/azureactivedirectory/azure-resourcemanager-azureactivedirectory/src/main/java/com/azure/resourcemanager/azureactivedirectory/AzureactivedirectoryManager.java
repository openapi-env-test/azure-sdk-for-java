...
import com.azure.resourcemanager.azureactivedirectory.implementation.AzureADMetricsImpl;
...
/** Entry point to AzureactivedirectoryManager. Metrics and Alerts for Azure Active Directory. */
public final class AzureactivedirectoryManager {
    private AzureADMetrics azureADMetrics;
    ...
    /** @return Resource collection API of AzureADMetrics. */
    public AzureADMetrics azureADMetrics() {
        if (this.azureADMetrics == null) {
            this.azureADMetrics = new AzureADMetricsImpl(clientObject.getAzureADMetrics(), this);
        }
        return azureADMetrics;
    }
