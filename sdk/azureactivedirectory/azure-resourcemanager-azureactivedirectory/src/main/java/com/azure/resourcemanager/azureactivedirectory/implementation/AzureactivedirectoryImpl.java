...
public final class AzureactivedirectoryImpl implements Azureactivedirectory {
    ...
    /** The AzureADMetricsClient object to access its operations. */
    private final AzureADMetricsClient azureADMetrics;

    /**
     * Gets the AzureADMetricsClient object to access its operations.
     *
     * @return the AzureADMetricsClient object.
     */
    public AzureADMetricsClient getAzureADMetrics() {
        return this.azureADMetrics;
    }
    ...
    AzureactivedirectoryImpl(
        ...
        this.azureADMetrics = new AzureADMetricsClientImpl(this);
