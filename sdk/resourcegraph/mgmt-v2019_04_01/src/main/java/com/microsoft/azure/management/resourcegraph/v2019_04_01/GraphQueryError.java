...
public class GraphQueryError {
     ...
     * @return the GraphQueryError object itself.
     */
    public GraphQueryError withCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the GraphQueryError object itself.
     */
    public GraphQueryError withMessage(String message) {
     ...
     * @return the GraphQueryError object itself.
     */
    public GraphQueryError withDetails(List<ErrorFieldContract> details) {
