...
import com.azure.resourcemanager.contoso_cdn.models.ProfileResourceState;
...
public final class ProfileImpl implements Profile, Profile.Definition, Profile.Update {
    ...
    ProfileImpl(String name, CdnManager serviceManager) {
    ...
    ProfileImpl(ProfileInner innerObject, CdnManager serviceManager) {
