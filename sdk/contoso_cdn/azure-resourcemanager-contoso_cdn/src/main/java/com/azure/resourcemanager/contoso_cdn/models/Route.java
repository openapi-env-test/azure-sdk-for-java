...
import com.azure.resourcemanager.contoso_cdn.fluent.models.RouteInner;
...
public interface Route {
    ...
    /**
     * Gets the queryStringCachingBehavior property: Defines how AzureFrontDoor caches requests that include query
    ...
    /**
     * Gets the optimizationType property: Specifies what scenario the customer wants this AzureFrontDoor endpoint to
    ...
    /**
     * Gets the inner com.azure.resourcemanager.contoso_cdn.fluent.models.RouteInner object.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithQueryStringCachingBehavior {
            /**
             * Specifies the queryStringCachingBehavior property: Defines how AzureFrontDoor caches requests that
             * include query strings. You can ignore any query strings when caching, bypass caching to prevent requests
             * that contain query strings from being cached, or cache every request with a unique URL..
             *
             * @param queryStringCachingBehavior Defines how AzureFrontDoor caches requests that include query strings.
             *     You can ignore any query strings when caching, bypass caching to prevent requests that contain query
             *     strings from being cached, or cache every request with a unique URL.
             * @return the next definition stage.
             */
        ...
        interface WithOptimizationType {
            /**
             * Specifies the optimizationType property: Specifies what scenario the customer wants this AzureFrontDoor
             * endpoint to optimize for, e.g. Download, Media services. With this information, AzureFrontDoor can apply
             * scenario driven optimization..
             *
             * @param optimizationType Specifies what scenario the customer wants this AzureFrontDoor endpoint to
             *     optimize for, e.g. Download, Media services. With this information, AzureFrontDoor can apply scenario
             *     driven optimization.
             * @return the next definition stage.
             */
