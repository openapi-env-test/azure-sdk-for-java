...
import com.azure.resourcemanager.contoso_cdn.fluent.models.SecurityPolicyInner;
import com.azure.resourcemanager.contoso_cdn.models.SecurityPolicies;
import com.azure.resourcemanager.contoso_cdn.models.SecurityPolicy;
...
public final class SecurityPoliciesImpl implements SecurityPolicies {
    ...
    public SecurityPoliciesImpl(SecurityPoliciesClient innerClient, CdnManager serviceManager) {
    ...
    public PagedIterable<SecurityPolicy> listByProfile(String resourceGroupName, String profileName) {
        ...
        return inner.mapPage(inner1 -> new SecurityPolicyImpl(inner1, this.manager()));
    }
