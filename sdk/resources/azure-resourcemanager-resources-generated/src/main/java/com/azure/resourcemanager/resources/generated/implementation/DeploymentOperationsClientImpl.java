...
public final class DeploymentOperationsClientImpl implements DeploymentOperationsClient {
    ...
    private final ResourcesManagementClientImpl client;
     ...
     */
    DeploymentOperationsClientImpl(ResourcesManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for ResourcesManagementClientDeploymentOperations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ResourcesManagementC")
