...
public final class ProvidersClientImpl implements ProvidersClient {
     ...
     */
    ProvidersClientImpl(ResourcesManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ResourcesManagementClientProviders to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
