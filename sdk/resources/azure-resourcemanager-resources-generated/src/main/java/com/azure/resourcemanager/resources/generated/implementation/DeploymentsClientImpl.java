...
public final class DeploymentsClientImpl implements DeploymentsClient {
     ...
     */
    DeploymentsClientImpl(ResourcesManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ResourcesManagementClientDeployments to be used by the proxy service
