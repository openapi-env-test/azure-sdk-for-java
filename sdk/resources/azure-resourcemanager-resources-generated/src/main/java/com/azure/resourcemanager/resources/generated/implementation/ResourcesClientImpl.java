...
public final class ResourcesClientImpl implements ResourcesClient {
     ...
     */
    ResourcesClientImpl(ResourcesManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ResourcesManagementClientResources to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
