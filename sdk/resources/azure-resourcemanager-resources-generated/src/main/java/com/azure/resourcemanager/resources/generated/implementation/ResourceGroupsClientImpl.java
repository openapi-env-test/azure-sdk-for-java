...
public final class ResourceGroupsClientImpl implements ResourceGroupsClient {
     ...
     */
    ResourceGroupsClientImpl(ResourcesManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ResourcesManagementClientResourceGroups to be used by the proxy
