...
public class DeploymentOperationsInner {
    ...
    interface DeploymentOperationsService {
        ...
        Observable<Response<ResponseBody>> getAtScope(@Path("scope") String scope, @Path("deploymentName") String deploymentName, @Path("operationId") String operationId, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> listAtScope(@Path("scope") String scope, @Path("deploymentName") String deploymentName, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> getAtTenantScope(@Path("deploymentName") String deploymentName, @Path("operationId") String operationId, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> listAtTenantScope(@Path("deploymentName") String deploymentName, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> getAtManagementGroupScope(@Path("groupId") String groupId, @Path("deploymentName") String deploymentName, @Path("operationId") String operationId, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> listAtManagementGroupScope(@Path("groupId") String groupId, @Path("deploymentName") String deploymentName, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> getAtSubscriptionScope(@Path("deploymentName") String deploymentName, @Path("operationId") String operationId, @Path("subscriptionId") String subscriptionId, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> listAtSubscriptionScope(@Path("deploymentName") String deploymentName, @Path("subscriptionId") String subscriptionId, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    public Observable<ServiceResponse<DeploymentOperationInner>> getAtScopeWithServiceResponseAsync(String scope, String deploymentName, String operationId) {
        ...
        return service.getAtScope(scope, deploymentName, operationId, this.client.acceptLanguage(), this.client.userAgent())
    ...
    public Observable<ServiceResponse<Page<DeploymentOperationInner>>> listAtScopeSinglePageAsync(final String scope, final String deploymentName) {
        ...
        return service.listAtScope(scope, deploymentName, top, this.client.acceptLanguage(), this.client.userAgent())
    ...
    public Observable<ServiceResponse<DeploymentOperationInner>> getAtTenantScopeWithServiceResponseAsync(String deploymentName, String operationId) {
        ...
        return service.getAtTenantScope(deploymentName, operationId, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<DeploymentOperationInner>>>() {
                @Override
                public Observable<ServiceResponse<DeploymentOperationInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<Page<DeploymentOperationInner>>> listAtTenantScopeSinglePageAsync(final String deploymentName) {
        ...
        final Integer top = null;
        return service.listAtTenantScope(deploymentName, top, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<DeploymentOperationInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<DeploymentOperationInner>>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<DeploymentOperationInner>> getAtManagementGroupScopeWithServiceResponseAsync(String groupId, String deploymentName, String operationId) {
        ...
        return service.getAtManagementGroupScope(groupId, deploymentName, operationId, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<DeploymentOperationInner>>>() {
                @Override
                public Observable<ServiceResponse<DeploymentOperationInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<Page<DeploymentOperationInner>>> listAtManagementGroupScopeSinglePageAsync(final String groupId, final String deploymentName) {
        ...
        final Integer top = null;
        return service.listAtManagementGroupScope(groupId, deploymentName, top, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<DeploymentOperationInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<DeploymentOperationInner>>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<DeploymentOperationInner>> getAtSubscriptionScopeWithServiceResponseAsync(String deploymentName, String operationId) {
        ...
        return service.getAtSubscriptionScope(deploymentName, operationId, this.client.subscriptionId(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<DeploymentOperationInner>>>() {
                @Override
                public Observable<ServiceResponse<DeploymentOperationInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<Page<DeploymentOperationInner>>> listAtSubscriptionScopeSinglePageAsync(final String deploymentName) {
        ...
        final Integer top = null;
        return service.listAtSubscriptionScope(deploymentName, this.client.subscriptionId(), top, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<DeploymentOperationInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<DeploymentOperationInner>>> call(Response<ResponseBody> response) {
                    try {
