...
public class ResourceGroupsInner {
    ...
    interface ResourceGroupsService {
        ...
        Observable<Response<ResponseBody>> update(@Path("resourceGroupName") String resourceGroupName, @Path("subscriptionId") String subscriptionId, @Body ResourceGroupPatchable parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> exportTemplate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Body ExportTemplateRequest parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        @POST("subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/exportTemplate")
        Observable<Response<ResponseBody>> beginExportTemplate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Body ExportTemplateRequest parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    public Observable<ServiceResponse<ResourceGroupInner>> updateWithServiceResponseAsync(String resourceGroupName, ResourceGroupPatchable parameters) {
        ...
        Validator.validate(parameters);
        return service.update(resourceGroupName, this.client.subscriptionId(), parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ResourceGroupInner>>>() {
                @Override
                public Observable<ServiceResponse<ResourceGroupInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<ResourceGroupExportResultInner>> exportTemplateWithServiceResponseAsync(String resourceGroupName, ExportTemplateRequest parameters) {
        ...
        Validator.validate(parameters);
        Observable<Response<ResponseBody>> observable = service.exportTemplate(this.client.subscriptionId(), resourceGroupName, parameters, this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<ResourceGroupExportResultInner>> beginExportTemplateWithServiceResponseAsync(String resourceGroupName, ExportTemplateRequest parameters) {
        ...
        Validator.validate(parameters);
        return service.beginExportTemplate(this.client.subscriptionId(), resourceGroupName, parameters, this.client.acceptLanguage(), this.client.userAgent())
