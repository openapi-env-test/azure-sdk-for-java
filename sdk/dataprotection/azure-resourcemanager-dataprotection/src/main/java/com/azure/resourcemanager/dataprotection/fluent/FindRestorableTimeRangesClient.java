...
public interface FindRestorableTimeRangesClient {
    /**
    ...
    AzureBackupFindRestorableTimeRangesResponseResourceInner post(
        String vaultName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureBackupFindRestorableTimeRangesResponseResourceInner> postWithResponse(
        String vaultName,
        String resourceGroupName,
        String backupInstances,
        AzureBackupFindRestorableTimeRangesRequest parameters,
