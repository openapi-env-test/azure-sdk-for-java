...
public final class DataProtectionClientImpl implements DataProtectionClient {
    ...
    /** The FindRestorableTimeRangesClient object to access its operations. */
    private final FindRestorableTimeRangesClient findRestorableTimeRanges;

    /**
     * Gets the FindRestorableTimeRangesClient object to access its operations.
     *
     * @return the FindRestorableTimeRangesClient object.
     */
    public FindRestorableTimeRangesClient getFindRestorableTimeRanges() {
        return this.findRestorableTimeRanges;
    }
    ...
    DataProtectionClientImpl(
        ...
        this.findRestorableTimeRanges = new FindRestorableTimeRangesClientImpl(this);
