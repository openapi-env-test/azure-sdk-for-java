...
import com.azure.resourcemanager.dataprotection.implementation.FindRestorableTimeRangesImpl;
...
public final class DataProtectionManager {
    ...
    private FindRestorableTimeRanges findRestorableTimeRanges;
    ...
    /** @return Resource collection API of FindRestorableTimeRanges. */
    public FindRestorableTimeRanges findRestorableTimeRanges() {
        if (this.findRestorableTimeRanges == null) {
            this.findRestorableTimeRanges =
                new FindRestorableTimeRangesImpl(clientObject.getFindRestorableTimeRanges(), this);
        }
        return findRestorableTimeRanges;
    }
