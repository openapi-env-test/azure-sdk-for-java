...
public final class RecoveryPointsClientImpl implements RecoveryPointsClient {
    ...
    private PagedFlux<AzureBackupRecoveryPointResourceInner> getListAsync(
        ...
        return new PagedFlux<>(
            () -> getListSinglePageAsync(vaultName, resourceGroupName, backupInstanceName, filter, skipToken),
    ...
    private PagedFlux<AzureBackupRecoveryPointResourceInner> getListAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> getListSinglePageAsync(vaultName, resourceGroupName, backupInstanceName, filter, skipToken, context),
    ...
    public PagedIterable<AzureBackupRecoveryPointResourceInner> getList(
        ...
        final String filter = null;
        final String skipToken = null;
        return new PagedIterable<>(getListAsync(vaultName, resourceGroupName, backupInstanceName, filter, skipToken));
    }
    ...
    public PagedIterable<AzureBackupRecoveryPointResourceInner> getList(
        ...
        return new PagedIterable<>(
            getListAsync(vaultName, resourceGroupName, backupInstanceName, filter, skipToken, context));
    }
