...
public final class BackupInstancesClientImpl implements BackupInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<OperationJobExtendedInfoInner>, OperationJobExtendedInfoInner> beginValidateRestore(
        String vaultName,
        String resourceGroupName,
        String backupInstanceName,
        ValidateRestoreRequestObject parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationJobExtendedInfoInner> validateRestoreAsync(
        String vaultName,
        String resourceGroupName,
        String backupInstanceName,
        ValidateRestoreRequestObject parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationJobExtendedInfoInner validateRestore(
        String vaultName,
        String resourceGroupName,
        String backupInstanceName,
        ValidateRestoreRequestObject parameters) {
        return validateRestoreAsync(vaultName, resourceGroupName, backupInstanceName, parameters).block();
    }
    ...
    public OperationJobExtendedInfoInner validateRestore(
        ...
        ValidateRestoreRequestObject parameters,
        Context context) {
        return validateRestoreAsync(vaultName, resourceGroupName, backupInstanceName, parameters, context).block();
    }
