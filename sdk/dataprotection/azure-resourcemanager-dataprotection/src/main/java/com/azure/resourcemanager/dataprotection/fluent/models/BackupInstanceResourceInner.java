...
public class BackupInstanceResourceInner extends DppResource {
     ...
     */
    @JsonProperty(value = "properties.currentProtectionState", access = JsonProperty.Access.WRITE_ONLY)
    private CurrentProtectionState currentProtectionState;

    /*
     * Specifies the protection error of the resource
     */
    @JsonProperty(value = "properties.protectionErrorDetails", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    public BackupInstanceResourceInner withFriendlyName(String friendlyName) {
