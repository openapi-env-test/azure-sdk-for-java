...
public interface EnergyServicesClient {
    ...
    SyncPoller<PollResult<DataPartitionAddOrRemoveRequestInner>, DataPartitionAddOrRemoveRequestInner>
        beginAddPartition(String resourceGroupName, String resourceName, DataPartitionAddOrRemoveRequestInner body);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataPartitionAddOrRemoveRequestInner>, DataPartitionAddOrRemoveRequestInner>
        beginRemovePartition(String resourceGroupName, String resourceName, DataPartitionAddOrRemoveRequestInner body);
