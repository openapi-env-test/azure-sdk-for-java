...
public final class HealthMonitorsImpl implements HealthMonitors {
    ...
    public HealthMonitorsImpl(HealthMonitorsClient innerClient, WorkloadMonitorManager serviceManager) {
    ...
    public PagedIterable<HealthMonitor> list(
        ...
        return inner.mapPage(inner1 -> new HealthMonitorImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<HealthMonitorStateChange> listStateChanges(
        ...
        return inner.mapPage(inner1 -> new HealthMonitorStateChangeImpl(inner1, this.manager()));
    }
