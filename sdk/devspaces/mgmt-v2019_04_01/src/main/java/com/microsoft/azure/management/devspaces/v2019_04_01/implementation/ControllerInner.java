...
import com.microsoft.azure.management.devspaces.v2019_04_01.HostEndpointType;
...
public class ControllerInner extends Resource {
    ...
    /**
     * The endpoint type to be exposed for a Azure Dev Spaces Controller.
     * Possible values include: 'Public', 'Private', 'None'.
     */
    @JsonProperty(value = "properties.hostEndpointType")
    private HostEndpointType hostEndpointType;
    ...
    /**
     * Get the endpoint type to be exposed for a Azure Dev Spaces Controller. Possible values include: 'Public', 'Private', 'None'.
     *
     * @return the hostEndpointType value
     */
    public HostEndpointType hostEndpointType() {
        return this.hostEndpointType;
    }

    /**
     * Set the endpoint type to be exposed for a Azure Dev Spaces Controller. Possible values include: 'Public', 'Private', 'None'.
     *
     * @param hostEndpointType the hostEndpointType value to set
     * @return the ControllerInner object itself.
     */
    public ControllerInner withHostEndpointType(HostEndpointType hostEndpointType) {
        this.hostEndpointType = hostEndpointType;
        return this;
    }
