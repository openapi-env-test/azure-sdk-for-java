...
import com.microsoft.azure.management.devspaces.v2019_04_01.implementation.ControllerInner;
...
*/
        ...
        /**
         * The stage of the controller definition allowing to specify HostEndpointType.
         */
        interface WithHostEndpointType {
            /**
             * Specifies hostEndpointType.
             * @param hostEndpointType The endpoint type to be exposed for a Azure Dev Spaces Controller. Possible values include: 'Public', 'Private', 'None'
             * @return the next definition stage
             */
            WithCreate withHostEndpointType(HostEndpointType hostEndpointType);
        }
         ...
         */
        interface WithCreate extends Creatable<Controller>, Resource.DefinitionWithTags<WithCreate>, DefinitionStages.WithHostEndpointType {
        }
    }
    /**
     * The template for a Controller update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<Controller>, Resource.UpdateWithTags<Update>, UpdateStages.WithTargetContainerHostCredentialsBase64 {
    }
