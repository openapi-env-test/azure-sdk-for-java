...
public interface Workflow extends HasInner<WorkflowInner>, Resource, GroupableResourceCore<LogicManager, WorkflowInner>, HasResourceGroup, Refreshable<Workflow>, Updatable<Workflow.Update>, HasManager<LogicManager> {
     ...
     */
    interface Update extends Appliable<Workflow>, Resource.UpdateWithTags<Update>, UpdateStages.WithDefinition, UpdateStages.WithEndpointsConfiguration, UpdateStages.WithIntegrationAccount, UpdateStages.WithIntegrationServiceEnvironment, UpdateStages.WithParameters, UpdateStages.WithState {
    }
