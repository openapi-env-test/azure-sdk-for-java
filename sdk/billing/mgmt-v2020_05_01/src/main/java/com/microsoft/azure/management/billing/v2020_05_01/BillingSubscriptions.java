...
public interface BillingSubscriptions extends HasInner<BillingSubscriptionsInner> {
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> getAsync(String billingAccountName, String billingSubscriptionName);
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> moveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId);
     ...
     * @return the observable for the request
     */
    Observable<ValidateSubscriptionTransferEligibilityResult> validateMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId);
