...
public class BillingSubscriptionsInner {
    ...
    interface BillingSubscriptionsService {
        ...
        Observable<Response<ResponseBody>> get(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> update(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Query("api-version") String apiVersion, @Body BillingSubscriptionInner parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> move(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Header("accept-language") String acceptLanguage, @Body TransferBillingSubscriptionRequestProperties parameters, @Header("User-Agent") String userAgent);
        ...
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}/move")
        Observable<Response<ResponseBody>> beginMove(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Header("accept-language") String acceptLanguage, @Body TransferBillingSubscriptionRequestProperties parameters, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> validateMove(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Header("accept-language") String acceptLanguage, @Body TransferBillingSubscriptionRequestProperties parameters, @Header("User-Agent") String userAgent);
    ...
    public BillingSubscriptionInner get(String billingAccountName, String billingSubscriptionName) {
        return getWithServiceResponseAsync(billingAccountName, billingSubscriptionName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingSubscriptionInner> getAsync(String billingAccountName, String billingSubscriptionName, final ServiceCallback<BillingSubscriptionInner> serviceCallback) {
        return ServiceFuture.fromResponse(getWithServiceResponseAsync(billingAccountName, billingSubscriptionName), serviceCallback);
    }
     ...
     */
    public Observable<BillingSubscriptionInner> getAsync(String billingAccountName, String billingSubscriptionName) {
        return getWithServiceResponseAsync(billingAccountName, billingSubscriptionName).map(new Func1<ServiceResponse<BillingSubscriptionInner>, BillingSubscriptionInner>() {
            @Override
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<ServiceResponse<BillingSubscriptionInner>> getWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        ...
        return service.get(billingAccountName, billingSubscriptionName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the BillingSubscriptionInner object if successful.
     */
    public BillingSubscriptionInner update(String billingAccountName, String billingSubscriptionName, BillingSubscriptionInner parameters) {
        return updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, parameters).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingSubscriptionInner> updateAsync(String billingAccountName, String billingSubscriptionName, BillingSubscriptionInner parameters, final ServiceCallback<BillingSubscriptionInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, parameters), serviceCallback);
    }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<BillingSubscriptionInner> updateAsync(String billingAccountName, String billingSubscriptionName, BillingSubscriptionInner parameters) {
        return updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, parameters).map(new Func1<ServiceResponse<BillingSubscriptionInner>, BillingSubscriptionInner>() {
            @Override
            public BillingSubscriptionInner call(ServiceResponse<BillingSubscriptionInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<ServiceResponse<BillingSubscriptionInner>> updateWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName, BillingSubscriptionInner parameters) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingSubscriptionName == null) {
        ...
        return service.update(billingAccountName, billingSubscriptionName, this.client.apiVersion(), parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<BillingSubscriptionInner>>>() {
                @Override
                public Observable<ServiceResponse<BillingSubscriptionInner>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the BillingSubscriptionInner object if successful.
     */
    public BillingSubscriptionInner move(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return moveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingSubscriptionInner> moveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId, final ServiceCallback<BillingSubscriptionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(moveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId), serviceCallback);
    }
     ...
     */
    public Observable<BillingSubscriptionInner> moveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return moveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).map(new Func1<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsMoveHeaders>, BillingSubscriptionInner>() {
            @Override
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsMoveHeaders>> moveWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingSubscriptionName == null) {
        ...
        Observable<Response<ResponseBody>> observable = service.move(billingAccountName, billingSubscriptionName, this.client.acceptLanguage(), parameters, this.client.userAgent());
     ...
     * @return the BillingSubscriptionInner object if successful.
     */
    public BillingSubscriptionInner beginMove(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return beginMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingSubscriptionInner> beginMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId, final ServiceCallback<BillingSubscriptionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(beginMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId), serviceCallback);
    }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<BillingSubscriptionInner> beginMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return beginMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).map(new Func1<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsMoveHeaders>, BillingSubscriptionInner>() {
            @Override
            public BillingSubscriptionInner call(ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsMoveHeaders> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsMoveHeaders>> beginMoveWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingSubscriptionName == null) {
        ...
        TransferBillingSubscriptionRequestProperties parameters = new TransferBillingSubscriptionRequestProperties();
        parameters.withDestinationInvoiceSectionId(destinationInvoiceSectionId);
        return service.beginMove(billingAccountName, billingSubscriptionName, this.client.acceptLanguage(), parameters, this.client.userAgent())
     ...
     */
    public ValidateSubscriptionTransferEligibilityResultInner validateMove(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return validateMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ValidateSubscriptionTransferEligibilityResultInner> validateMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId, final ServiceCallback<ValidateSubscriptionTransferEligibilityResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(validateMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId), serviceCallback);
    }
     ...
     */
    public Observable<ValidateSubscriptionTransferEligibilityResultInner> validateMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        return validateMoveWithServiceResponseAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId).map(new Func1<ServiceResponse<ValidateSubscriptionTransferEligibilityResultInner>, ValidateSubscriptionTransferEligibilityResultInner>() {
            @Override
     ...
     * @return the observable to the ValidateSubscriptionTransferEligibilityResultInner object
     */
    public Observable<ServiceResponse<ValidateSubscriptionTransferEligibilityResultInner>> validateMoveWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingSubscriptionName == null) {
        ...
        TransferBillingSubscriptionRequestProperties parameters = new TransferBillingSubscriptionRequestProperties();
        parameters.withDestinationInvoiceSectionId(destinationInvoiceSectionId);
        return service.validateMove(billingAccountName, billingSubscriptionName, this.client.acceptLanguage(), parameters, this.client.userAgent())
