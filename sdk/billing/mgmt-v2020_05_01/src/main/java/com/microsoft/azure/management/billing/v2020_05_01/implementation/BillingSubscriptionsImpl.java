...
class BillingSubscriptionsImpl extends WrapperImpl<BillingSubscriptionsInner> implements BillingSubscriptions {
    ...
    @Override
    public Observable<BillingSubscription> getAsync(String billingAccountName, String billingSubscriptionName) {
        BillingSubscriptionsInner client = this.inner();
        return client.getAsync(billingAccountName, billingSubscriptionName)
        .map(new Func1<BillingSubscriptionInner, BillingSubscription>() {
            @Override
            public BillingSubscription call(BillingSubscriptionInner inner) {
                return new BillingSubscriptionImpl(inner, manager());
    ...
    @Override
    public Observable<BillingSubscription> moveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        BillingSubscriptionsInner client = this.inner();
        return client.moveAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId)
        .map(new Func1<BillingSubscriptionInner, BillingSubscription>() {
            @Override
            public BillingSubscription call(BillingSubscriptionInner inner) {
                return new BillingSubscriptionImpl(inner, manager());
    ...
    @Override
    public Observable<ValidateSubscriptionTransferEligibilityResult> validateMoveAsync(String billingAccountName, String billingSubscriptionName, String destinationInvoiceSectionId) {
        BillingSubscriptionsInner client = this.inner();
        return client.validateMoveAsync(billingAccountName, billingSubscriptionName, destinationInvoiceSectionId)
