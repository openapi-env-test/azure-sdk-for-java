...
import com.microsoft.azure.management.billing.v2020_05_01.UpdateAutoRenewOperation;
...
class ProductsImpl extends WrapperImpl<ProductsInner> implements Products {
    ...
    @Override
    public Observable<UpdateAutoRenewOperation> updateAutoRenewAsync(String billingAccountName, String productName) {
        ProductsInner client = this.inner();
        return client.updateAutoRenewAsync(billingAccountName, productName)
