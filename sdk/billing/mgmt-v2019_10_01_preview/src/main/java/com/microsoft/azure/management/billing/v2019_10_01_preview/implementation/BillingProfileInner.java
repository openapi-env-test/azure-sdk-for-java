...
public class BillingProfileInner extends ProxyResource {
     ...
     * Azure usage address.
     */
    @JsonProperty(value = "properties.azureUsageAddress")
    private AddressDetails azureUsageAddress;
    ...
    /**
     * Get azure usage address.
     *
     * @return the azureUsageAddress value
     */
    public AddressDetails azureUsageAddress() {
        return this.azureUsageAddress;
    }

    /**
     * Set azure usage address.
     *
     * @param azureUsageAddress the azureUsageAddress value to set
     * @return the BillingProfileInner object itself.
     */
    public BillingProfileInner withAzureUsageAddress(AddressDetails azureUsageAddress) {
        this.azureUsageAddress = azureUsageAddress;
        return this;
    }
