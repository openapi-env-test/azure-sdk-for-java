...
public interface BillingProfile extends HasInner<BillingProfileInner>, Indexable, Refreshable<BillingProfile>, Updatable<BillingProfile.Update>, HasManager<BillingManager> {
    ...
    /**
     * @return the azureUsageAddress value.
     */
    AddressDetails azureUsageAddress();
     ...
     */
    interface Update extends Appliable<BillingProfile>, UpdateStages.WithAddress, UpdateStages.WithAzureUsageAddress, UpdateStages.WithDisplayName, UpdateStages.WithEnabledAzurePlans, UpdateStages.WithInvoiceEmailOptIn, UpdateStages.WithInvoiceSections, UpdateStages.WithPoNumber {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the billingprofile update allowing to specify AzureUsageAddress.
         */
        interface WithAzureUsageAddress {
            /**
             * Specifies azureUsageAddress.
             * @param azureUsageAddress Azure usage address
             * @return the next update stage
             */
            Update withAzureUsageAddress(AddressDetails azureUsageAddress);
        }
