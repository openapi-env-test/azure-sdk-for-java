...
public final class BackupProtectionIntentsClientImpl implements BackupProtectionIntentsClient {
     ...
     */
    BackupProtectionIntentsClientImpl(RecoveryServicesBackupClientImpl client) {
        this.service =
            RestProxy
                .create(BackupProtectionIntentsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface BackupProtectionIntentsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProtectionIntentResourceList>> listNext(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ProtectionIntentResourceInner>>map(
                res ->
