...
public final class AzureKeyVaultKms {
     ...
     * possible values are `Public` and `Private`. `Public` means the key vault
     * allows public access from all networks. `Private` means the key vault
    ...
    /**
     * Get the keyVaultNetworkAccess property: Network access of the key vault Network access of key vault. The possible
     * values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private`
    ...
    /**
     * Set the keyVaultNetworkAccess property: Network access of the key vault Network access of key vault. The possible
     * values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private`
     * means the key vault disables public access and enables private link. The default value is `Public`.
     *
