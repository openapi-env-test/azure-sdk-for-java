...
public final class ManagedClusterSnapshotProperties {
    /*
     * CreationData to be used to specify the source resource ID to create this
     * snapshot.
     */
    ...
    /*
     * What the properties will be showed when getting managed cluster
     * snapshot. Those properties are read-only.
     */
