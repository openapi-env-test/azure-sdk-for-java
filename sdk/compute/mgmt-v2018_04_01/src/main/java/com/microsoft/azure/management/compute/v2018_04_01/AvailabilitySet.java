...
public class AvailabilitySet extends Resource {
     ...
     */
    public AvailabilitySet withPlatformUpdateDomainCount(Integer platformUpdateDomainCount) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet withPlatformFaultDomainCount(Integer platformFaultDomainCount) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet withVirtualMachines(List<SubResource> virtualMachines) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet withProximityPlacementGroup(SubResource proximityPlacementGroup) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
