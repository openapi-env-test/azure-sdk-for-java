...
public class ManagedDiskParameters extends SubResource {
    ...
    /**
     * Get specifies the storage account type for the managed disk. Possible values are: Standard_LRS, Premium_LRS, and StandardSSD_LRS. Possible values include: 'Standard_LRS', 'Premium_LRS', 'StandardSSD_LRS'.
     *
    ...
    /**
     * Set specifies the storage account type for the managed disk. Possible values are: Standard_LRS, Premium_LRS, and StandardSSD_LRS. Possible values include: 'Standard_LRS', 'Premium_LRS', 'StandardSSD_LRS'.
     *
