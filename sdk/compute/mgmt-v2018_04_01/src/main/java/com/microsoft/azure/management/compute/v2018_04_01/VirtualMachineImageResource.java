...
public class VirtualMachineImageResource extends SubResource {
     ...
     */
    public VirtualMachineImageResource withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VirtualMachineImageResource object itself.
     */
    public VirtualMachineImageResource withLocation(String location) {
     ...
     * @return the VirtualMachineImageResource object itself.
     */
    public VirtualMachineImageResource withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
