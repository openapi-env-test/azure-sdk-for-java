...
public class VirtualMachineImage extends VirtualMachineImageResource {
     ...
     */
    public VirtualMachineImage withPlan(PurchasePlan plan) {
        this.plan = plan;
        return this;
    }
     ...
     * @return the VirtualMachineImage object itself.
     */
    public VirtualMachineImage withOsDiskImage(OSDiskImage osDiskImage) {
     ...
     * @return the VirtualMachineImage object itself.
     */
    public VirtualMachineImage withDataDiskImages(List<DataDiskImage> dataDiskImages) {
