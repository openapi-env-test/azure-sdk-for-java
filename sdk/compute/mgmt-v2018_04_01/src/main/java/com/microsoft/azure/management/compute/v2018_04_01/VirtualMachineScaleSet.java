...
public class VirtualMachineScaleSet extends Resource {
     ...
     */
    public VirtualMachineScaleSet withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withPlan(Plan plan) {
        this.plan = plan;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withUpgradePolicy(UpgradePolicy upgradePolicy) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withVirtualMachineProfile(VirtualMachineScaleSetVMProfile virtualMachineProfile) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withOverprovision(Boolean overprovision) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withSinglePlacementGroup(Boolean singlePlacementGroup) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withZoneBalance(Boolean zoneBalance) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withPlatformFaultDomainCount(Integer platformFaultDomainCount) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withProximityPlacementGroup(SubResource proximityPlacementGroup) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withIdentity(VirtualMachineScaleSetIdentity identity) {
     ...
     * @return the VirtualMachineScaleSet object itself.
     */
    public VirtualMachineScaleSet withZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
