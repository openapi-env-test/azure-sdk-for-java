...
public final class VirtualMachinesImpl implements VirtualMachines {
    ...
    public void deleteByResourceGroup(String resourceGroupName, String vmName) {
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, vmName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceGroupName, vmName, context);
    }
