...
public final class ProximityPlacementGroupsImpl implements ProximityPlacementGroups {
    ...
    public Response<ProximityPlacementGroup> getByResourceGroupWithResponse(
        ...
        Response<ProximityPlacementGroupInner> inner =
            this
                .serviceClient()
                .getByResourceGroupWithResponse(resourceGroupName, proximityPlacementGroupName, context);
        if (inner != null) {
    ...
    public ProximityPlacementGroup getById(String id) {
        ...
        return this
            .getByResourceGroupWithResponse(resourceGroupName, proximityPlacementGroupName, Context.NONE)
            .getValue();
    }

    public Response<ProximityPlacementGroup> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, proximityPlacementGroupName, context);
    }
