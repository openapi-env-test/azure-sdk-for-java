...
public final class DedicatedHostGroupsImpl implements DedicatedHostGroups {
    ...
    public Response<DedicatedHostGroup> getByResourceGroupWithResponse(
        ...
        Response<DedicatedHostGroupInner> inner =
            this.serviceClient().getByResourceGroupWithResponse(resourceGroupName, hostGroupName, context);
        if (inner != null) {
    ...
    public DedicatedHostGroup getById(String id) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, hostGroupName, Context.NONE).getValue();
    }

    public Response<DedicatedHostGroup> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, hostGroupName, context);
    }
