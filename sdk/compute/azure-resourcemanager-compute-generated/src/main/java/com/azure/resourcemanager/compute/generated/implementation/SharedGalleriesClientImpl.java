...
public final class SharedGalleriesClientImpl implements SharedGalleriesClient {
    ...
    private PagedFlux<PirSharedGalleryResourceInner> listAsync(String location, SharedToValues sharedTo) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PirSharedGalleryResourceInner> listAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PirSharedGalleryResourceInner> getAsync(String location, String galleryUniqueName) {
