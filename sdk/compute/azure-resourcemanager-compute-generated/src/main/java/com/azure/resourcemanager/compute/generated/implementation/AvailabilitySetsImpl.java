...
public final class AvailabilitySetsImpl implements AvailabilitySets {
    ...
    public AvailabilitySet update(
        ...
        AvailabilitySetInner inner = this.serviceClient().update(resourceGroupName, availabilitySetName, parameters);
        if (inner != null) {
    ...
    public Response<AvailabilitySet> updateWithResponse(
        ...
        Response<AvailabilitySetInner> inner =
            this.serviceClient().updateWithResponse(resourceGroupName, availabilitySetName, parameters, context);
        if (inner != null) {
