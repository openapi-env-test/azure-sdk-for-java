...
public interface AvailabilitySets {
     ...
     */
    AvailabilitySet update(String resourceGroupName, String availabilitySetName, AvailabilitySetUpdate parameters);
     ...
     * @return specifies information about the availability set that the virtual machine should be assigned to.
     */
    Response<AvailabilitySet> updateWithResponse(
