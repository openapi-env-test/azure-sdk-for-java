...
import com.azure.resourcemanager.mediaservices.models.AsyncOperationErrorDetail;
...
public final class AsyncOperationResultInner {
    ...
    private AsyncOperationErrorDetail error;
     ...
     */
    public AsyncOperationErrorDetail error() {
        return this.error;
    }
     ...
     */
    public AsyncOperationResultInner withError(AsyncOperationErrorDetail error) {
        this.error = error;
        return this;
    }
