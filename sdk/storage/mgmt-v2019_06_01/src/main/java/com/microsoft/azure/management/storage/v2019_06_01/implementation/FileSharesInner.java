...
public class FileSharesInner {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> restoreAsync(String resourceGroupName, String accountName, String shareName, final ServiceCallback<Void> serviceCallback) {
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<Void> restoreAsync(String resourceGroupName, String accountName, String shareName) {
        return restoreWithServiceResponseAsync(resourceGroupName, accountName, shareName).map(new Func1<ServiceResponse<Void>, Void>() {
            @Override
            public Void call(ServiceResponse<Void> response) {
                return response.body();
            }
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<ServiceResponse<Void>> restoreWithServiceResponseAsync(String resourceGroupName, String accountName, String shareName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (accountName == null) {
