...
public final class StorageAccountsImpl implements StorageAccounts {
    ...
    public StorageAccountManagementPolicies getManagementPolicies(
        String resourceGroupName, String accountName, ManagementPolicyName managementPolicyName) {
        StorageAccountManagementPoliciesInner inner =
            this.serviceClient().getManagementPolicies(resourceGroupName, accountName, managementPolicyName);
        if (inner != null) {
            return new StorageAccountManagementPoliciesImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<StorageAccountManagementPolicies> getManagementPoliciesWithResponse(
        String resourceGroupName, String accountName, ManagementPolicyName managementPolicyName, Context context) {
        Response<StorageAccountManagementPoliciesInner> inner =
            this
                .serviceClient()
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new StorageAccountManagementPoliciesImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public void deleteManagementPolicies(
        String resourceGroupName, String accountName, ManagementPolicyName managementPolicyName) {
        this.serviceClient().deleteManagementPolicies(resourceGroupName, accountName, managementPolicyName);
    }
    ...
    public Response<Void> deleteManagementPoliciesWithResponse(
        ...
        return this
            .serviceClient()
            .deleteManagementPoliciesWithResponse(resourceGroupName, accountName, managementPolicyName, context);
    }
    ...
    public StorageAccountManagementPolicies getManagementPoliciesById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
    ...
    public Response<StorageAccountManagementPolicies> getManagementPoliciesByIdWithResponse(
        ...
        return this.getManagementPoliciesWithResponse(resourceGroupName, accountName, managementPolicyName, context);
    }
    ...
    public void deleteManagementPoliciesById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        this
            .deleteManagementPoliciesWithResponse(resourceGroupName, accountName, managementPolicyName, Context.NONE)
            .getValue();
    }

    public Response<Void> deleteManagementPoliciesByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.deleteManagementPoliciesWithResponse(resourceGroupName, accountName, managementPolicyName, context);
    }
    ...
    public StorageAccountManagementPoliciesImpl defineManagementPolicies(ManagementPolicyName name) {
