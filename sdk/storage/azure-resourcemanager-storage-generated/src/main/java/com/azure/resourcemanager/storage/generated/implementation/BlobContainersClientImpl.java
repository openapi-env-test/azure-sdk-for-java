...
public final class BlobContainersClientImpl implements BlobContainersClient {
     ...
     * @return the list of blob containers.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ListContainerItemsInner>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListContainerItemsInner> listAsync(String resourceGroupName, String accountName) {
        return listWithResponseAsync(resourceGroupName, accountName)
            .flatMap(
                (Response<ListContainerItemsInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ListContainerItemsInner> listWithResponse(
        String resourceGroupName, String accountName, Context context) {
