...
public final class UsagesImpl implements Usages {
    ...
    public PagedIterable<Usage> list() {
        PagedIterable<UsageInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new UsageImpl(inner1, this.manager()));
    }

    public PagedIterable<Usage> list(Context context) {
        PagedIterable<UsageInner> inner = this.serviceClient().list(context);
        return inner.mapPage(inner1 -> new UsageImpl(inner1, this.manager()));
    }
