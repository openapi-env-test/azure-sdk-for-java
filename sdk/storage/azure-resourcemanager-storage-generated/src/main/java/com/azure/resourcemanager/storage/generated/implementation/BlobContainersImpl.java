...
public final class BlobContainersImpl implements BlobContainers {
    ...
    public ListContainerItems list(String resourceGroupName, String accountName) {
        ListContainerItemsInner inner = this.serviceClient().list(resourceGroupName, accountName);
        if (inner != null) {
            return new ListContainerItemsImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<ListContainerItems> listWithResponse(
        String resourceGroupName, String accountName, Context context) {
        Response<ListContainerItemsInner> inner =
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new ListContainerItemsImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
