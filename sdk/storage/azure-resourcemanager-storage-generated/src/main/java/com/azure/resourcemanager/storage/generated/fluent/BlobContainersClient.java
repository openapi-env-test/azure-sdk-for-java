...
public interface BlobContainersClient {
    ...
    ListContainerItemsInner list(String resourceGroupName, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ListContainerItemsInner> listWithResponse(String resourceGroupName, String accountName, Context context);
