...
public final class SkuInner {
    ...
    /**
     * Get the name property: Gets or sets the sku name. Required for account creation; optional for update. Note that
    ...
    /**
     * Set the name property: Gets or sets the sku name. Required for account creation; optional for update. Note that
     * in older versions, sku name was called accountType.
     *
    ...
    public void validate() {
        if (name() == null) {
            throw logger
                .logExceptionAsError(new IllegalArgumentException("Missing required property name in model SkuInner"));
        }
