...
public interface StorageAccount {
    ...
    interface DefinitionStages {
        ...
        interface WithEncryption {
            /**
             * Specifies the encryption property: Provides the encryption settings on the account. If left unspecified
             * the account encryption settings will remain the same. The default setting is unencrypted..
             *
             * @param encryption Provides the encryption settings on the account. If left unspecified the account
    ...
    interface UpdateStages {
        ...
        interface WithSku {
             ...
             *
             * @param sku Gets or sets the SKU name. Note that the SKU name cannot be updated to Standard_ZRS or
     ...
     * @return the response from the ListKeys operation.
     */
    Response<StorageAccountListKeysResult> listKeysWithResponse(Context context);
