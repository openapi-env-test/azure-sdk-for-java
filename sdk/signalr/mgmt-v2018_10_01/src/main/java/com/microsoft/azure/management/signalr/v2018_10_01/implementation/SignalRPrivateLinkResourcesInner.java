...
public class SignalRPrivateLinkResourcesInner {
    ...
    interface SignalRPrivateLinkResourcesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.signalr.v2018_10_01.SignalRPrivateLinkResources list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.signalr.v2018_10_01.SignalRPrivateLinkResources listNext" })
        @GET
