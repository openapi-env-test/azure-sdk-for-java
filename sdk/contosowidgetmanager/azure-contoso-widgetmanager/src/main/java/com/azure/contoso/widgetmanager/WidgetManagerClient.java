...
public final class WidgetManagerClient {
     ...
     *     <tr><td>select</td><td>List&lt;String&gt;</td><td>No</td><td>Select the specified fields to be included in the response. In the form of "," separated string.</td></tr>
     * </table>
     *
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Widget> listWidgets(Integer top, Integer skip, Integer maxPageSize, List<String> select) {
        // Generated convenience method for listWidgets
        return new PagedIterable<>(client.listWidgets(top, skip, maxPageSize, select));
    }
