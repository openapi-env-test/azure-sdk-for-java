...
public final class UsageAggregatesClientImpl implements UsageAggregatesClient {
    ...
    private interface UsageAggregatesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UsageAggregationListResult>> listTestNext(
    ...
    private PagedFlux<UsageAggregationInner> listAsync(
        ...
        return new PagedFlux<>(
            ...
            nextLink -> listTestNextSinglePageAsync(nextLink));
    }
        ...
        return new PagedFlux<>(
            () ->
                listSinglePageAsync(
                    ...
                    continuationToken,
                    context),
            nextLink -> listTestNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UsageAggregationInner>> listTestNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
        ...
        final String accept = "application/json, text/json";
        return FluxUtil
            .withContext(context -> service.listTestNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<UsageAggregationInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UsageAggregationInner>> listTestNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listTestNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
