...
public final class ProtocolType extends ExpandableStringEnum<ProtocolType> {
    /** Static value Https for ProtocolType. */
    public static final ProtocolType HTTPS = fromString("Https");

    /** Static value Tcp for ProtocolType. */
    public static final ProtocolType TCP = fromString("Tcp");

    /** Static value WebSocket for ProtocolType. */
    public static final ProtocolType WEB_SOCKET = fromString("WebSocket");

    /** Static value Ssh for ProtocolType. */
    public static final ProtocolType SSH = fromString("Ssh");
