...
@Immutable
public final class AvailablePlatformImageDescriptionList {
    /*
     * One page of the list.
     */
    @JsonProperty(value = "value", access = JsonProperty.Access.WRITE_ONLY)
    private List<AvailablePlatformImageDescriptionInner> value;
     ...
     */
    public List<AvailablePlatformImageDescriptionInner> value() {
        return this.value;
    }
