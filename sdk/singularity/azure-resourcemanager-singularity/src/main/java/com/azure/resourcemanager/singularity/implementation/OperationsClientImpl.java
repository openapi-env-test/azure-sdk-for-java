...
import com.azure.resourcemanager.singularity.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(SingularityManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SingularityManagementClientOperations to be used by the proxy service
    ...
    private interface OperationsService {
        ...
        @Get("/providers/Microsoft.Singularity/operations")
     ...
     * @return describes the result of the request to list Singularity operations along with {@link PagedResponse} on
     ...
     * @throws ErrorModelPropertiesException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return describes the result of the request to list Singularity operations as paginated response with {@link
     *     PagedFlux}.
     */
