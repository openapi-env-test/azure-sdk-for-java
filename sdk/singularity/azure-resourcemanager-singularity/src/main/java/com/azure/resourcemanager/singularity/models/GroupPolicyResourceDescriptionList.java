...
@Immutable
public final class GroupPolicyResourceDescriptionList {
    /*
     * One page of the list.
     */
    @JsonProperty(value = "value", access = JsonProperty.Access.WRITE_ONLY)
    private List<GroupPolicyResourceDescriptionInner> value;
     ...
     */
    public List<GroupPolicyResourceDescriptionInner> value() {
        return this.value;
    }
