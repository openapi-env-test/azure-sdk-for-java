...
@Immutable
public final class StorageCacheResourceDescriptionList {
    /*
     * One page of the list.
     */
    @JsonProperty(value = "value", access = JsonProperty.Access.WRITE_ONLY)
    private List<StorageCacheResourceDescriptionInner> value;
     ...
     */
    public List<StorageCacheResourceDescriptionInner> value() {
        return this.value;
    }
