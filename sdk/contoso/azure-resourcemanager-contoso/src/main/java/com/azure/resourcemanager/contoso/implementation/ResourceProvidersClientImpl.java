...
import com.azure.resourcemanager.contoso.models.OperationListResult;
...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
     ...
     */
    ResourceProvidersClientImpl(ContosoImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ContosoResourceProviders to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ContosoResourceProvi")
