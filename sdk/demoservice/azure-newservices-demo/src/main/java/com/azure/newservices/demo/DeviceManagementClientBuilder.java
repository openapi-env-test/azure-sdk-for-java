...
import com.azure.newservices.demo.implementation.DemoNewServiceClientImpl;
...
public final class DeviceManagementClientBuilder
    ...
    @Generated
    private final Map<String, String> properties = CoreUtils.getProperties("azure-newservices-demo.properties");
     ...
     * Service version
     */
    @Generated private DemoNewServiceVersion serviceVersion;
     ...
     */
    @Generated
    public DeviceManagementClientBuilder serviceVersion(DemoNewServiceVersion serviceVersion) {
    ...
    /**
     * Builds an instance of DemoNewServiceClientImpl with the provided parameters.
     *
     * @return an instance of DemoNewServiceClientImpl.
     */
    @Generated
    private DemoNewServiceClientImpl buildInnerClient() {
        if (pipeline == null) {
            this.pipeline = createHttpPipeline();
        }
        if (serviceVersion == null) {
            this.serviceVersion = DemoNewServiceVersion.getLatest();
        }
        DemoNewServiceClientImpl client =
                new DemoNewServiceClientImpl(
                        pipeline,
