    ...
    public static void main(String[] args) {
        DeviceManagementClient deviceManagementClient =
                new DeviceManagementClientBuilder()
                        ...
                        .instanceId("blue")
                        .buildClient();
        // BEGIN:com.azure.newservice.demo.generated.devicemanagementgetgroup.devicemanagementgetgroup
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response = deviceManagementClient.getGroupWithResponse("group1", requestOptions);
        // END:com.azure.newservice.demo.generated.devicemanagementgetgroup.devicemanagementgetgroup
    }
}
