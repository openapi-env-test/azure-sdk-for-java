    ...
    public static void main(String[] args) {
        DeviceManagementClient deviceManagementClient =
                new DeviceManagementClientBuilder()
                        ...
                        .instanceId("blue")
                        .buildClient();
        // BEGIN:com.azure.newservice.demo.generated.devicemanagementlistdevicehealth.devicemanagementlistdevicehealth
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response =
                deviceManagementClient.listDeviceHealthWithResponse("state eq 'unhealthy'", requestOptions);
        // END:com.azure.newservice.demo.generated.devicemanagementlistdevicehealth.devicemanagementlistdevicehealth
    }
}
