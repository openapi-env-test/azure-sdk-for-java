...
package com.azure.newservice.demo.implementation;
...
import com.azure.newservice.demo.DemoNewServiceVersion;

/** Initializes a new instance of the DemoNewServiceClient type. */
public final class DemoNewServiceClientImpl {
    /** Account endpoint. */
    ...
    /** Service version. */
    private final DemoNewServiceVersion serviceVersion;
     ...
     */
    public DemoNewServiceVersion getServiceVersion() {
    ...
    /**
     * Initializes an instance of DemoNewServiceClient client.
     *
     * @param endpoint Account endpoint.
     * @param instanceId Account instance identifier.
     * @param serviceVersion Service version.
     */
    public DemoNewServiceClientImpl(String endpoint, String instanceId, DemoNewServiceVersion serviceVersion) {
        this(
     ...
     * @param serviceVersion Service version.
     */
    public DemoNewServiceClientImpl(
            HttpPipeline httpPipeline, String endpoint, String instanceId, DemoNewServiceVersion serviceVersion) {
    ...
    public DemoNewServiceClientImpl(
            ...
            String endpoint,
            String instanceId,
            DemoNewServiceVersion serviceVersion) {
