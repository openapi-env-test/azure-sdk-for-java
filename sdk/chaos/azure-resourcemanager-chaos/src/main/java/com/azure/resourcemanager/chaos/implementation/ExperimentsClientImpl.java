...
public final class ExperimentsClientImpl implements ExperimentsClient {
    ...
    private Mono<PagedResponse<ExperimentInner>> listSinglePageAsync(Boolean running) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ExperimentInner>> listSinglePageAsync(Boolean running, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<ExperimentInner> listAsync(Boolean running) {
        return new PagedFlux<>(() -> listSinglePageAsync(running), nextLink -> listAllNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ExperimentInner> listAsync(Boolean running, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(running, context), nextLink -> listAllNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<ExperimentInner> list() {
        final Boolean running = null;
        return new PagedIterable<>(listAsync(running));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ExperimentInner> list(Boolean running, Context context) {
        return new PagedIterable<>(listAsync(running, context));
    }
