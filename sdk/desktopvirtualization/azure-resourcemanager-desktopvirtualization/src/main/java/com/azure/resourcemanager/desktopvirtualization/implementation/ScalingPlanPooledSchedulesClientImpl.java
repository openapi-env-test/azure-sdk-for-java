...
public final class ScalingPlanPooledSchedulesClientImpl implements ScalingPlanPooledSchedulesClient {
    ...
    public ScalingPlanPooledScheduleInner get(
        String resourceGroupName, String scalingPlanName, String scalingPlanScheduleName) {
        return getAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName).block();
    }
    ...
    public ScalingPlanPooledScheduleInner create(
        ...
        String scalingPlanScheduleName,
        ScalingPlanPooledScheduleInner scalingPlanSchedule) {
        return createAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName, scalingPlanSchedule).block();
    }
    ...
    public void delete(String resourceGroupName, String scalingPlanName, String scalingPlanScheduleName) {
        deleteAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName).block();
    }
    ...
    public ScalingPlanPooledScheduleInner update(
        String resourceGroupName, String scalingPlanName, String scalingPlanScheduleName) {
        final ScalingPlanPooledSchedulePatch scalingPlanSchedule = null;
        return updateAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName, scalingPlanSchedule).block();
    }
    ...
    private PagedFlux<ScalingPlanPooledScheduleInner> listAsync(String resourceGroupName, String scalingPlanName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, scalingPlanName),
    ...
    private PagedFlux<ScalingPlanPooledScheduleInner> listAsync(
        String resourceGroupName, String scalingPlanName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, scalingPlanName, context),
    ...
    public PagedIterable<ScalingPlanPooledScheduleInner> list(String resourceGroupName, String scalingPlanName) {
        return new PagedIterable<>(listAsync(resourceGroupName, scalingPlanName));
    }
    ...
    public PagedIterable<ScalingPlanPooledScheduleInner> list(
        String resourceGroupName, String scalingPlanName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, scalingPlanName, context));
    }
