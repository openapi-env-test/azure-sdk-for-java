...
import com.azure.resourcemanager.batchai.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(BatchAIImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for BatchAIOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BatchAIOperations")
