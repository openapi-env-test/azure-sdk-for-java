...
import com.azure.resourcemanager.batchai.models.ListUsagesResult;
...
public final class UsagesClientImpl implements UsagesClient {
     ...
     */
    UsagesClientImpl(BatchAIImpl client) {
        this.service = RestProxy.create(UsagesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for BatchAIUsages to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BatchAIUsages")
