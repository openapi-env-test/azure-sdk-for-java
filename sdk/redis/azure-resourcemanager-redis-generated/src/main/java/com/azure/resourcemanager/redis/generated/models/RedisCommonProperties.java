...
public class RedisCommonProperties {
    ...
    /*
     * Redis version. This should be in the form 'major[.minor]' (only 'major'
     * is required) or the value 'latest' which refers to the latest stable
     * Redis version that is available. Supported versions: 4.0, 6.0 (latest).
