...
public class DatabasesInner {
    ...
    public Observable<ServiceResponse<Page<DatabaseInner>>> listByServerSinglePageAsync(final String resourceGroupName, final String serverName) {
        ...
        final String apiVersion = "20017-03-01-preview";
    ...
    public Observable<ServiceResponse<ImportExportOperationResultInner>> exportWithServiceResponseAsync(String resourceGroupName, String serverName, String databaseName, ImportExportDatabaseDefinition parameters) {
        ...
        Validator.validate(parameters);
        final String apiVersion = "20017-03-01-preview";
        Observable<Response<ResponseBody>> observable = service.export(resourceGroupName, serverName, databaseName, this.client.subscriptionId(), parameters, apiVersion, this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<ImportExportOperationResultInner>> beginExportWithServiceResponseAsync(String resourceGroupName, String serverName, String databaseName, ImportExportDatabaseDefinition parameters) {
        ...
        Validator.validate(parameters);
        final String apiVersion = "20017-03-01-preview";
        return service.beginExport(resourceGroupName, serverName, databaseName, this.client.subscriptionId(), parameters, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
