...
public final class ServerDevOpsAuditingSettingsImpl
    ...
    ServerDevOpsAuditingSettingsImpl(String name, SqlManager serviceManager) {
    ...
    ServerDevOpsAuditingSettingsImpl(ServerDevOpsAuditingSettingsInner innerObject, SqlManager serviceManager) {
