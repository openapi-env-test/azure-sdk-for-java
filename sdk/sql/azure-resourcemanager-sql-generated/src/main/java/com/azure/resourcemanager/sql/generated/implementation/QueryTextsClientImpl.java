...
import com.azure.resourcemanager.sql.generated.models.QueryTextListResult;
...
public final class QueryTextsClientImpl implements QueryTextsClient {
     ...
     */
    QueryTextsClientImpl(SqlManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SqlManagementClientQueryTexts to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface QueryTextsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/topQueries/{queryId}/queryText")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<QueryTextListResult>> listByQuery(
    ...
    private Mono<PagedResponse<QueryTextInner>> listByQuerySinglePageAsync(
    ...
    private PagedFlux<QueryTextInner> listByQueryAsync(
        String resourceGroupName, String serverName, String databaseName, String queryId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<QueryTextInner> listByQuery(
        String resourceGroupName, String serverName, String databaseName, String queryId) {
