...
public interface QueriesClient {
    ...
    PagedIterable<TopQueriesInner> listByDatabase(String resourceGroupName, String serverName, String databaseName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TopQueriesInner> listByDatabase(
