...
public final class ServerAdvisorsClientImpl implements ServerAdvisorsClient {
    ...
    private interface ServerAdvisorsService {
        ...
        Mono<Response<AdvisorListResultInner>> listByServer(
    ...
    private Mono<Response<AdvisorListResultInner>> listByServerWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorListResultInner> listByServerAsync(String resourceGroupName, String serverName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AdvisorListResultInner> listByServerWithResponse(
        String resourceGroupName, String serverName, Context context) {
    ...
    private Mono<AdvisorInner> createOrUpdateAsync(
        String resourceGroupName, String serverName, String advisorName, AdvisorInner parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, serverName, advisorName, parameters)
            .flatMap(
                (Response<AdvisorInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public AdvisorInner createOrUpdate(
        String resourceGroupName, String serverName, String advisorName, AdvisorInner parameters) {
        return createOrUpdateAsync(resourceGroupName, serverName, advisorName, parameters).block();
    }
    ...
    public Response<AdvisorInner> createOrUpdateWithResponse(
        String resourceGroupName, String serverName, String advisorName, AdvisorInner parameters, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, serverName, advisorName, parameters, context).block();
    }
}
