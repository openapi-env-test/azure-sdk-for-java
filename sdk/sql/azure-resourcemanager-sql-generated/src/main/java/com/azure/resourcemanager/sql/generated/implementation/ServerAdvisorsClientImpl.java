...
public final class ServerAdvisorsClientImpl implements ServerAdvisorsClient {
    ...
    private interface ServerAdvisorsService {
        ...
        Mono<Response<List<AdvisorAutoGeneratedInner>>> listByServer(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AdvisorAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AdvisorAutoGeneratedInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("advisorName") String advisorName,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AdvisorAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<List<AdvisorAutoGeneratedInner>>> listByServerWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<AdvisorAutoGeneratedInner>> listByServerAsync(
        String resourceGroupName, String serverName, String expand) {
        return listByServerWithResponseAsync(resourceGroupName, serverName, expand)
            .flatMap(
                (Response<List<AdvisorAutoGeneratedInner>> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<AdvisorAutoGeneratedInner>> listByServerAsync(String resourceGroupName, String serverName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<AdvisorAutoGeneratedInner> listByServer(String resourceGroupName, String serverName) {
        final String expand = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<AdvisorAutoGeneratedInner>> listByServerWithResponse(
        String resourceGroupName, String serverName, String expand, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AdvisorAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorAutoGeneratedInner> getAsync(String resourceGroupName, String serverName, String advisorName) {
        return getWithResponseAsync(resourceGroupName, serverName, advisorName)
            .flatMap(
                (Response<AdvisorAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AdvisorAutoGeneratedInner get(String resourceGroupName, String serverName, String advisorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AdvisorAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serverName, String advisorName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AdvisorAutoGeneratedInner>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorAutoGeneratedInner> updateAsync(
        String resourceGroupName, String serverName, String advisorName, AdvisorAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AdvisorAutoGeneratedInner update(
        String resourceGroupName, String serverName, String advisorName, AdvisorAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AdvisorAutoGeneratedInner> updateWithResponse(
        String resourceGroupName,
        String serverName,
        String advisorName,
        AdvisorAutoGeneratedInner parameters,
