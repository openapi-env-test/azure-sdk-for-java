...
@JsonFlatten
@Fluent
public class RecommendedActionAutoGeneratedInner extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RecommendedActionAutoGeneratedInner.class);
