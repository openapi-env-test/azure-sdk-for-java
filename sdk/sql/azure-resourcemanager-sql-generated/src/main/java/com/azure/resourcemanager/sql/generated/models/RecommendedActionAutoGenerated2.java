...
@JsonFlatten
@Fluent
public class RecommendedActionAutoGenerated2 {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RecommendedActionAutoGenerated2.class);
     ...
     * @return the RecommendedActionAutoGenerated2 object itself.
     */
    public RecommendedActionAutoGenerated2 withState(RecommendedActionStateInfo state) {
        this.state = state;
        return this;
    }
