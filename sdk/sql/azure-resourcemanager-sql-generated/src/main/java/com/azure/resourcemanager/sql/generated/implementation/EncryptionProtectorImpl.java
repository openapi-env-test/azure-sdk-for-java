...
public final class EncryptionProtectorImpl
    ...
    EncryptionProtectorImpl(EncryptionProtectorName name, SqlManager serviceManager) {
    ...
    EncryptionProtectorImpl(EncryptionProtectorInner innerObject, SqlManager serviceManager) {
