...
public final class ManagedDatabasesClientImpl implements ManagedDatabasesClient {
    ...
    private interface ManagedDatabasesService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/providers/Microsoft.Sql/locations/{locationName}"
                + "/managedDatabaseRestoreAzureAsyncOperation/{operationId}/completeRestore")
    ...
    private Mono<Response<Flux<ByteBuffer>>> completeRestoreWithResponseAsync(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> completeRestoreWithResponseAsync(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginCompleteRestoreAsync(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = completeRestoreWithResponseAsync(locationName, operationId, parameters);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginCompleteRestoreAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            completeRestoreWithResponseAsync(locationName, operationId, parameters, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginCompleteRestore(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters) {
        return beginCompleteRestoreAsync(locationName, operationId, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCompleteRestore(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters, Context context) {
        return beginCompleteRestoreAsync(locationName, operationId, parameters, context).getSyncPoller();
    }
    ...
    private Mono<Void> completeRestoreAsync(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters) {
        return beginCompleteRestoreAsync(locationName, operationId, parameters)
            .last()
    ...
    private Mono<Void> completeRestoreAsync(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters, Context context) {
        return beginCompleteRestoreAsync(locationName, operationId, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void completeRestore(String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters) {
        completeRestoreAsync(locationName, operationId, parameters).block();
    }
    ...
    public void completeRestore(
        String locationName, UUID operationId, CompleteDatabaseRestoreDefinition parameters, Context context) {
        completeRestoreAsync(locationName, operationId, parameters, context).block();
    }
