...
public final class InstanceFailoverGroupImpl
    ...
    InstanceFailoverGroupImpl(String name, SqlManager serviceManager) {
    ...
    InstanceFailoverGroupImpl(InstanceFailoverGroupInner innerObject, SqlManager serviceManager) {
