...
public final class OperationsHealthsImpl implements OperationsHealths {
    ...
    public OperationsHealthsImpl(OperationsHealthsClient innerClient, SqlManager serviceManager) {
    ...
    public PagedIterable<OperationsHealth> listByLocation(String locationName) {
        ...
        return inner.mapPage(inner1 -> new OperationsHealthImpl(inner1, this.manager()));
    }
