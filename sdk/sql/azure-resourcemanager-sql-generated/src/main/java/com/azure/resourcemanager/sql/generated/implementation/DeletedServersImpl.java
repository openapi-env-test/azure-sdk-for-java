...
public final class DeletedServersImpl implements DeletedServers {
    ...
    public DeletedServersImpl(DeletedServersClient innerClient, SqlManager serviceManager) {
    ...
    public PagedIterable<DeletedServer> list() {
        ...
        return inner.mapPage(inner1 -> new DeletedServerImpl(inner1, this.manager()));
    }
