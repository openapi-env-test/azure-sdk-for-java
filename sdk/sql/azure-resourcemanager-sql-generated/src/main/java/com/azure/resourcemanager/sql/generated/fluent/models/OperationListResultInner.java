...
/**
 * Result of the request to list SQL operations. It contains a list of operations and a URL link to get the next set of
 * results.
 */
@Fluent
public final class OperationListResultInner {
    ...
    /**
     * Get the value property: List of SQL operations supported by the SQL resource provider.
     *
    ...
    /**
     * Set the value property: List of SQL operations supported by the SQL resource provider.
     *
