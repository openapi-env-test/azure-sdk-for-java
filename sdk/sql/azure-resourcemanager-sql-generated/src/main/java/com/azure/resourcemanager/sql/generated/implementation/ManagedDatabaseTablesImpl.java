...
public final class ManagedDatabaseTablesImpl implements ManagedDatabaseTables {
    ...
    public ManagedDatabaseTablesImpl(ManagedDatabaseTablesClient innerClient, SqlManager serviceManager) {
    ...
    public PagedIterable<DatabaseTable> listBySchema(
        ...
        return inner.mapPage(inner1 -> new DatabaseTableImpl(inner1, this.manager()));
    }
