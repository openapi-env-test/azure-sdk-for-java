...
public final class ServerCommunicationLinkImpl
    ...
    ServerCommunicationLinkImpl(String name, SqlManager serviceManager) {
    ...
    ServerCommunicationLinkImpl(ServerCommunicationLinkInner innerObject, SqlManager serviceManager) {
