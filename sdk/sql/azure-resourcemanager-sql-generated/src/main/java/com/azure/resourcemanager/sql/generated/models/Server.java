...
public interface Server {
    ...
    /**
     * Gets the administratorLogin property: Administrator username for the server. Can only be specified when the
    ...
    /**
     * Gets the externalAdministratorSid property: The ID of the Active Azure Directory object with admin permissions on
    ...
    /**
     * Gets the externalAdministratorLogin property: The display name of the Azure Active Directory object with admin
    ...
    interface DefinitionStages {
        ...
        interface WithAdministratorLogin {
            /**
             * Specifies the administratorLogin property: Administrator username for the server. Can only be specified
             * when the server is being created (and is required for creation)..
             *
             * @param administratorLogin Administrator username for the server. Can only be specified when the server is
