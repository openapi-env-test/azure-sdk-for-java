...
public final class DatabaseImpl implements Database, Database.Definition, Database.Update {
    ...
    public Integer readReplicaCount() {
        return this.innerModel().readReplicaCount();
    }
    ...
    public DatabaseImpl withReadReplicaCount(Integer readReplicaCount) {
        if (isInCreateMode()) {
            this.innerModel().withReadReplicaCount(readReplicaCount);
            return this;
        } else {
            this.updateParameters.withReadReplicaCount(readReplicaCount);
            return this;
        }
    }
