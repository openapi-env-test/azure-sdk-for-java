...
public final class ServerBlobAuditingPolicyImpl
    ...
    ServerBlobAuditingPolicyImpl(SqlManager serviceManager) {
    ...
    ServerBlobAuditingPolicyImpl(ServerBlobAuditingPolicyInner innerObject, SqlManager serviceManager) {
