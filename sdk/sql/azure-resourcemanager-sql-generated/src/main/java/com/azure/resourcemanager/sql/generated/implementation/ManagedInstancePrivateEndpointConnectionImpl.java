...
public final class ManagedInstancePrivateEndpointConnectionImpl
    ...
    ManagedInstancePrivateEndpointConnectionImpl(String name, SqlManager serviceManager) {
    ...
    ManagedInstancePrivateEndpointConnectionImpl(
        ManagedInstancePrivateEndpointConnectionInner innerObject, SqlManager serviceManager) {
