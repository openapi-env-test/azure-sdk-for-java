...
public final class QueriesClientImpl implements QueriesClient {
     ...
     */
    QueriesClientImpl(SqlManagementClientImpl client) {
        this.service = RestProxy.create(QueriesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SqlManagementClientQueries to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    private interface QueriesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/topQueries")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TopQueriesListResult>> listByDatabase(
     ...
     * @return a list of top queries by database.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TopQueriesInner>> listByDatabaseSinglePageAsync(
    ...
    private PagedFlux<TopQueriesInner> listByDatabaseAsync(
        String resourceGroupName, String serverName, String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TopQueriesInner> listByDatabase(
        String resourceGroupName, String serverName, String databaseName) {
