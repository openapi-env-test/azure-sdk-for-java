...
public final class ManagedDatabaseQueriesImpl implements ManagedDatabaseQueries {
    ...
    public ManagedDatabaseQueriesImpl(ManagedDatabaseQueriesClient innerClient, SqlManager serviceManager) {
    ...
    public PagedIterable<QueryStatistics> listByQuery(
        ...
        return inner.mapPage(inner1 -> new QueryStatisticsImpl(inner1, this.manager()));
    }
