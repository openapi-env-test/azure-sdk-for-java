...
public final class DatabaseBlobAuditingPolicyImpl
    ...
    DatabaseBlobAuditingPolicyImpl(SqlManager serviceManager) {
    ...
    DatabaseBlobAuditingPolicyImpl(DatabaseBlobAuditingPolicyInner innerObject, SqlManager serviceManager) {
