...
public final class DatabaseSchemasClientImpl implements DatabaseSchemasClient {
    private final ClientLogger logger = new ClientLogger(DatabaseSchemasClientImpl.class);
    ...
    private Mono<PagedResponse<Resource>> listByDatabaseSinglePageAsync(
    ...
    private PagedFlux<Resource> listByDatabaseAsync(
        String resourceGroupName, String serverName, String databaseName, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<Resource> listByDatabaseAsync(String resourceGroupName, String serverName, String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<Resource>> listByDatabaseNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<Resource>> listByDatabaseNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
