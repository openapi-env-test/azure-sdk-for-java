...
public final class ServerConnectionPolicyImpl
    ...
    ServerConnectionPolicyImpl(ConnectionPolicyName name, SqlManager serviceManager) {
    ...
    ServerConnectionPolicyImpl(ServerConnectionPolicyInner innerObject, SqlManager serviceManager) {
