...
public final class AppServiceEnvironmentsClientImpl implements AppServiceEnvironmentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AddressResponseInner>> listVipsWithResponseAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AddressResponseInner> listVipsAsync(String resourceGroupName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetricDefinitionInner> listMetricDefinitionsAsync(String resourceGroupName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ResourceMetricInner> listMultiRoleMetricsAsync(String resourceGroupName, String name) {
