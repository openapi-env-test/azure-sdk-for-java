...
public final class SiteImpl implements Site, Site.Definition, Site.Update {
    ...
    public SnapshotRecoveryRequest snapshotInfo() {
        return this.innerModel().snapshotInfo();
    }
    ...
    public void recover(SnapshotRecoveryRequest recoveryEntity) {
        serviceManager.webApps().recover(resourceGroupName, name, recoveryEntity);
    }

    public void recover(SnapshotRecoveryRequest recoveryEntity, Context context) {
        serviceManager.webApps().recover(resourceGroupName, name, recoveryEntity, context);
    }
    ...
    public SiteImpl withSnapshotInfo(SnapshotRecoveryRequest snapshotInfo) {
        this.innerModel().withSnapshotInfo(snapshotInfo);
        return this;
    }
