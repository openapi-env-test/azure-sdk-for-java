...
public final class AppServiceEnvironmentsImpl implements AppServiceEnvironments {
    ...
    public AddressResponse listVips(String resourceGroupName, String name) {
        AddressResponseInner inner = this.serviceClient().listVips(resourceGroupName, name);
        if (inner != null) {
    ...
    public Response<AddressResponse> listVipsWithResponse(String resourceGroupName, String name, Context context) {
        Response<AddressResponseInner> inner =
            this.serviceClient().listVipsWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public MetricDefinition listMetricDefinitions(String resourceGroupName, String name) {
        MetricDefinitionInner inner = this.serviceClient().listMetricDefinitions(resourceGroupName, name);
        if (inner != null) {
    ...
    public Response<MetricDefinition> listMetricDefinitionsWithResponse(
        String resourceGroupName, String name, Context context) {
        Response<MetricDefinitionInner> inner =
            this.serviceClient().listMetricDefinitionsWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PagedIterable<ResourceMetric> listMultiRolePoolInstanceMetrics(
        String resourceGroupName, String name, String instance) {
        PagedIterable<ResourceMetricInner> inner =
            this.serviceClient().listMultiRolePoolInstanceMetrics(resourceGroupName, name, instance);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ResourceMetric> listMultiRolePoolInstanceMetrics(
        ...
        PagedIterable<ResourceMetricInner> inner =
            this.serviceClient().listMultiRolePoolInstanceMetrics(resourceGroupName, name, instance, details, context);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ResourceMetric> listMultiRoleMetrics(String resourceGroupName, String name) {
        PagedIterable<ResourceMetricInner> inner = this.serviceClient().listMultiRoleMetrics(resourceGroupName, name);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }

    public PagedIterable<ResourceMetric> listMultiRoleMetrics(
        ...
        PagedIterable<ResourceMetricInner> inner =
            this
                .serviceClient()
                .listMultiRoleMetrics(resourceGroupName, name, startTime, endTime, timeGrain, details, filter, context);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ResourceMetric> listWorkerPoolInstanceMetrics(
        String resourceGroupName, String name, String workerPoolName, String instance) {
        PagedIterable<ResourceMetricInner> inner =
            this.serviceClient().listWorkerPoolInstanceMetrics(resourceGroupName, name, workerPoolName, instance);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ResourceMetric> listWebWorkerMetrics(
        String resourceGroupName, String name, String workerPoolName) {
        PagedIterable<ResourceMetricInner> inner =
            this.serviceClient().listWebWorkerMetrics(resourceGroupName, name, workerPoolName);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ResourceMetric> listWebWorkerMetrics(
        ...
        PagedIterable<ResourceMetricInner> inner =
            this
                .serviceClient()
                .listWebWorkerMetrics(resourceGroupName, name, workerPoolName, details, filter, context);
        return inner.mapPage(inner1 -> new ResourceMetricImpl(inner1, this.manager()));
    }
