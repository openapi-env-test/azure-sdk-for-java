...
public final class PremierAddOnImpl implements PremierAddOn, PremierAddOn.Definition, PremierAddOn.Update {
    ...
    public String premierAddOnName() {
        return this.innerModel().premierAddOnName();
    }
    ...
    public PremierAddOnImpl withPremierAddOnName(String premierAddOnName) {
        this.innerModel().withPremierAddOnName(premierAddOnName);
        return this;
    }

    public PremierAddOnImpl withLocationPropertiesLocation(String locationPropertiesLocation) {
        this.innerModel().withLocationPropertiesLocation(locationPropertiesLocation);
        return this;
    }

    public PremierAddOnImpl withTagsPropertiesTags(Map<String, String> tagsPropertiesTags) {
