...
public interface Diagnostics {
     ...
     */
    DiagnosticAnalysis getSiteAnalysis(
     ...
     * @return site Analysis.
     */
    Response<DiagnosticAnalysis> getSiteAnalysisWithResponse(
     ...
     * @return detector.
     */
    PagedIterable<DetectorDefinition> getSiteDetector(
     ...
     * @return site Analysis.
     */
    DiagnosticAnalysis getSiteAnalysisSlot(
     ...
     * @return site Analysis.
     */
    Response<DiagnosticAnalysis> getSiteAnalysisSlotWithResponse(
        String resourceGroupName,
        String siteName,
        String diagnosticCategory,
        String analysisName,
     ...
     * @return detector.
     */
    PagedIterable<DetectorDefinition> getSiteDetectorSlot(
