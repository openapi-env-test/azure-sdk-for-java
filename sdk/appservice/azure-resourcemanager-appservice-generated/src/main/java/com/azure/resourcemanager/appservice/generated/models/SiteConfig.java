...
public final class SiteConfig {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(SiteConfig.class);
     ...
     * @return the SiteConfig object itself.
     */
    public SiteConfig withRequestTracingExpirationTime(OffsetDateTime requestTracingExpirationTime) {
