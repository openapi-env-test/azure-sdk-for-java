...
public class SitePatchResourceInner extends ProxyOnlyResource {
    ...
    /**
     * Get the snapshotInfo property: If specified during app creation, the app is created from a previous snapshot.
     *
    ...
    /**
     * Set the snapshotInfo property: If specified during app creation, the app is created from a previous snapshot.
     *
     * @param snapshotInfo the snapshotInfo value to set.
     * @return the SitePatchResourceInner object itself.
     */
    public SitePatchResourceInner withSnapshotInfo(SnapshotRecoveryRequest snapshotInfo) {
