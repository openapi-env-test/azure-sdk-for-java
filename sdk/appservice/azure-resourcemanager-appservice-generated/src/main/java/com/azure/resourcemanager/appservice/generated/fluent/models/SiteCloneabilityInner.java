...
public final class SiteCloneabilityInner {
    ...
    /**
     * Get the result property: Name of web app.
     *
    ...
    /**
     * Set the result property: Name of web app.
     *
    ...
    /**
     * Get the blockingFeatures property: List of features enabled on web app that prevent cloning.
     *
    ...
    /**
     * Set the blockingFeatures property: List of features enabled on web app that prevent cloning.
     *
    ...
    /**
     * Get the unsupportedFeatures property: List of features enabled on web app that are non-blocking but cannot be
     * cloned. The web app can still be cloned but the features in this list will not be set up on cloned web app.
     *
    ...
    /**
     * Set the unsupportedFeatures property: List of features enabled on web app that are non-blocking but cannot be
     * cloned. The web app can still be cloned but the features in this list will not be set up on cloned web app.
     *
    ...
    public void validate() {
        if (result() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property result in model SiteCloneabilityInner"));
        }
