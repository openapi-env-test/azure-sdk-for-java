...
public final class AutoHealRules {
    ...
    /**
     * Get the triggers property: Triggers - Conditions that describe when to execute the auto-heal actions.
     *
    ...
    /**
     * Set the triggers property: Triggers - Conditions that describe when to execute the auto-heal actions.
     *
    ...
    /**
     * Get the actions property: Actions - Actions to be executed when a rule is triggered.
     *
    ...
    /**
     * Set the actions property: Actions - Actions to be executed when a rule is triggered.
     *
