...
public class PremierAddOnInner extends Resource {
    ...
    /**
     * Get the premierAddOnName property: Premier add on Name.
     *
    ...
    /**
     * Set the premierAddOnName property: Premier add on Name.
     *
    ...
    /**
     * Get the locationPropertiesLocation property: Premier add on Location.
     *
    ...
    /**
     * Set the locationPropertiesLocation property: Premier add on Location.
     *
     * @param locationPropertiesLocation the locationPropertiesLocation value to set.
     * @return the PremierAddOnInner object itself.
     */
    public PremierAddOnInner withLocationPropertiesLocation(String locationPropertiesLocation) {
        this.locationPropertiesLocation = locationPropertiesLocation;
        return this;
    }

    /**
     * Get the tagsPropertiesTags property: Premier add on Tags.
     *
    ...
    /**
     * Set the tagsPropertiesTags property: Premier add on Tags.
     *
     * @param tagsPropertiesTags the tagsPropertiesTags value to set.
     * @return the PremierAddOnInner object itself.
     */
    public PremierAddOnInner withTagsPropertiesTags(Map<String, String> tagsPropertiesTags) {
