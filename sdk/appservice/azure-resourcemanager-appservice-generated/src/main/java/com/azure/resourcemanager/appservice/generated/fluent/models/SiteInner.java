...
public class SiteInner extends Resource {
     ...
     */
    public SiteInner withNamePropertiesName(String namePropertiesName) {
     ...
     * @return the SiteInner object itself.
     */
    public SiteInner withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the SiteInner object itself.
     */
    public SiteInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SiteInner object itself.
     */
    public SiteInner withType(String type) {
        this.type = type;
        return this;
    }
