...
import com.azure.resourcemanager.appservice.generated.models.SnapshotRecoveryRequest;
...
public final class WebAppsImpl implements WebApps {
    ...
    public RestoreRequest discoverRestore(String resourceGroupName, String name, RestoreRequestInner request) {
        RestoreRequestInner inner = this.serviceClient().discoverRestore(resourceGroupName, name, request);
        if (inner != null) {
    ...
    public Response<RestoreRequest> discoverRestoreWithResponse(
        String resourceGroupName, String name, RestoreRequestInner request, Context context) {
        Response<RestoreRequestInner> inner =
            this.serviceClient().discoverRestoreWithResponse(resourceGroupName, name, request, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public RestoreResponse restore(
        ...
        RestoreResponseInner inner = this.serviceClient().restore(resourceGroupName, name, backupId, request);
        if (inner != null) {
    ...
    public RestoreResponse restore(
        ...
        RestoreResponseInner inner = this.serviceClient().restore(resourceGroupName, name, backupId, request, context);
        if (inner != null) {
            return new RestoreResponseImpl(inner, this.manager());
        } else {
            return null;
    ...
    public InputStream getWebSiteContainerLogsZip(String resourceGroupName, String name) {
        return this.serviceClient().getWebSiteContainerLogsZip(resourceGroupName, name);
    }

    public StreamResponse getWebSiteContainerLogsZipWithResponse(
        String resourceGroupName, String name, Context context) {
        return this.serviceClient().getWebSiteContainerLogsZipWithResponse(resourceGroupName, name, context);
    }
    ...
    public String stopWebSiteNetworkTrace(String resourceGroupName, String name) {
        return this.serviceClient().stopWebSiteNetworkTrace(resourceGroupName, name);
    }

    public Response<String> stopWebSiteNetworkTraceWithResponse(
        String resourceGroupName, String name, Context context) {
    ...
    public void recover(String resourceGroupName, String name, SnapshotRecoveryRequest recoveryEntity) {
        this.serviceClient().recover(resourceGroupName, name, recoveryEntity);
    }

    public void recover(
        String resourceGroupName, String name, SnapshotRecoveryRequest recoveryEntity, Context context) {
        this.serviceClient().recover(resourceGroupName, name, recoveryEntity, context);
    }
    ...
    public Site createOrUpdateSlot(
        ...
        Boolean skipDnsRegistration,
        Boolean skipCustomDomainVerification,
        Boolean forceDnsRegistration,
        String ttlInSeconds) {
        SiteInner inner =
            this
                .serviceClient()
    ...
    public Response<Void> deleteSlotWithResponse(
        ...
        return this
            ...
            .deleteSlotWithResponse(
                resourceGroupName, name, slot, deleteMetrics, deleteEmptyServerFarm, skipDnsRegistration, context);
    }
    ...
    public RestoreRequest discoverRestoreSlot(
        String resourceGroupName, String name, String slot, RestoreRequestInner request) {
        RestoreRequestInner inner = this.serviceClient().discoverRestoreSlot(resourceGroupName, name, slot, request);
        if (inner != null) {
            return new RestoreRequestImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<RestoreRequest> discoverRestoreSlotWithResponse(
        String resourceGroupName, String name, String slot, RestoreRequestInner request, Context context) {
        Response<RestoreRequestInner> inner =
            this.serviceClient().discoverRestoreSlotWithResponse(resourceGroupName, name, slot, request, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public RestoreResponse restoreSlot(
        String resourceGroupName, String name, String backupId, String slot, RestoreRequestInner request) {
        RestoreResponseInner inner = this.serviceClient().restoreSlot(resourceGroupName, name, backupId, slot, request);
        if (inner != null) {
            return new RestoreResponseImpl(inner, this.manager());
        } else {
            return null;
    ...
    public InputStream getWebSiteContainerLogsZipSlot(String resourceGroupName, String name, String slot) {
        return this.serviceClient().getWebSiteContainerLogsZipSlot(resourceGroupName, name, slot);
    }

    public StreamResponse getWebSiteContainerLogsZipSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
        return this.serviceClient().getWebSiteContainerLogsZipSlotWithResponse(resourceGroupName, name, slot, context);
    }
    ...
    public String stopWebSiteNetworkTraceSlot(String resourceGroupName, String name, String slot) {
        return this.serviceClient().stopWebSiteNetworkTraceSlot(resourceGroupName, name, slot);
    }

    public Response<String> stopWebSiteNetworkTraceSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
    ...
    public void recoverSlot(
        String resourceGroupName, String name, String slot, SnapshotRecoveryRequest recoveryEntity) {
        this.serviceClient().recoverSlot(resourceGroupName, name, slot, recoveryEntity);
    }

    public void recoverSlot(
        String resourceGroupName, String name, String slot, SnapshotRecoveryRequest recoveryEntity, Context context) {
        this.serviceClient().recoverSlot(resourceGroupName, name, slot, recoveryEntity, context);
    }
