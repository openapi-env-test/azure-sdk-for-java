...
public interface VnetRoute {
    ...
    /**
     * Gets the vnetRouteName property: The name of this route. This is only returned by the server and does not need to
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithKind,
                DefinitionStages.WithVnetRouteName,
        ...
        interface WithVnetRouteName {
            /**
             * Specifies the vnetRouteName property: The name of this route. This is only returned by the server and
             * does not need to be set by the client..
             *
             * @param vnetRouteName The name of this route. This is only returned by the server and does not need to be
             *     set by the client.
             * @return the next definition stage.
             */
    ...
    interface Update
        extends UpdateStages.WithKind,
            UpdateStages.WithVnetRouteName,
