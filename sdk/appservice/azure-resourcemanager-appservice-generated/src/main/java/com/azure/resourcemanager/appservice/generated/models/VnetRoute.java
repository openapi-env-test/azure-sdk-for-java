...
public class VnetRoute extends ProxyOnlyResource {
    ...
    /**
     * Get the vnetRouteName property: The name of this route. This is only returned by the server and does not need to
    ...
    /**
     * Set the vnetRouteName property: The name of this route. This is only returned by the server and does not need to
     * be set by the client.
     *
    ...
    /** {@inheritDoc} */
    @Override
    public VnetRoute withKind(String kind) {
        super.withKind(kind);
        return this;
    }
