...
public class TriggeredJobRun extends ProxyOnlyResource {
    ...
    /**
     * Get the idPropertiesId property: Job ID.
     *
    ...
    /**
     * Set the idPropertiesId property: Job ID.
     *
     * @param idPropertiesId the idPropertiesId value to set.
     * @return the TriggeredJobRun object itself.
     */
    public TriggeredJobRun withIdPropertiesId(String idPropertiesId) {
        this.idPropertiesId = idPropertiesId;
        return this;
    }

    /**
     * Get the namePropertiesName property: Job name.
     *
