...
public final class BackupSchedule {
     ...
     */
    @JsonProperty(value = "frequencyInterval")
     ...
     */
    @JsonProperty(value = "keepAtLeastOneBackup")
     ...
     */
    @JsonProperty(value = "lastExecutionTime")
    private OffsetDateTime lastExecutionTime;

    /**
     * Get the frequencyInterval property: How often should be the backup executed (e.g. for weekly backup, this should
    ...
    /**
     * Set the frequencyInterval property: How often should be the backup executed (e.g. for weekly backup, this should
     * be set to 7 and FrequencyUnit should be set to Day).
     *
    ...
    /**
     * Get the frequencyUnit property: How often should be the backup executed (e.g. for weekly backup, this should be
     * set to Day and FrequencyInterval should be set to 7).
     *
    ...
    /**
     * Set the frequencyUnit property: How often should be the backup executed (e.g. for weekly backup, this should be
     * set to Day and FrequencyInterval should be set to 7).
     *
    ...
    /**
     * Get the lastExecutionTime property: The last time when this schedule was triggered.
     *
    ...
    /**
     * Set the lastExecutionTime property: The last time when this schedule was triggered.
     *
     * @param lastExecutionTime the lastExecutionTime value to set.
     * @return the BackupSchedule object itself.
     */
    public BackupSchedule withLastExecutionTime(OffsetDateTime lastExecutionTime) {
