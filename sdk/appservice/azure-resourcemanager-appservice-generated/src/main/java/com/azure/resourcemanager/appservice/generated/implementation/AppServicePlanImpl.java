...
public final class AppServicePlanImpl implements AppServicePlan, AppServicePlan.Definition, AppServicePlan.Update {
    ...
    public AppServicePlanImpl withNamePropertiesName(String namePropertiesName) {
        if (isInCreateMode()) {
            this.innerModel().withNamePropertiesName(namePropertiesName);
            return this;
        } else {
            this.updateAppServicePlan.withNamePropertiesName(namePropertiesName);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withAdminSiteName(String adminSiteName) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlan.withAdminSiteName(adminSiteName);
            return this;
        }
    }
