...
public final class DiagnosticsImpl implements Diagnostics {
    ...
    public DiagnosticAnalysis getSiteAnalysis(
    ...
    public Response<DiagnosticAnalysis> getSiteAnalysisWithResponse(
    ...
    public PagedIterable<DetectorDefinition> getSiteDetector(
    ...
    public PagedIterable<DetectorDefinition> getSiteDetector(
        ...
        PagedIterable<DetectorDefinitionInner> inner =
            this
                .serviceClient()
                .getSiteDetector(resourceGroupName, siteName, diagnosticCategory, detectorName, context);
        return inner.mapPage(inner1 -> new DetectorDefinitionImpl(inner1, this.manager()));
    }
    ...
    public DiagnosticAnalysis getSiteAnalysisSlot(
    ...
    public Response<DiagnosticAnalysis> getSiteAnalysisSlotWithResponse(
        String resourceGroupName,
        String siteName,
        String diagnosticCategory,
        String analysisName,
    ...
    public PagedIterable<DetectorDefinition> getSiteDetectorSlot(
    ...
    public PagedIterable<DetectorDefinition> getSiteDetectorSlot(
        ...
        PagedIterable<DetectorDefinitionInner> inner =
            this
                .serviceClient()
                .getSiteDetectorSlot(resourceGroupName, siteName, diagnosticCategory, detectorName, slot, context);
        return inner.mapPage(inner1 -> new DetectorDefinitionImpl(inner1, this.manager()));
    }
