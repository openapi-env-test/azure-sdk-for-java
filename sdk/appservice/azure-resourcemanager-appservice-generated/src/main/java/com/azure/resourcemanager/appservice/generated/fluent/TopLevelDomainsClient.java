...
public interface TopLevelDomainsClient {
    ...
    TopLevelDomainInner getTopLevelDomain(String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TopLevelDomainInner> getTopLevelDomainWithResponse(String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TldLegalAgreementInner> listTopLevelDomainAgreements(
