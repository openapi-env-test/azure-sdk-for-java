...
@Fluent
public final class StringDictionaryInner extends Resource {
     ...
     * @return the StringDictionaryInner object itself.
     */
    public StringDictionaryInner withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the StringDictionaryInner object itself.
     */
    public StringDictionaryInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the StringDictionaryInner object itself.
     */
    public StringDictionaryInner withType(String type) {
        this.type = type;
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public StringDictionaryInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public StringDictionaryInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
