...
public final class DomainsImpl implements Domains {
    ...
    public DomainAvailablilityCheckResult checkAvailability(NameIdentifierInner identifier) {
        DomainAvailablilityCheckResultInner inner = this.serviceClient().checkAvailability(identifier);
        if (inner != null) {
    ...
    public Response<DomainAvailablilityCheckResult> checkAvailabilityWithResponse(
