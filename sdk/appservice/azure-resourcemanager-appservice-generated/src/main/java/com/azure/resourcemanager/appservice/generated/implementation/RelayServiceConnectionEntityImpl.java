...
public final class RelayServiceConnectionEntityImpl
    ...
    public RelayServiceConnectionEntity create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSites()
                .createOrUpdateSiteRelayServiceConnectionWithResponse(
    ...
    public RelayServiceConnectionEntity apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSites()
                .updateSiteRelayServiceConnectionWithResponse(
                    resourceGroupName, name, entityName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public RelayServiceConnectionEntityImpl withRegion(Region location) {
        this.innerModel().withLocation(location.toString());
        return this;
    }

    public RelayServiceConnectionEntityImpl withRegion(String location) {
        this.innerModel().withLocation(location);
        return this;
    }

    public RelayServiceConnectionEntityImpl withTags(Map<String, String> tags) {
    ...
    public RelayServiceConnectionEntityImpl withName(String name) {
        this.innerModel().withName(name);
        return this;
    }

    public RelayServiceConnectionEntityImpl withType(String type) {
