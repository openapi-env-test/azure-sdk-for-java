...
public final class AppServiceCertificateOrderImpl
    ...
    public void resendRequestEmails(NameIdentifier nameIdentifier) {
        serviceManager
            .appServiceCertificateOrders()
            .resendRequestEmails(resourceGroupName, certificateOrderName, nameIdentifier);
    }

    public Response<Void> resendRequestEmailsWithResponse(NameIdentifier nameIdentifier, Context context) {
        return serviceManager
            .appServiceCertificateOrders()
