...
public final class TopLevelDomainsImpl implements TopLevelDomains {
    ...
    public TopLevelDomain getTopLevelDomain(String name) {
        TopLevelDomainInner inner = this.serviceClient().getTopLevelDomain(name);
        if (inner != null) {
    ...
    public Response<TopLevelDomain> getTopLevelDomainWithResponse(String name, Context context) {
        Response<TopLevelDomainInner> inner = this.serviceClient().getTopLevelDomainWithResponse(name, context);
        if (inner != null) {
    ...
    public PagedIterable<TldLegalAgreement> listTopLevelDomainAgreements(
        String name, TopLevelDomainAgreementOption agreementOption) {
        PagedIterable<TldLegalAgreementInner> inner =
            this.serviceClient().listTopLevelDomainAgreements(name, agreementOption);
    ...
    public PagedIterable<TldLegalAgreement> listTopLevelDomainAgreements(
        ...
        PagedIterable<TldLegalAgreementInner> inner =
            this.serviceClient().listTopLevelDomainAgreements(name, agreementOption, context);
        return inner.mapPage(inner1 -> new TldLegalAgreementImpl(inner1, this.manager()));
    }
