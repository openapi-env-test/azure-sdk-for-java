...
public final class CertificatesImpl implements Certificates {
    ...
    public Object getCsrs(String resourceGroupName) {
        return this.serviceClient().getCsrs(resourceGroupName);
    }

    public Response<Object> getCsrsWithResponse(String resourceGroupName, Context context) {
        return this.serviceClient().getCsrsWithResponse(resourceGroupName, context);
    }

    public Csr getCsr(String resourceGroupName, String name) {
        CsrInner inner = this.serviceClient().getCsr(resourceGroupName, name);
        if (inner != null) {
            return new CsrImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<Csr> getCsrWithResponse(String resourceGroupName, String name, Context context) {
        Response<CsrInner> inner = this.serviceClient().getCsrWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CsrImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public Object deleteCsr(String resourceGroupName, String name) {
        return this.serviceClient().deleteCsr(resourceGroupName, name);
    }

    public Response<Object> deleteCsrWithResponse(String resourceGroupName, String name, Context context) {
        return this.serviceClient().deleteCsrWithResponse(resourceGroupName, name, context);
    }
    ...
    public Csr getCsrById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        String name = Utils.getValueFromIdByName(id, "csrs");
        if (name == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String.format("The resource ID '%s' is not valid. Missing path segment 'csrs'.", id)));
        }
        return this.getCsrWithResponse(resourceGroupName, name, Context.NONE).getValue();
    }

    public Response<Csr> getCsrByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.getCsrWithResponse(resourceGroupName, name, context);
    }
    ...
    public Object deleteCsrById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.deleteCsrWithResponse(resourceGroupName, name, Context.NONE).getValue();
    }

    public Response<Object> deleteCsrByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.deleteCsrWithResponse(resourceGroupName, name, context);
    }
    ...
    public CertificateImpl defineCertificate(String name) {
        return new CertificateImpl(name, this.manager());
    }

    public CsrImpl defineCsr(String name) {
        return new CsrImpl(name, this.manager());
    }
}
