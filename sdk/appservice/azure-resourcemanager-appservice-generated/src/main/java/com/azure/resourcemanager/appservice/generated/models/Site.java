...
public interface Site {
    ...
    /**
     * Gets the snapshotInfo property: If specified during app creation, the app is created from a previous snapshot.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithSnapshotInfo,
        ...
        /** The stage of the Site definition allowing to specify snapshotInfo. */
        interface WithSnapshotInfo {
            /**
             * Specifies the snapshotInfo property: If specified during app creation, the app is created from a previous
             * snapshot..
             *
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void recover(SnapshotRecoveryRequest recoveryEntity);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void recover(SnapshotRecoveryRequest recoveryEntity, Context context);
