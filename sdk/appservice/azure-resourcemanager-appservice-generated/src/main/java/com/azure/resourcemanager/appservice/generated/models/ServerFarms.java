...
/** Resource collection API of ServerFarms. */
public interface ServerFarms {
     ...
     */
    PagedIterable<ServerFarmWithRichSku> listByResourceGroup(String resourceGroupName);
     ...
     * @return collection of App Service Plans in a resource group for a given subscription.
     */
    PagedIterable<ServerFarmWithRichSku> listByResourceGroup(String resourceGroupName, Context context);
     ...
     */
    ServerFarmWithRichSku getByResourceGroup(String resourceGroupName, String name);
     ...
     * @return specified App Service Plan in a resource group.
     */
    Response<ServerFarmWithRichSku> getByResourceGroupWithResponse(
     ...
     */
    PagedIterable<ResourceMetric> getServerFarmMetrics(String resourceGroupName, String name);
     ...
     * @return collection of metric responses.
     */
    PagedIterable<ResourceMetric> getServerFarmMetrics(
     ...
     */
    PagedIterable<MetricDefinition> getServerFarmMetricDefintions(String resourceGroupName, String name);
     ...
     * @return collection of metric definitions.
     */
    PagedIterable<MetricDefinition> getServerFarmMetricDefintions(
        String resourceGroupName, String name, Context context);
     ...
     */
    VnetGateway getServerFarmVnetGateway(String resourceGroupName, String name, String vnetName, String gatewayName);
     ...
     * @return the vnet gateway.
     */
    Response<VnetGateway> getServerFarmVnetGatewayWithResponse(
     ...
     */
    VnetGateway updateServerFarmVnetGateway(
     ...
     * @return the VnetGateway contract.
     */
    Response<VnetGateway> updateServerFarmVnetGatewayWithResponse(
        String resourceGroupName,
        String name,
        String vnetName,
        String gatewayName,
     ...
     */
    PagedIterable<Site> getServerFarmSites(String resourceGroupName, String name);
     ...
     * @return list of Apps associated with an App Service Plan.
     */
    PagedIterable<Site> getServerFarmSites(
     ...
     */
    ServerFarmWithRichSku getServerFarmOperation(String resourceGroupName, String name, String operationId);
     ...
     * @return a server farm operation.
     */
    Response<ServerFarmWithRichSku> getServerFarmOperationWithResponse(
     ...
     * @return specified App Service Plan in a resource group.
     */
    ServerFarmWithRichSku getById(String id);
     ...
     * @return specified App Service Plan in a resource group.
     */
    Response<ServerFarmWithRichSku> getByIdWithResponse(String id, Context context);
     ...
     * @return any object.
     */
    Object deleteVnetRouteById(String id);
     ...
     * @return any object.
     */
    Response<Object> deleteVnetRouteByIdWithResponse(String id, Context context);

    /**
     * Begins definition for a new ServerFarmWithRichSku resource.
     *
     * @param name resource name.
     * @return the first stage of the new ServerFarmWithRichSku definition.
     */
    ServerFarmWithRichSku.DefinitionStages.Blank defineServerFarm(String name);
