...
import com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager;
...
public final class UserAssignedIdentitiesImpl implements UserAssignedIdentities {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(UserAssignedIdentitiesImpl.class);

    private final UserAssignedIdentitiesClient innerClient;

    private final ManagedServiceIdentityManager serviceManager;

    public UserAssignedIdentitiesImpl(
        UserAssignedIdentitiesClient innerClient, ManagedServiceIdentityManager serviceManager) {
    ...
    public PagedIterable<Identity> list() {
        ...
        return inner.mapPage(inner1 -> new IdentityImpl(inner1, this.manager()));
    }
    ...
    private ManagedServiceIdentityManager manager() {
