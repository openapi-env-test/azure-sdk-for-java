...
public final class IdentityImpl implements Identity, Identity.Definition, Identity.Update {
    ...
    IdentityImpl(String name, ManagedServiceIdentityManager serviceManager) {
    ...
    IdentityImpl(IdentityInner innerObject, ManagedServiceIdentityManager serviceManager) {
