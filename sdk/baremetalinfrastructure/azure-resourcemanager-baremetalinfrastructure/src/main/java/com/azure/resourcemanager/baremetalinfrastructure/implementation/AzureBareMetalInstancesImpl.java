...
public final class AzureBareMetalInstancesImpl implements AzureBareMetalInstances {
    ...
    public AzureBareMetalInstancesImpl(
        AzureBareMetalInstancesClient innerClient, BareMetalInfrastructureManager serviceManager) {
    ...
    public PagedIterable<AzureBareMetalInstance> list() {
        ...
        return inner.mapPage(inner1 -> new AzureBareMetalInstanceImpl(inner1, this.manager()));
    }
