...
public final class DefenderForDatabasesGcpOfferingArcAutoProvisioningConfiguration {
     ...
     */
    public DefenderForDatabasesGcpOfferingArcAutoProvisioningConfiguration withClientId(String clientId) {
     ...
     * @return the DefenderForDatabasesGcpOfferingArcAutoProvisioningConfiguration object itself.
     */
    public DefenderForDatabasesGcpOfferingArcAutoProvisioningConfiguration withAgentOnboardingServiceAccountNumericId(
