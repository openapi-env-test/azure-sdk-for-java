...
public interface Event {
    ...
    /**
     * Gets the duration property: The expected duration of the event in seconds.
     *
    ...
    /**
     * Gets the impactType property: The event's impact type.
     *
    ...
    /**
     * Gets the additionalInformation property: Contains additional information regarding the event.
     *
