...
public final class MongoUserDefinitionGetResultsImpl
    ...
    public MongoUserDefinitionGetResultsImpl withDisplayName(String displayName) {
        if (isInCreateMode()) {
            this.createCreateUpdateMongoUserDefinitionParameters.withDisplayName(displayName);
            return this;
        } else {
            this.updateCreateUpdateMongoUserDefinitionParameters.withDisplayName(displayName);
            return this;
        }
    }
