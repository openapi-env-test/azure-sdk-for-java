...
public final class MongoRoleDefinitionCreateUpdateParameters {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(MongoRoleDefinitionCreateUpdateParameters.class);

    /*
     * Properties to create and update an Azure Cosmos DB Mongo Role
     * Definition.
     */
