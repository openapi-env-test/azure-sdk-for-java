...
public final class SqlContainerGetResultsImpl
    ...
    SqlContainerGetResultsImpl(String name, CosmosDBManager serviceManager) {
    ...
    SqlContainerGetResultsImpl(SqlContainerGetResultsInner innerObject, CosmosDBManager serviceManager) {
