...
public final class SqlDatabaseGetResultsImpl
    ...
    SqlDatabaseGetResultsImpl(String name, CosmosDBManager serviceManager) {
    ...
    SqlDatabaseGetResultsImpl(SqlDatabaseGetResultsInner innerObject, CosmosDBManager serviceManager) {
