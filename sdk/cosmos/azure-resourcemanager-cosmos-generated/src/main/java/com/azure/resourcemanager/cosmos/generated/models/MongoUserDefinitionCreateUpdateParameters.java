...
public final class MongoUserDefinitionCreateUpdateParameters {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(MongoUserDefinitionCreateUpdateParameters.class);
    ...
    /**
     * Get the displayName property: The display name for User Definition.
     *
    ...
    /**
     * Set the displayName property: The display name for User Definition.
     *
     * @param displayName the displayName value to set.
     * @return the MongoUserDefinitionCreateUpdateParameters object itself.
     */
    public MongoUserDefinitionCreateUpdateParameters withDisplayName(String displayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MongoUserDefinitionResource();
        }
