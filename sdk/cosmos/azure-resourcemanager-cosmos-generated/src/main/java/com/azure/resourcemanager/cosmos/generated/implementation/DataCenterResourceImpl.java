...
public final class DataCenterResourceImpl
    ...
    DataCenterResourceImpl(String name, CosmosDBManager serviceManager) {
    ...
    DataCenterResourceImpl(DataCenterResourceInner innerObject, CosmosDBManager serviceManager) {
