...
public final class GremlinGraphGetResultsImpl
    ...
    GremlinGraphGetResultsImpl(String name, CosmosDBManager serviceManager) {
    ...
    GremlinGraphGetResultsImpl(GremlinGraphGetResultsInner innerObject, CosmosDBManager serviceManager) {
