...
public final class RestorableSqlContainersClientImpl implements RestorableSqlContainersClient {
    ...
    private Mono<PagedResponse<RestorableSqlContainerGetResultInner>> listSinglePageAsync(
        String location, String instanceId, String restorableSqlDatabaseRid) {
    ...
    private PagedFlux<RestorableSqlContainerGetResultInner> listAsync(
        String location, String instanceId, String restorableSqlDatabaseRid) {
        return new PagedFlux<>(() -> listSinglePageAsync(location, instanceId, restorableSqlDatabaseRid));
    }
    ...
    private PagedFlux<RestorableSqlContainerGetResultInner> listAsync(
        String location, String instanceId, String restorableSqlDatabaseRid, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(location, instanceId, restorableSqlDatabaseRid, context));
    }
    ...
    public PagedIterable<RestorableSqlContainerGetResultInner> list(String location, String instanceId) {
        final String restorableSqlDatabaseRid = null;
        return new PagedIterable<>(listAsync(location, instanceId, restorableSqlDatabaseRid));
    }
    ...
    public PagedIterable<RestorableSqlContainerGetResultInner> list(
        String location, String instanceId, String restorableSqlDatabaseRid, Context context) {
        return new PagedIterable<>(listAsync(location, instanceId, restorableSqlDatabaseRid, context));
    }
}
