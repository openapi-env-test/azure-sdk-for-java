...
public final class CassandraDataCentersImpl implements CassandraDataCenters {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(CassandraDataCentersImpl.class);

    private final CassandraDataCentersClient innerClient;

    private final CosmosDBManager serviceManager;

    public CassandraDataCentersImpl(CassandraDataCentersClient innerClient, CosmosDBManager serviceManager) {
