...
public final class NotebookWorkspaceImpl
    ...
    NotebookWorkspaceImpl(NotebookWorkspaceName name, CosmosDBManager serviceManager) {
    ...
    NotebookWorkspaceImpl(NotebookWorkspaceInner innerObject, CosmosDBManager serviceManager) {
