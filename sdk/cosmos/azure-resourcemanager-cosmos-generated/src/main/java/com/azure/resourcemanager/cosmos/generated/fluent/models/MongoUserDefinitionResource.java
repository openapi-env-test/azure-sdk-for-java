...
public final class MongoUserDefinitionResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(MongoUserDefinitionResource.class);
     ...
     * @return the MongoUserDefinitionResource object itself.
     */
    public MongoUserDefinitionResource withDisplayName(String displayName) {
