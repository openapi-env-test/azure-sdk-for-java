...
public class NotebookWorkspacesInner implements InnerSupportsDelete<Void> {
    ...
    public Observable<ServiceResponse<NotebookWorkspaceInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String accountName) {
        ...
        final String notebookWorkspaceName = "default";
        Observable<Response<ResponseBody>> observable = service.createOrUpdate(this.client.subscriptionId(), resourceGroupName, accountName, notebookWorkspaceName, this.client.apiVersion(), this.client.acceptLanguage(), notebookCreateUpdateParameters, this.client.userAgent());
    ...
    public Observable<ServiceResponse<Void>> deleteWithServiceResponseAsync(String resourceGroupName, String accountName) {
        ...
        final String notebookWorkspaceName = "default";
        Observable<Response<ResponseBody>> observable = service.delete(this.client.subscriptionId(), resourceGroupName, accountName, notebookWorkspaceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<Void>> regenerateAuthTokenWithServiceResponseAsync(String resourceGroupName, String accountName) {
        ...
        final String notebookWorkspaceName = "default";
        Observable<Response<ResponseBody>> observable = service.regenerateAuthToken(this.client.subscriptionId(), resourceGroupName, accountName, notebookWorkspaceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
        return client.getAzureClient().getPostOrDeleteResultAsync(observable, new TypeToken<Void>() { }.getType());
    }
    ...
    public Observable<ServiceResponse<Void>> startWithServiceResponseAsync(String resourceGroupName, String accountName) {
        ...
        final String notebookWorkspaceName = "default";
        Observable<Response<ResponseBody>> observable = service.start(this.client.subscriptionId(), resourceGroupName, accountName, notebookWorkspaceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
        return client.getAzureClient().getPostOrDeleteResultAsync(observable, new TypeToken<Void>() { }.getType());
    }
    ...
    public Observable<ServiceResponse<Void>> beginStartWithServiceResponseAsync(String resourceGroupName, String accountName) {
        ...
        final String notebookWorkspaceName = "default";
        return service.beginStart(this.client.subscriptionId(), resourceGroupName, accountName, notebookWorkspaceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Void>>>() {
                @Override
                public Observable<ServiceResponse<Void>> call(Response<ResponseBody> response) {
                    try {
