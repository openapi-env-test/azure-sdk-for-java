...
public final class CollectionsImpl {
     ...
     */
    CollectionsImpl(PurviewCatalogServiceRestApiDocumentClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewCatalogServiceRestApiDocumentCollections to be used by the
