...
public final class ScanRulesetsListAllTests extends PurviewMetadataPolicyClientTestBase {
    @Test
    @Disabled
    public void testScanRulesetsListAllTests() {
        ...
        Assertions.assertEquals(
                BinaryData.fromString("{\"name\":\"ScanRuleset1\",\"kind\":\"AzureStorage\"}").toObject(Object.class),
