...
public final class FiltersCreateOrUpdateTests extends PurviewMetadataPolicyClientTestBase {
    @Test
    @Disabled
    public void testFiltersCreateOrUpdateTests() {
        ...
        Assertions.assertEquals(
                BinaryData.fromString(
                                "{\"name\":\"custom\",\"id\":\"datasources/myDataSource/scans/Scan1/filters/custom\",\"properties\":{\"excludeUriPrefixes\":[\"https://foo.file.core.windows.net/share1/user/temp\"],\"includeUriPrefixes\":[\"https://foo.file.core.windows.net/share1/user\",\"https://foo.file.core.windows.net/share1/aggregated\"]}}")
