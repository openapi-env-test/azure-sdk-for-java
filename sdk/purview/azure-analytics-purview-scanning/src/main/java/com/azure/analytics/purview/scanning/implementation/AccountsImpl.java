...
public final class AccountsImpl {
     ...
     */
    AccountsImpl(PurviewScanningClientImpl client) {
        this.service = RestProxy.create(AccountsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewScanningClientAccounts to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public Mono<Response<BinaryData>> getAccountPropertiesWithResponseAsync(RequestOptions requestOptions) {
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
                        service.getAccountProperties(
                                this.client.getEndpoint(), apiVersion, accept, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> getAccountPropertiesWithResponseAsync(
        ...
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return service.getAccountProperties(this.client.getEndpoint(), apiVersion, accept, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> updateAccountPropertiesWithResponseAsync(
        ...
        return service.updateAccountProperties(
                this.client.getEndpoint(), apiVersion, accountUpdateParameters, accept, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> getAccessKeysWithResponseAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.getAccessKeys(this.client.getEndpoint(), apiVersion, accept, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> getAccessKeysWithResponseAsync(RequestOptions requestOptions, Context context) {
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return service.getAccessKeys(this.client.getEndpoint(), apiVersion, accept, requestOptions, context);
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.regenerateAccessKey(
                                this.client.getEndpoint(), apiVersion, keyOptions, accept, requestOptions, context));
    }
