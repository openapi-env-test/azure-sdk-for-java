...
public final class ScanRulesetsImpl {
     ...
     */
    ScanRulesetsImpl(PurviewMetadataPolicyClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataPolicyClientScanRulesets to be used by the proxy
