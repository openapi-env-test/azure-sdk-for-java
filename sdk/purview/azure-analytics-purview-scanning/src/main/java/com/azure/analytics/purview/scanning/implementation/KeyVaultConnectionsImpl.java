...
public final class KeyVaultConnectionsImpl {
     ...
     */
    KeyVaultConnectionsImpl(PurviewMetadataPolicyClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewMetadataPolicyClientKeyVaultConnections to be used by the
