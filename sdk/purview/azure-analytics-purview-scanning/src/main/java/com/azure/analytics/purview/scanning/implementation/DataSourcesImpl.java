...
public final class DataSourcesImpl {
     ...
     */
    DataSourcesImpl(PurviewMetadataPolicyClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataPolicyClientDataSources to be used by the proxy
