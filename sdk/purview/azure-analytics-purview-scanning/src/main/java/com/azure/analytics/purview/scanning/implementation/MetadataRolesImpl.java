...
public final class MetadataRolesImpl {
     ...
     */
    MetadataRolesImpl(PurviewScanningClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewScanningClientMetadataRoles to be used by the proxy service to
     * perform REST calls.
     */
    ...
    public Mono<PagedResponse<BinaryData>> listSinglePageAsync(RequestOptions requestOptions, Context context) {
        final String apiVersion = "2021-07-01-preview";
        final String accept = "application/json";
        return service.list(this.client.getEndpoint(), apiVersion, accept, requestOptions, context)
                .map(
                        res ->
                                new PagedResponseBase<>(
                                        res.getRequest(),
