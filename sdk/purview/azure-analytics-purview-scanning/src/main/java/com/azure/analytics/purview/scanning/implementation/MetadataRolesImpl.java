...
public final class MetadataRolesImpl {
     ...
     */
    MetadataRolesImpl(PurviewMetadataPolicyClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataPolicyClientMetadataRoles to be used by the proxy
