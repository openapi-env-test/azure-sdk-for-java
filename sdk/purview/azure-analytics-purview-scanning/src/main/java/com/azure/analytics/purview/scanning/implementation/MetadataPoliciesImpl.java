...
public final class MetadataPoliciesImpl {
     ...
     */
    MetadataPoliciesImpl(PurviewMetadataPolicyClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewMetadataPolicyClientMetadataPolicies to be used by the proxy
