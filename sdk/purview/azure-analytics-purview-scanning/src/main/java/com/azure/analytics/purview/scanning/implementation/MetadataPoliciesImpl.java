...
public final class MetadataPoliciesImpl {
     ...
     */
    MetadataPoliciesImpl(PurviewScanningClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewScanningClientMetadataPolicies to be used by the proxy service
    ...
    public Mono<PagedResponse<BinaryData>> listAllSinglePageAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                        context ->
                                service.listAll(this.client.getEndpoint(), apiVersion, accept, requestOptions, context))
                .map(
                        res ->
    ...
    public Mono<PagedResponse<BinaryData>> listAllSinglePageAsync(RequestOptions requestOptions, Context context) {
        final String apiVersion = "2021-07-01-preview";
        final String accept = "application/json";
        return service.listAll(this.client.getEndpoint(), apiVersion, accept, requestOptions, context)
                .map(
                        res ->
                                new PagedResponseBase<>(
                                        res.getRequest(),
    ...
    public Mono<Response<BinaryData>> updateWithResponseAsync(String policyId, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.update(
                                this.client.getEndpoint(), policyId, apiVersion, accept, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> updateWithResponseAsync(
        ...
        final String apiVersion = "2021-07-01-preview";
        final String accept = "application/json";
        return service.update(this.client.getEndpoint(), policyId, apiVersion, accept, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String policyId, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.get(this.client.getEndpoint(), policyId, apiVersion, accept, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(
        ...
        final String apiVersion = "2021-07-01-preview";
        final String accept = "application/json";
        return service.get(this.client.getEndpoint(), policyId, apiVersion, accept, requestOptions, context);
    }
