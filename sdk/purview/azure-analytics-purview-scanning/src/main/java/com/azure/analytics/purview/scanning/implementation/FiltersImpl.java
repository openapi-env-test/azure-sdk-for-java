...
public final class FiltersImpl {
     ...
     */
    FiltersImpl(PurviewMetadataPolicyClientImpl client) {
        this.service = RestProxy.create(FiltersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewMetadataPolicyClientFilters to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{Endpoint}")
