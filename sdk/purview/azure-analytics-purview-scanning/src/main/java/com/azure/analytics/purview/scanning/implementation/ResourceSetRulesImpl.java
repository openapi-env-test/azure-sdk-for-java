...
public final class ResourceSetRulesImpl {
     ...
     */
    ResourceSetRulesImpl(PurviewScanningClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewScanningClientResourceSetRules to be used by the proxy service
    ...
    public Mono<Response<BinaryData>> getResourceSetRuleWithResponseAsync(
        ...
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return service.getResourceSetRule(this.client.getEndpoint(), apiVersion, accept, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> createOrUpdateResourceSetRuleWithResponseAsync(
        ...
        return service.createOrUpdateResourceSetRule(
                this.client.getEndpoint(), apiVersion, resourceSetRuleConfig, accept, requestOptions, context);
    }
    ...
    public Mono<Response<Void>> deleteResourceSetRuleWithResponseAsync(RequestOptions requestOptions, Context context) {
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return service.deleteResourceSetRule(this.client.getEndpoint(), apiVersion, accept, requestOptions, context);
    }
    ...
    public Mono<PagedResponse<BinaryData>> listResourceSetRulesSinglePageAsync(
        ...
        final String apiVersion = "2019-11-01-preview";
        final String accept = "application/json";
        return service.listResourceSetRules(this.client.getEndpoint(), apiVersion, accept, requestOptions, context)
                .map(
                        res ->
                                new PagedResponseBase<>(
                                        res.getRequest(),
