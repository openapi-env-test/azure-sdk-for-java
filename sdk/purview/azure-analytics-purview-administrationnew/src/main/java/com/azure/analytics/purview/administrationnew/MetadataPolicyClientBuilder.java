...
import com.azure.analytics.purview.administrationnew.implementation.PurviewMetadataPoliciesServiceRestApiDocumentClientImpl;
...
public final class MetadataPolicyClientBuilder {
    ...
    private final Map<String, String> properties =
            CoreUtils.getProperties("azure-analytics-purview-administrationnew.properties");
     ...
     * Service version
     */
    @Generated private PurviewMetadataPoliciesServiceRestApiDocumentServiceVersion serviceVersion;
     ...
     */
    @Generated
    public MetadataPolicyClientBuilder serviceVersion(
    ...
    /**
     * Builds an instance of PurviewMetadataPoliciesServiceRestApiDocumentClientImpl with the provided parameters.
     *
     * @return an instance of PurviewMetadataPoliciesServiceRestApiDocumentClientImpl.
     */
    @Generated
    private PurviewMetadataPoliciesServiceRestApiDocumentClientImpl buildInnerClient() {
        if (serviceVersion == null) {
            this.serviceVersion = PurviewMetadataPoliciesServiceRestApiDocumentServiceVersion.getLatest();
        }
        if (pipeline == null) {
            this.pipeline = createHttpPipeline();
        }
        PurviewMetadataPoliciesServiceRestApiDocumentClientImpl client =
                new PurviewMetadataPoliciesServiceRestApiDocumentClientImpl(
