...
public final class MetadataRolesImpl {
     ...
     */
    MetadataRolesImpl(PurviewMetadataPoliciesServiceRestApiDocumentClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataPoliciesServiceRestApiDocumentMetadataRoles to be used
