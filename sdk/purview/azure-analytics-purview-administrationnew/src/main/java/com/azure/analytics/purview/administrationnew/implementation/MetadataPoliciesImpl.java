...
public final class MetadataPoliciesImpl {
    ...
    private final PurviewMetadataPoliciesServiceRestApiDocumentClientImpl client;
     ...
     */
    MetadataPoliciesImpl(PurviewMetadataPoliciesServiceRestApiDocumentClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewMetadataPoliciesServiceRestApiDocumentMetadataPolicies to be
