...
import com.azure.purview.purviewcatalog.implementation.PurviewCatalogServiceRestApiDocumentClientImpl;
...
public final class RelationshipClientBuilder {
    ...
    @Generated
    private final Map<String, String> properties = CoreUtils.getProperties("azure-purview-purviewcatalog.properties");
     ...
     */
    @Generated
    public RelationshipClientBuilder serviceVersion(PurviewCatalogServiceRestApiDocumentServiceVersion serviceVersion) {
