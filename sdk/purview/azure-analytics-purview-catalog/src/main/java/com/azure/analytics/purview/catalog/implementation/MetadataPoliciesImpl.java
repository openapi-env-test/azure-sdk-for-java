...
public final class MetadataPoliciesImpl {
     ...
     */
    MetadataPoliciesImpl(PurviewCatalogClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewCatalogClientMetadataPolicies to be used by the proxy service
