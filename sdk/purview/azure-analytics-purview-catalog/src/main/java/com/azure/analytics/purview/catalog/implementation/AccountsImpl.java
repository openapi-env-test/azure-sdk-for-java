...
public final class AccountsImpl {
     ...
     */
    AccountsImpl(PurviewCatalogClientImpl client) {
        this.service = RestProxy.create(AccountsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewCatalogClientAccounts to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
