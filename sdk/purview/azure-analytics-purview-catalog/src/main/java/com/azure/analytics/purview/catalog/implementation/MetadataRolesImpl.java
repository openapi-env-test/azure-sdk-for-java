...
public final class MetadataRolesImpl {
     ...
     */
    MetadataRolesImpl(PurviewCatalogClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewCatalogClientMetadataRoles to be used by the proxy service to
     * perform REST calls.
     */
