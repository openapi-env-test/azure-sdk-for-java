...
public final class ResourceSetRulesImpl {
     ...
     */
    ResourceSetRulesImpl(PurviewCatalogClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for PurviewCatalogClientResourceSetRules to be used by the proxy service
