...
import com.azure.resourcemanager.customerlockbox.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CustomerLockboxImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for CustomerLockboxOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CustomerLockboxOpera")
     ...
     * @return result of the request to list Customer Lockbox operations.
     */
