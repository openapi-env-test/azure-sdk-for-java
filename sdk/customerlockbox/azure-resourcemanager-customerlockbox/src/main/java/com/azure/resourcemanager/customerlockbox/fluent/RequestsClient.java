...
public interface RequestsClient {
    ...
    LockboxRequestResponseInner get(String requestId, String subscriptionId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LockboxRequestResponseInner> getWithResponse(String requestId, String subscriptionId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ApprovalInner updateStatus(String subscriptionId, String requestId, ApprovalInner approval);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApprovalInner> updateStatusWithResponse(
    ...
    PagedIterable<LockboxRequestResponseInner> list(String subscriptionId);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LockboxRequestResponseInner> list(String subscriptionId, String filter, Context context);
}
