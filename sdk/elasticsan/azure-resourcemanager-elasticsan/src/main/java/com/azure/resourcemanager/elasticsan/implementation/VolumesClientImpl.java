...
public final class VolumesClientImpl implements VolumesClient {
    ...
    private interface VolumesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(
            ...
            @PathParam("volumeGroupName") String volumeGroupName,
            @PathParam("volumeName") String volumeName,
            @HeaderParam("x-ms-delete-snapshots") Boolean forceDeleteSnapshots,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @param volumeGroupName The name of the VolumeGroup.
     * @param volumeName The name of the Volume.
     * @param forceDeleteSnapshots Required if the Volume has associated snapshots.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(
                resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(
                resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        String volumeName,
        Boolean forceDeleteSnapshots) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        ...
        final Boolean forceDeleteSnapshots = null;
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(
        ...
        String volumeName,
        Boolean forceDeleteSnapshots) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots).block();
    }
    ...
    public void delete(
        ...
        Boolean forceDeleteSnapshots,
        Context context) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, volumeName, forceDeleteSnapshots, context)
            .block();
    }
