...
public final class ElasticSanInner extends Resource {
     ...
     * @return the ElasticSanInner object itself.
     */
    public ElasticSanInner withBaseSizeTB(Long baseSizeTB) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ElasticSanProperties();
        }
     ...
     * @return the ElasticSanInner object itself.
     */
    public ElasticSanInner withExtendedSizeTB(Long extendedSizeTB) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ElasticSanProperties();
        }
    ...
    public Long totalSizeTB() {
        return this.innerProperties() == null ? null : this.innerProperties().totalSizeTB();
    }
