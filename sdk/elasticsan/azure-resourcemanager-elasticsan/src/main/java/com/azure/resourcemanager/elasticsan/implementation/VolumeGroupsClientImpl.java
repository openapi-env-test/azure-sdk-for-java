...
public final class VolumeGroupsClientImpl implements VolumeGroupsClient {
    ...
    private interface VolumeGroupsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(
            ...
            @PathParam("elasticSanName") String elasticSanName,
            @PathParam("volumeGroupName") String volumeGroupName,
            @HeaderParam("x-ms-delete-volumes-snapshots") Boolean forceDeleteVolumesAndSnapshots,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
                ...
                context ->
                    service
                        .delete(
                            ...
                            elasticSanName,
                            volumeGroupName,
                            forceDeleteVolumesAndSnapshots,
                            this.client.getApiVersion(),
                            accept,
                            context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        Boolean forceDeleteVolumesAndSnapshots) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(
                resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        String volumeGroupName,
        Boolean forceDeleteVolumesAndSnapshots) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        final Boolean forceDeleteVolumesAndSnapshots = null;
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(
        ...
        String volumeGroupName,
        Boolean forceDeleteVolumesAndSnapshots) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots).block();
    }
    ...
    public void delete(
        ...
        Boolean forceDeleteVolumesAndSnapshots,
        Context context) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots, context)
            .block();
    }
