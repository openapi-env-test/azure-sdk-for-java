...
public final class VolumeGroupsImpl implements VolumeGroups {
    ...
    public void delete(
        ...
        this.serviceClient().delete(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots);
    }
    ...
    public void delete(
        ...
        this
            .serviceClient()
            .delete(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots, context);
    }
    ...
    public void deleteById(String id) {
        ...
        Boolean localForceDeleteVolumesAndSnapshots = null;
        this
            .delete(
                resourceGroupName, elasticSanName, volumeGroupName, localForceDeleteVolumesAndSnapshots, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean forceDeleteVolumesAndSnapshots, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        this.delete(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumesAndSnapshots, context);
    }
