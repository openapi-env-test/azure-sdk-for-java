...
public final class ElasticSanImpl implements ElasticSan, ElasticSan.Definition, ElasticSan.Update {
    ...
    public long baseSizeTB() {
        return this.innerModel().baseSizeTB();
    }

    public long extendedSizeTB() {
        return this.innerModel().extendedSizeTB();
    }

    public Long totalSizeTB() {
        return this.innerModel().totalSizeTB();
    }
    ...
    public ElasticSanImpl withBaseSizeTB(long baseSizeTB) {
        this.innerModel().withBaseSizeTB(baseSizeTB);
        return this;
    }

    public ElasticSanImpl withExtendedSizeTB(long extendedSizeTB) {
        this.innerModel().withExtendedSizeTB(extendedSizeTB);
        return this;
    }
