...
public interface ContainerGroups {
     ...
     * group including containers, image registry credentials, restart policy, IP address type, OS type, state, volumes
     * and priority.
     *
     ...
     * type, state, volumes and priority.
     *
     ...
     * restart policy, IP address type, OS type, state, volumes and priority.
     *
     * @param resourceGroupName The name of the resource group.
