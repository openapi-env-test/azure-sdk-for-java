...
public class AppsInner {
    ...
    interface AppsService {
        ...
        Observable<Response<ResponseBody>> createOrUpdate(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("serviceName") String serviceName, @Path("appName") String appName, @Body AppResourceInner appResource, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> update(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("serviceName") String serviceName, @Path("appName") String appName, @Body AppResourceInner appResource, @Header("x-ms-identity-url") String xMsIdentityUrl, @Header("x-ms-identity-principal-id") String xMsIdentityPrincipalId, @Header("x-ms-home-tenant-id") String xMsHomeTenantId, @Header("x-ms-client-tenant-id") String xMsClientTenantId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    public Observable<ServiceResponse<AppResourceInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource) {
        ...
        Observable<Response<ResponseBody>> observable = service.createOrUpdate(this.client.subscriptionId(), resourceGroupName, serviceName, appName, appResource, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<AppResourceInner>> beginCreateOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource) {
        ...
        Validator.validate(appResource);
        return service.beginCreateOrUpdate(this.client.subscriptionId(), resourceGroupName, serviceName, appName, appResource, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<AppResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<AppResourceInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<AppResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource) {
        ...
        Validator.validate(appResource);
        final String xMsIdentityUrl = null;
        final String xMsIdentityPrincipalId = null;
        final String xMsHomeTenantId = null;
        final String xMsClientTenantId = null;
        Observable<Response<ResponseBody>> observable = service.update(this.client.subscriptionId(), resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
        return client.getAzureClient().getPutOrPatchResultAsync(observable, new TypeToken<AppResourceInner>() { }.getType());
    }
    /**
     * Operation to update an exiting App.
     ...
     * @return the AppResourceInner object if successful.
     */
    public AppResourceInner update(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        return updateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<AppResourceInner> updateAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId, final ServiceCallback<AppResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId), serviceCallback);
    }
     ...
     * @return the observable for the request
     */
    public Observable<AppResourceInner> updateAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        return updateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId).map(new Func1<ServiceResponse<AppResourceInner>, AppResourceInner>() {
            @Override
            public AppResourceInner call(ServiceResponse<AppResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<AppResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
    ...
    public Observable<ServiceResponse<AppResourceInner>> beginUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource) {
        ...
        final String xMsHomeTenantId = null;
        final String xMsClientTenantId = null;
        return service.beginUpdate(this.client.subscriptionId(), resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<AppResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<AppResourceInner>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the AppResourceInner object if successful.
     */
    public AppResourceInner beginUpdate(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        return beginUpdateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<AppResourceInner> beginUpdateAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId, final ServiceCallback<AppResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(beginUpdateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId), serviceCallback);
    }
     ...
     * @return the observable to the AppResourceInner object
     */
    public Observable<AppResourceInner> beginUpdateAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        return beginUpdateWithServiceResponseAsync(resourceGroupName, serviceName, appName, appResource, xMsIdentityUrl, xMsIdentityPrincipalId, xMsHomeTenantId, xMsClientTenantId).map(new Func1<ServiceResponse<AppResourceInner>, AppResourceInner>() {
            @Override
            public AppResourceInner call(ServiceResponse<AppResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the AppResourceInner object
     */
    public Observable<ServiceResponse<AppResourceInner>> beginUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String appName, AppResourceInner appResource, String xMsIdentityUrl, String xMsIdentityPrincipalId, String xMsHomeTenantId, String xMsClientTenantId) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
