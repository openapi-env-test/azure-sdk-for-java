...
public interface Certificates extends SupportsCreating<CertificateResource.DefinitionStages.Blank>, HasInner<CertificatesInner> {
     ...
     * @return the observable for the request
     */
    Observable<CertificateResource> deleteAsync(String resourceGroupName, String serviceName, String certificateName);
     ...
     * @return the observable for the request
     */
    Observable<CertificateResourceCollection> listAsync(String resourceGroupName, String serviceName, String certificateName);
