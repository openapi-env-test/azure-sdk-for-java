...
public interface CustomDomainResource extends HasInner<CustomDomainResourceInner>, Indexable, Refreshable<CustomDomainResource>, Updatable<CustomDomainResource.Update>, HasManager<AppPlatformManager> {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the customdomainresource definition allowing to specify Location.
         */
         ...
         */
        interface WithCreate extends Creatable<CustomDomainResource>, DefinitionStages.WithLocation, DefinitionStages.WithProperties {
        }
    }
    /**
     * The template for a CustomDomainResource update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<CustomDomainResource>, UpdateStages.WithLocation, UpdateStages.WithProperties {
    }
    ...
    interface UpdateStages {
        /**
         * The stage of the customdomainresource update allowing to specify Location.
         */
        interface WithLocation {
            /**
             * Specifies location.
