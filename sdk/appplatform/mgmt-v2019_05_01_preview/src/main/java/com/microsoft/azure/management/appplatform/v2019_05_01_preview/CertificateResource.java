...
public interface CertificateResource extends HasInner<CertificateResourceInner>, Indexable, Updatable<CertificateResource.Update>, HasManager<AppPlatformManager> {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the certificateresource definition allowing to specify Location.
         */
         ...
         */
        interface WithCreate extends Creatable<CertificateResource>, DefinitionStages.WithLocation, DefinitionStages.WithProperties {
        }
    }
    /**
     * The template for a CertificateResource update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<CertificateResource>, UpdateStages.WithLocation, UpdateStages.WithProperties {
    }
    ...
    interface UpdateStages {
        /**
         * The stage of the certificateresource update allowing to specify Location.
         */
        interface WithLocation {
            /**
             * Specifies location.
