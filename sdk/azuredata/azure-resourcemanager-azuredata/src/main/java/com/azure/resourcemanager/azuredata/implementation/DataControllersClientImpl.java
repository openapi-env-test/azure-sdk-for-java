...
import com.azure.resourcemanager.azuredata.models.PageOfDataControllerResource;
...
public final class DataControllersClientImpl implements DataControllersClient {
     ...
     */
    DataControllersClientImpl(AzureDataManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureDataManagementClientDataControllers to be used by the proxy
    ...
    private interface DataControllersService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.AzureData/dataControllers")
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataControllerResourceInner>> putDataController(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataControllerResourceInner>> putDataControllerWithResponseAsync(
    ...
    private Mono<DataControllerResourceInner> putDataControllerAsync(
        String resourceGroupName, String dataControllerName, DataControllerResourceInner dataControllerResource) {
        return putDataControllerWithResponseAsync(resourceGroupName, dataControllerName, dataControllerResource)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataControllerResourceInner> putDataControllerWithResponse(
        String resourceGroupName,
        String dataControllerName,
        DataControllerResourceInner dataControllerResource,
        Context context) {
        return putDataControllerWithResponseAsync(
