...
public final class SqlManagedInstancesImpl implements SqlManagedInstances {
    ...
    public SqlManagedInstancesImpl(SqlManagedInstancesClient innerClient, AzureDataManager serviceManager) {
    ...
    public PagedIterable<SqlManagedInstance> list() {
        ...
        return inner.mapPage(inner1 -> new SqlManagedInstanceImpl(inner1, this.manager()));
    }
