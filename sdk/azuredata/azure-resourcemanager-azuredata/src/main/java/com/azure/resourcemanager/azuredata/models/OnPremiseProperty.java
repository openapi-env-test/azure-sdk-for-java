...
public final class OnPremiseProperty {
    ...
    /*
     * Certificate that contains the on premise cluster public key used to
     * verify signing
     */
    ...
    /**
     * Get the id property: A globally unique ID identifying the associated on premise cluster.
     *
     * @return the id value.
     */
    public UUID id() {
    ...
    /**
     * Set the id property: A globally unique ID identifying the associated on premise cluster.
     *
    ...
    /**
     * Get the publicSigningKey property: Certificate that contains the on premise cluster public key used to verify
     * signing.
     *
    ...
    /**
     * Set the publicSigningKey property: Certificate that contains the on premise cluster public key used to verify
     * signing.
     *
