...
import com.azure.resourcemanager.azuredata.fluent.SqlManagedInstancesClient;
import com.azure.resourcemanager.azuredata.fluent.models.SqlManagedInstanceInner;
import com.azure.resourcemanager.azuredata.models.SqlManagedInstanceListResult;
...
public final class SqlManagedInstancesClientImpl implements SqlManagedInstancesClient {
     ...
     */
    SqlManagedInstancesClientImpl(AzureDataManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureDataManagementClientSqlManagedInstances to be used by the proxy
    ...
    private interface SqlManagedInstancesService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.AzureData/sqlManagedInstances")
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlManagedInstanceInner>> create(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlManagedInstanceName") String sqlManagedInstanceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SqlManagedInstanceInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @param parameters The SQL Managed Instance to be created or updated.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SqlManagedInstance.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlManagedInstanceInner>> createWithResponseAsync(
        String resourceGroupName, String sqlManagedInstanceName, SqlManagedInstanceInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlManagedInstanceInner>> createWithResponseAsync(
        String resourceGroupName, String sqlManagedInstanceName, SqlManagedInstanceInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<SqlManagedInstanceInner> createAsync(
        String resourceGroupName, String sqlManagedInstanceName, SqlManagedInstanceInner parameters) {
        return createWithResponseAsync(resourceGroupName, sqlManagedInstanceName, parameters)
            .flatMap(
                (Response<SqlManagedInstanceInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public SqlManagedInstanceInner create(
        String resourceGroupName, String sqlManagedInstanceName, SqlManagedInstanceInner parameters) {
        return createAsync(resourceGroupName, sqlManagedInstanceName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SqlManagedInstanceInner> createWithResponse(
        String resourceGroupName, String sqlManagedInstanceName, SqlManagedInstanceInner parameters, Context context) {
        return createWithResponseAsync(resourceGroupName, sqlManagedInstanceName, parameters, context).block();
    }
