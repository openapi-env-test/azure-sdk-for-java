...
public final class SqlServerRegistrationImpl
    ...
    SqlServerRegistrationImpl(String name, AzureDataManager serviceManager) {
    ...
    SqlServerRegistrationImpl(SqlServerRegistrationInner innerObject, AzureDataManager serviceManager) {
