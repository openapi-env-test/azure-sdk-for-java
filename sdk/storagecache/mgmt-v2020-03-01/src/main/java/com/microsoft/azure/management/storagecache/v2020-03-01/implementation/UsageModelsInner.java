...
public class UsageModelsInner {
    ...
    interface UsageModelsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagecache.v2020-03-01.UsageModels list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.StorageCache/usageModels")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.storagecache.v2020-03-01.UsageModels listNext" })
        @GET
