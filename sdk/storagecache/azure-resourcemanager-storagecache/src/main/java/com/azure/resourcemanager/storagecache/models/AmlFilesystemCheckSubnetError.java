...
public final class AmlFilesystemCheckSubnetError {
    ...
    /**
     * Get the filesystemSubnet property: The error details for the filesystem subnet.
     *
    ...
    /**
     * Set the filesystemSubnet property: The error details for the filesystem subnet.
     *
