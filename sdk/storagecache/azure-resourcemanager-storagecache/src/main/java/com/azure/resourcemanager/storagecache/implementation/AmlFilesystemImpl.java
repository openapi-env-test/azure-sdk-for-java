    ...
    public AmlFilesystem apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAmlFilesystems()
                .updateWithResponse(resourceGroupName, amlFilesystemName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public AmlFilesystem apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAmlFilesystems()
                .updateWithResponse(resourceGroupName, amlFilesystemName, this.innerModel(), context)
                .getValue();
        return this;
    }
