...
public final class ArchiveStatusType extends ExpandableStringEnum<ArchiveStatusType> {
    ...
    /** Static value Pending for ArchiveStatusType. */
    public static final ArchiveStatusType PENDING = fromString("Pending");

    /** Static value Cancelled for ArchiveStatusType. */
    public static final ArchiveStatusType CANCELLED = fromString("Cancelled");
