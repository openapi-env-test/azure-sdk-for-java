...
public final class AmlFilesystemProperties {
    ...
    /*
     * Throughput provisioned in MB per sec, calculated as storageCapacityTiB *
     ...
     * @return the AmlFilesystemProperties object itself.
     */
    public AmlFilesystemProperties withZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
    ...
    public void validate() {
        ...
        if (zones() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property zones in model AmlFilesystemProperties"));
        }
