...
public interface AmlFilesystem {
    ...
    /**
     * Gets the identity property: The managed identity used by the AML Filesystem, if configured.
     *
    ...
    /**
     * Gets the storageCapacityTiB property: The size of this filesystem, in TiB. This might be rounded up.
     *
    ...
    /**
     * Gets the health property: Health of the AML Filesystem.
     *
    ...
    /**
     * Gets the filesystemSubnet property: Subnet used for managing the AML Filesystem and for client-facing operations.
    ...
    /**
     * Gets the mgsAddress property: IPv4 Address.
     *
    ...
    /**
     * Gets the mountCommand property: Recommended command to mount the Lustre filesystem.
     *
    ...
    /**
     * Gets the lustreVersion property: The version of Lustre running in the AML Filesystem.
     *
    ...
    /**
     * Gets the encryptionSettings property: Specifies encryption settings of the AML Filesystem.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithIdentity {
            /**
             * Specifies the identity property: The managed identity used by the AML Filesystem, if configured..
             *
             * @param identity The managed identity used by the AML Filesystem, if configured.
             * @return the next definition stage.
             */
        ...
        interface WithStorageCapacityTiB {
            /**
             * Specifies the storageCapacityTiB property: The size of this filesystem, in TiB. This might be rounded
             * up..
             *
             * @param storageCapacityTiB The size of this filesystem, in TiB. This might be rounded up.
             * @return the next definition stage.
             */
        ...
        interface WithFilesystemSubnet {
            /**
             * Specifies the filesystemSubnet property: Subnet used for managing the AML Filesystem and for
             * client-facing operations. This subnet should have at least a /24 subnet mask within the VNET's address
             * space..
             *
             * @param filesystemSubnet Subnet used for managing the AML Filesystem and for client-facing operations.
             *     This subnet should have at least a /24 subnet mask within the VNET's address space.
             * @return the next definition stage.
             */
        ...
        interface WithEncryptionSettings {
            /**
             * Specifies the encryptionSettings property: Specifies encryption settings of the AML Filesystem..
             *
             * @param encryptionSettings Specifies encryption settings of the AML Filesystem.
             * @return the next definition stage.
             */
    ...
    interface UpdateStages {
        ...
        /** The stage of the AmlFilesystem update allowing to specify identity. */
        interface WithIdentity {
            /**
             * Specifies the identity property: The managed identity used by the AML Filesystem, if configured..
             *
             ...
             * @return the next definition stage.
             */
            Update withIdentity(AmlFilesystemIdentity identity);
        }
        /** The stage of the AmlFilesystem update allowing to specify sku. */
        interface WithSku {
            /**
             * Specifies the sku property: SKU for the Resource..
             *
        ...
        /** The stage of the AmlFilesystem update allowing to specify hsm. */
        interface WithHsm {
            /**
             * Specifies the hsm property: Hydration and Archive settings and status.
             *
             ...
             * @return the next definition stage.
             */
            Update withHsm(AmlFilesystemPropertiesHsm hsm);
        }
    }
    /**
