...
public final class AmlFilesystemSubnetInfo {
    /*
     * Subnet used for managing the AML Filesystem and for client-facing
    ...
    /**
     * Get the storageCapacityTiB property: The size of this filesystem, in TiB.
     *
    ...
    /**
     * Set the storageCapacityTiB property: The size of this filesystem, in TiB.
     *
    ...
    /**
     * Get the location property: Region that the AML Filesystem will be created in.
     *
    ...
    /**
     * Set the location property: Region that the AML Filesystem will be created in.
     *
