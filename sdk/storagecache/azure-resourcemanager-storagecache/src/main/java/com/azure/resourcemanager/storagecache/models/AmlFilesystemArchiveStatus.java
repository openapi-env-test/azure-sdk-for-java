...
public final class AmlFilesystemArchiveStatus {
    ...
    /**
     * Get the percentComplete property: The completion percentage of the archive.
     *
    ...
    /**
     * Get the errorMessage property: Server-defined error message of the archive operation.
     *
