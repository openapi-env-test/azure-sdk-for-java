...
public final class AmlFilesystemsClientImpl implements AmlFilesystemsClient {
    ...
    private interface AmlFilesystemsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AmlFilesystemInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     * @return result of the request to list AML Filesystems along with {@link PagedResponse} on successful completion
     *     of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list AML Filesystems as paginated response with {@link PagedFlux}.
     */
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String amlFilesystemName) {
        return beginDeleteAsync(resourceGroupName, amlFilesystemName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String amlFilesystemName, Context context) {
        return beginDeleteAsync(resourceGroupName, amlFilesystemName, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an AML Filesystem instance along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an AML Filesystem instance on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public AmlFilesystemInner getByResourceGroup(String resourceGroupName, String amlFilesystemName) {
        return getByResourceGroupAsync(resourceGroupName, amlFilesystemName).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of an AML Filesystem instance.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    ...
    public SyncPoller<PollResult<AmlFilesystemInner>, AmlFilesystemInner> beginCreateOrUpdate(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemInner amlFilesystem) {
        return beginCreateOrUpdateAsync(resourceGroupName, amlFilesystemName, amlFilesystem).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AmlFilesystemInner>, AmlFilesystemInner> beginCreateOrUpdate(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemInner amlFilesystem, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, amlFilesystemName, amlFilesystem, context).getSyncPoller();
    }
    ...
    private Mono<AmlFilesystemInner> createOrUpdateAsync(String resourceGroupName, String amlFilesystemName) {
        final AmlFilesystemInner amlFilesystem = null;
        return beginCreateOrUpdateAsync(resourceGroupName, amlFilesystemName, amlFilesystem)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AmlFilesystemInner>> updateWithResponseAsync(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemInner amlFilesystem) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<AmlFilesystemInner> updateAsync(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemInner amlFilesystem) {
        return updateWithResponseAsync(resourceGroupName, amlFilesystemName, amlFilesystem)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AmlFilesystemInner> updateWithResponse(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemInner amlFilesystem, Context context) {
        return updateWithResponseAsync(resourceGroupName, amlFilesystemName, amlFilesystem, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> archiveAsync(
        String resourceGroupName, String amlFilesystemName, AmlFilesystemArchiveInfo archiveInfo) {
    ...
    public void archive(String resourceGroupName, String amlFilesystemName) {
        final AmlFilesystemArchiveInfo archiveInfo = null;
        archiveAsync(resourceGroupName, amlFilesystemName, archiveInfo).block();
    }
    ...
    public void cancelArchive(String resourceGroupName, String amlFilesystemName) {
        cancelArchiveAsync(resourceGroupName, amlFilesystemName).block();
    }
