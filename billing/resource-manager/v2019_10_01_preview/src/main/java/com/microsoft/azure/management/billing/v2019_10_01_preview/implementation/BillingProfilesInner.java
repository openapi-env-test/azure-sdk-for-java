...
public class BillingProfilesInner {
    ...
    interface BillingProfilesService {
        ...
        Observable<Response<ResponseBody>> update(@Path("billingAccountName") String billingAccountName, @Path("billingProfileName") String billingProfileName, @Query("api-version") String apiVersion, @Body List<JsonPatchOperation> patch, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        @PATCH("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}")
        Observable<Response<ResponseBody>> beginUpdate(@Path("billingAccountName") String billingAccountName, @Path("billingProfileName") String billingProfileName, @Query("api-version") String apiVersion, @Body List<JsonPatchOperation> patch, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @return the BillingProfileInner object if successful.
     */
    public BillingProfileInner update(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        return updateWithServiceResponseAsync(billingAccountName, billingProfileName, patch).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingProfileInner> updateAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch, final ServiceCallback<BillingProfileInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(updateWithServiceResponseAsync(billingAccountName, billingProfileName, patch), serviceCallback);
    }
     ...
     * @return the observable for the request
     */
    public Observable<BillingProfileInner> updateAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        return updateWithServiceResponseAsync(billingAccountName, billingProfileName, patch).map(new Func1<ServiceResponseWithHeaders<BillingProfileInner, BillingProfilesUpdateHeaders>, BillingProfileInner>() {
            @Override
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponseWithHeaders<BillingProfileInner, BillingProfilesUpdateHeaders>> updateWithServiceResponseAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        if (patch == null) {
            throw new IllegalArgumentException("Parameter patch is required and cannot be null.");
        }
        Validator.validate(patch);
        Observable<Response<ResponseBody>> observable = service.update(billingAccountName, billingProfileName, this.client.apiVersion(), patch, this.client.acceptLanguage(), this.client.userAgent());
     ...
     * @return the BillingProfileInner object if successful.
     */
    public BillingProfileInner beginUpdate(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        return beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, patch).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingProfileInner> beginUpdateAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch, final ServiceCallback<BillingProfileInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, patch), serviceCallback);
    }
     ...
     * @return the observable to the BillingProfileInner object
     */
    public Observable<BillingProfileInner> beginUpdateAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        return beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, patch).map(new Func1<ServiceResponseWithHeaders<BillingProfileInner, BillingProfilesUpdateHeaders>, BillingProfileInner>() {
            @Override
            public BillingProfileInner call(ServiceResponseWithHeaders<BillingProfileInner, BillingProfilesUpdateHeaders> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingProfileInner object
     */
    public Observable<ServiceResponseWithHeaders<BillingProfileInner, BillingProfilesUpdateHeaders>> beginUpdateWithServiceResponseAsync(String billingAccountName, String billingProfileName, List<JsonPatchOperation> patch) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        Validator.validate(patch);
        return service.beginUpdate(billingAccountName, billingProfileName, this.client.apiVersion(), patch, this.client.acceptLanguage(), this.client.userAgent())
