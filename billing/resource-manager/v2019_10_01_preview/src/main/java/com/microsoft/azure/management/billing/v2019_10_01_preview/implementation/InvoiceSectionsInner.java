...
public class InvoiceSectionsInner {
    ...
    interface InvoiceSectionsService {
        ...
        Observable<Response<ResponseBody>> update(@Path("billingAccountName") String billingAccountName, @Path("billingProfileName") String billingProfileName, @Path("invoiceSectionName") String invoiceSectionName, @Query("api-version") String apiVersion, @Body List<JsonPatchOperation> patch, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @return the InvoiceSectionInner object if successful.
     */
    public InvoiceSectionInner update(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        return updateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<InvoiceSectionInner> updateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch, final ServiceCallback<InvoiceSectionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(updateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch), serviceCallback);
    }
     ...
     * @return the observable for the request
     */
    public Observable<InvoiceSectionInner> updateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        return updateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).map(new Func1<ServiceResponseWithHeaders<InvoiceSectionInner, InvoiceSectionsUpdateHeaders>, InvoiceSectionInner>() {
            @Override
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponseWithHeaders<InvoiceSectionInner, InvoiceSectionsUpdateHeaders>> updateWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        Observable<Response<ResponseBody>> observable = service.update(billingAccountName, billingProfileName, invoiceSectionName, this.client.apiVersion(), patch, this.client.acceptLanguage(), this.client.userAgent());
     ...
     * @return the InvoiceSectionInner object if successful.
     */
    public InvoiceSectionInner beginUpdate(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        return beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<InvoiceSectionInner> beginUpdateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch, final ServiceCallback<InvoiceSectionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch), serviceCallback);
    }
     ...
     * @return the observable to the InvoiceSectionInner object
     */
    public Observable<InvoiceSectionInner> beginUpdateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        return beginUpdateWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, patch).map(new Func1<ServiceResponseWithHeaders<InvoiceSectionInner, InvoiceSectionsUpdateHeaders>, InvoiceSectionInner>() {
            @Override
            public InvoiceSectionInner call(ServiceResponseWithHeaders<InvoiceSectionInner, InvoiceSectionsUpdateHeaders> response) {
                return response.body();
            }
     ...
     * @return the observable to the InvoiceSectionInner object
     */
    public Observable<ServiceResponseWithHeaders<InvoiceSectionInner, InvoiceSectionsUpdateHeaders>> beginUpdateWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, List<JsonPatchOperation> patch) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        Validator.validate(patch);
        return service.beginUpdate(billingAccountName, billingProfileName, invoiceSectionName, this.client.apiVersion(), patch, this.client.acceptLanguage(), this.client.userAgent())
